...
public final class d1<T, R> extends Maybe<R> implements SingleConverter<T, Maybe<R>> {
    ...
    public static final class a<T, R> implements SingleObserver<T>, Disposable {
        public final C0649a<R> a;
        public final Function<? super T, ? extends MaybeSource<? extends R>> b;
        public final Function<? super Throwable, ? extends MaybeSource<? extends R>> c;

        /* renamed from: r6.a.b.i.d1$a$a  reason: collision with other inner class name */
        public static final class C0649a<R> extends AtomicReference<Disposable> implements MaybeObserver<R> {
            private static final long serialVersionUID = 314442824941893429L;
            public final MaybeObserver<? super R> a;

            public C0649a(MaybeObserver<? super R> maybeObserver) {
        ...
        public a(MaybeObserver<? super R> maybeObserver, Function<? super T, ? extends MaybeSource<? extends R>> function, Function<? super Throwable, ? extends MaybeSource<? extends R>> function2) {
            this.a = new C0649a<>(maybeObserver);
            this.b = function;
            this.c = function2;
        }
    ...
    public d1(Single<T> single, Function<? super T, ? extends MaybeSource<? extends R>> function, Function<? super Throwable, ? extends MaybeSource<? extends R>> function2) {
        this.a = single;
        this.b = function;
        this.c = function2;
    }
    ...
    public Object apply(Single single) {
        return new d1(single, this.b, this.c);
    }
