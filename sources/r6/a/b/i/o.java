...
public final class o<T, R> extends Flowable<R> implements FlowableTransformer<T, R> {
    ...
    public static abstract class a<T, R> extends AtomicInteger implements Subscriber<T>, Subscription, c<T, R> {
                                                ...
                                                if (j8 == j5) {
                                                    ...
                                                    if (!z || ((Throwable) this.h.get()) == null) {
                                                        ...
                                                        try {
                                                            ...
                                                            this.m.cancel();
                                                            e();
                                                            this.h.tryTerminateConsumer(subscriber2);
                                                            f();
                                                            return;
                                                        }
                                                    } else {
                                                        this.h.tryTerminateConsumer(subscriber4);
                                                        f();
                                                        return;
                                                    }
                                                } else {
        ...
        public final void onNext(T t) {
            try {
                ...
                Objects.requireNonNull(publisher, "The mapper returned a null value");
    ...
    public o(Publisher<T> publisher, Function<? super T, ? extends Publisher<? extends R>> function, int i, int i2, boolean z) {
        this.b = publisher;
        this.c = function;
        this.d = i;
        this.e = i2;
    ...
    public Publisher<R> apply(Flowable<T> flowable) {
        return new o(flowable, this.c, this.d, this.e, this.f);
    }
