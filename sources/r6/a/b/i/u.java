...
public final class u<T> extends Flowable<T> implements FlowableTransformer<T, T> {
    ...
    public static final class a<T> extends AtomicInteger implements Subscriber<T>, Subscription, Runnable {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: r6.a.b.i.u$a<T> */
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: r6.a.b.i.u$a<T> */
        /* JADX WARN: Multi-variable type inference failed */
        @Override // org.reactivestreams.Subscriber
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r8v0, resolved type: r6.a.b.i.u$a<T> */
        /* JADX WARN: Multi-variable type inference failed */
    ...
    public u(Publisher<T> publisher, int i, long j, TimeUnit timeUnit, Scheduler scheduler, Consumer<? super T> consumer) {
        this.b = publisher;
        this.c = i;
        this.d = j;
        this.e = timeUnit;
    ...
    public Publisher<T> apply(Flowable<T> flowable) {
        return new u(flowable, this.c, this.d, this.e, this.f, this.g);
    }
