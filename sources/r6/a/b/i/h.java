...
public final class h<T, R> extends Flowable<R> implements FlowableTransformer<T, R> {
    ...
    public static final class a<T, R> extends AtomicInteger implements FlowableSubscriber<T>, Subscription {
        ...
        public a(Subscriber<? super R> subscriber, Supplier<R> supplier, BiConsumer<R, T> biConsumer, int i2) {
            this.a = subscriber;
            this.b = supplier;
            this.c = biConsumer;
            this.e = i2;
    ...
    public h(Publisher<T> publisher, Supplier<R> supplier, BiConsumer<R, T> biConsumer, int i) {
        this.b = publisher;
        this.c = supplier;
        this.d = biConsumer;
        this.e = i;
    ...
    public Publisher<R> apply(Flowable<T> flowable) {
        return new h(flowable, this.c, this.d, this.e);
    }
