...
public final class f<T, C extends Collection<? super T>> extends Flowable<C> implements FlowableTransformer<T, C> {
    ...
    public static final class a<T, C extends Collection<? super T>> implements ConditionalSubscriber<T>, Subscription {
        ...
        public a(Subscriber<? super C> subscriber, C c2, Predicate<? super T> predicate, b bVar, Supplier<C> supplier) {
            this.a = subscriber;
            this.b = predicate;
            this.c = bVar;
            this.e = c2;
    ...
    public f(Publisher<T> publisher, Predicate<? super T> predicate, b bVar, Supplier<C> supplier) {
        this.b = publisher;
        this.c = predicate;
        this.d = bVar;
        this.e = supplier;
    ...
    public void subscribeActual(Subscriber<? super C> subscriber) {
        try {
            ...
            this.b.subscribe(new a(subscriber, c2, this.c, this.d, this.e));
        } catch (Throwable th) {
            Exceptions.throwIfFatal(th);
