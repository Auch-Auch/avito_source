...
public final class z0<T> extends Observable<T> implements ObservableTransformer<T, T> {
    ...
    public z0(Observable<T> observable, Scheduler scheduler) {
        this.a = observable;
        this.b = scheduler;
    }
    ...
    public ObservableSource<T> apply(Observable<T> observable) {
        return new z0(observable, this.b);
    }
