...
public final class j<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends a {
    public final Consumer9<T1, T2, T3, T4, T5, T6, T7, T8, T9> b;
    ...
    public j(l<T1> lVar, l<T2> lVar2, l<T3> lVar3, l<T4> lVar4, l<T5> lVar5, l<T6> lVar6, l<T7> lVar7, l<T8> lVar8, l<T9> lVar9, Consumer9<T1, T2, T3, T4, T5, T6, T7, T8, T9> consumer9, Action action) {
        this.b = consumer9;
        this.c = action;
        this.d = lVar;
        this.e = lVar2;
        ...
        this.a.put(lVar9, lVar9);
    }

    @Override // r6.a.b.g.a
    public void b() throws Throwable {
        if (!this.d.e.isEmpty() && !this.e.e.isEmpty() && !this.f.e.isEmpty() && !this.g.e.isEmpty() && !this.h.e.isEmpty() && !this.i.e.isEmpty() && !this.j.e.isEmpty() && !this.k.e.isEmpty() && !this.l.e.isEmpty()) {
            ...
            Notification<T> peek9 = this.l.e.peek();
            ...
            a();
            this.b.accept(peek.getValue(), peek2.getValue(), peek3.getValue(), peek4.getValue(), peek5.getValue(), peek6.getValue(), peek7.getValue(), peek8.getValue(), peek9.getValue());
        }
    }
}
