...
public final class g1<R> extends Nono {
    ...
    public g1(Supplier<R> supplier, Function<? super R, ? extends Nono> function, Consumer<? super R> consumer, boolean z) {
        this.b = supplier;
        this.c = function;
        this.d = consumer;
        this.e = z;
    ...
    public void subscribeActual(Subscriber<? super Void> subscriber) {
        try {
            R r = this.b.get();
            try {
                Nono nono = (Nono) this.c.apply(r);
                Objects.requireNonNull(nono, "The sourceSupplier returned a null Nono");
                nono.subscribe(new a(subscriber, r, this.d, this.e));
                return;
            } catch (Throwable th) {
                Exceptions.throwIfFatal(th);
                RxJavaPlugins.onError(th);
