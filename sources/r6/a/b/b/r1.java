...
public final class r1<T> extends Perhaps<T> {
    ...
    public final class a extends f<T> implements Subscriber<T> {
        ...
        public T poll() throws Throwable {
            T poll = this.c.poll();
            if (poll != null) {
                r1.this.c.accept(poll);
                r1.this.d.accept(poll);
            } else if (this.e == 1) {
                r1.this.f.run();
                r1.this.g.run();
            }
    ...
    public r1(Perhaps<T> perhaps, Consumer<? super T> consumer, Consumer<? super T> consumer2, Consumer<? super Throwable> consumer3, Action action, Action action2, Consumer<? super Subscription> consumer4, LongConsumer longConsumer, Action action3) {
        this.b = perhaps;
        this.c = consumer;
        this.d = consumer2;
        this.e = consumer3;
