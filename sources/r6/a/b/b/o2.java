...
public final class o2<T> extends Perhaps<T> {
    ...
    public static final class a<T> extends DeferredScalarSubscription<T> implements Subscriber<T> {
        ...
        public final a<T>.C0619a b = new C0619a();
        public Subscription c;

        /* renamed from: r6.a.b.b.o2$a$a  reason: collision with other inner class name */
        public final class C0619a extends AtomicReference<Subscription> implements Subscriber<T> {
    ...
    public o2(Perhaps<T> perhaps, Perhaps<? extends T> perhaps2) {
        this.b = perhaps;
        this.c = perhaps2;
    }
