...
public final class o2<T> extends Perhaps<T> {
    ...
    public static final class a<T> extends DeferredScalarSubscription<T> implements Subscriber<T> {
        ...
        public final a<T>.C0568a b = new C0568a();
        public Subscription c;

        /* renamed from: r6.a.a.b.o2$a$a  reason: collision with other inner class name */
        public final class C0568a extends AtomicReference<Subscription> implements Subscriber<T> {
