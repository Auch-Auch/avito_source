...
public final class h4<T> extends Solo<T> {
    ...
    public static final class a<T> extends DeferredScalarSubscription<T> implements Subscriber<T> {
        ...
        public final a<T>.C0556a b = new C0556a();
        public Subscription c;

        /* renamed from: r6.a.a.b.h4$a$a  reason: collision with other inner class name */
        public final class C0556a extends AtomicReference<Subscription> implements Subscriber<T> {
