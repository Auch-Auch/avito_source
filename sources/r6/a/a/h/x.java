...
public final class x<T> extends Flowable<T> implements FlowableTransformer<T, T> {
    ...
    public x(Publisher<T> publisher, long j, long j2, TimeUnit timeUnit, Scheduler scheduler, boolean z, int i) {
        this.b = publisher;
    ...
    public Publisher<T> apply(Flowable<T> flowable) {
        return new x(flowable, this.c, this.d, TimeUnit.NANOSECONDS, this.e, this.f, this.g);
    }
