...
public final class d extends Lambda implements Function1<NoArgSimpleBindingKodein<? extends Object>, BottomNavigationStorage> {
    ...
    public BottomNavigationStorage invoke(NoArgSimpleBindingKodein<? extends Object> noArgSimpleBindingKodein) {
        ...
        return new BottomNavigationStorage((Context) noArgSimpleBindingKodein2.getDkodein().Instance(TypesKt.TT(new TypeReference<Application>() { // from class: ru.sravni.android.bankproduct.storage.di.StorageClientProviderKt$storageKodeinModule$1$4$$special$$inlined$instance$1
        }), null));
    }
}
