...
public final class h<T, R> implements Function<Throwable, ObservableSource<? extends OfferOsagoListCompanyRepo>> {
    public final /* synthetic */ OfferOsagoWebClient.d a;

    public h(OfferOsagoWebClient.d dVar) {
        this.a = dVar;
    }
    ...
    public ObservableSource<? extends OfferOsagoListCompanyRepo> apply(Throwable th) {
        Throwable th2 = th;
