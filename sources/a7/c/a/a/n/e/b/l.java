...
public final class l<T, R> implements Function<Throwable, ObservableSource<? extends OfferProductStatusRepo>> {
    public final /* synthetic */ OfferProductListWebClient.f a;

    public l(OfferProductListWebClient.f fVar) {
        this.a = fVar;
    }
