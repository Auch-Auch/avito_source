...
public final class ParallelScheduler extends Scheduler {
    ...
    public Disposable scheduleDirect(Runnable runnable) {
        ...
        try {
            return Disposables.fromFuture(a3.submit(RxJavaPlugins.onSchedule(runnable)));
    ...
    public Disposable schedulePeriodicallyDirect(Runnable runnable, long j, long j2, TimeUnit timeUnit) {
        ...
        try {
            return Disposables.fromFuture(a3.scheduleAtFixedRate(RxJavaPlugins.onSchedule(runnable), j, j2, timeUnit));
        } catch (RejectedExecutionException unused) {
            return Disposables.disposed();
        }
    }
    ...
    public static final class a extends Scheduler.Worker {
        ...
        public final class CallableC0368a implements Callable<Object>, Disposable {
        ...
        public Disposable schedule(Runnable runnable) {
            if (!this.b) {
                try {
                    CallableC0368a aVar = new CallableC0368a(RxJavaPlugins.onSchedule(runnable));
                    this.a.submit(aVar);
                    return aVar;
                } catch (RejectedExecutionException unused) {
                }
    ...
    public Disposable scheduleDirect(Runnable runnable, long j, TimeUnit timeUnit) {
        ...
        try {
            return Disposables.fromFuture(a3.schedule(RxJavaPlugins.onSchedule(runnable), j, timeUnit));
        } catch (RejectedExecutionException unused) {
            return Disposables.disposed();
        }
    }
