...
public final class BasicMergeSubscription<T> extends AtomicInteger implements Subscription, InnerQueuedSubscriberSupport<T> {
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:131:0x00cb */
    /* JADX WARNING: Code restructure failed: missing block: B:42:0x00a0, code lost:
        if (r0 != r26) goto L_0x00a2;
     */
    /* JADX WARNING: Removed duplicated region for block: B:133:0x00cb A[SYNTHETIC] */
