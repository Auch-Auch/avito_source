...
public class x extends FragmentTransitionImpl {
    ...
    public class c implements Transition.TransitionListener {
        ...
        public void onTransitionStart(Transition transition) {
            Object obj = this.a;
            if (obj != null) {
                x.this.replaceTargets(obj, this.b, null);
            }
            Object obj2 = this.c;
            if (obj2 != null) {
                x.this.replaceTargets(obj2, this.d, null);
            }
            Object obj3 = this.e;
            if (obj3 != null) {
                x.this.replaceTargets(obj3, this.f, null);
            }
        }
    }
    ...
    public void replaceTargets(Object obj, ArrayList<View> arrayList, ArrayList<View> arrayList2) {
        ...
        } else if (!d(transition) && (targets = transition.getTargets()) != null && targets.size() == arrayList.size() && targets.containsAll(arrayList)) {
            if (arrayList2 == null) {
                i = 0;
            } else {
                i = arrayList2.size();
