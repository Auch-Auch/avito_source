...
public class a extends Socket {
    ...
    /* renamed from: l6.h.e.a$a  reason: collision with other inner class name */
    public static class C0525a extends SocketImpl {
        public C0525a(DatagramSocket datagramSocket, FileDescriptor fileDescriptor) {
    ...
    public a(DatagramSocket datagramSocket, FileDescriptor fileDescriptor) throws SocketException {
        super(new C0525a(datagramSocket, fileDescriptor));
    }
}
