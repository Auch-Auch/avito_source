...
public final class RightProjection<L, R> {
    ...
    public static final class a extends Lambda implements Function1<R, Either> {
        ...
        public Either invoke(Object obj) {
            return EitherKt.Right(this.a.invoke(obj));
        }
    }
    ...
    public final boolean exists(@NotNull Function1<? super R, Boolean> function1) {
        ...
        if (either instanceof Either.Right) {
            return function1.invoke((Object) ((Either.Right) either).getB()).booleanValue();
        }
    ...
    @NotNull
    public final Option<Either<L, R>> filter(@NotNull Function1<? super R, Boolean> function1) {
        Intrinsics.checkParameterIsNotNull(function1, "predicate");
        Either<L, R> either = this.a;
        if (either instanceof Either.Right) {
            if (function1.invoke((Object) ((Either.Right) either).getB()).booleanValue()) {
    ...
    public final void forEach(@NotNull Function1<? super R, Unit> function1) {
        ...
        Either<L, R> either = this.a;
        if (either instanceof Either.Right) {
            function1.invoke((Object) ((Either.Right) either).getB());
        }
    }
    ...
    @NotNull
    public final <X> Either<L, X> map(@NotNull Function1<? super R, ? extends X> function1) {
        Intrinsics.checkParameterIsNotNull(function1, "f");
        return RightProjectionKt.flatMap(this, new a(function1));
    }
    ...
    public final List<R> toList() {
        Either<L, R> either = this.a;
        if (either instanceof Either.Right) {
            return d.listOf(((Either.Right) either).getB());
        }
        if (either instanceof Either.Left) {
    ...
    public final Option<R> toOption() {
        Either<L, R> either = this.a;
        if (either instanceof Either.Right) {
            return new Some(((Either.Right) this.a).getB());
        }
        if (either instanceof Either.Left) {
            return None.INSTANCE;
        }
