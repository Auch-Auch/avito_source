...
public final class EndConsumerHelper {
    ...
    public static String composeMessage(String str) {
        return a.f("It is not allowed to subscribe with a(n) ", str, " multiple times. Please create a fresh instance of ", str, " and subscribe that to the target source instead.");
    }
