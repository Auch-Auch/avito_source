...
public final class SingleDelay<T> extends Single<T> {
    ...
    public final class a implements SingleObserver<T> {
        ...
        public final class RunnableC0497a implements Runnable {
            ...
            public RunnableC0497a(Throwable th) {
                this.a = th;
            }
        ...
        public void onError(Throwable th) {
            ...
            sequentialDisposable.replace(singleDelay.d.scheduleDirect(new RunnableC0497a(th), singleDelay.e ? singleDelay.b : 0, singleDelay.c));
        }
