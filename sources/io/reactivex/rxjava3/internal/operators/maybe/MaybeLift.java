...
public final class MaybeLift<T, R> extends a<T, R> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v1, resolved type: io.reactivex.rxjava3.core.MaybeSource<T> */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // io.reactivex.rxjava3.core.Maybe
    public void subscribeActual(MaybeObserver<? super R> maybeObserver) {
        try {
            MaybeObserver<? super Object> apply = this.a.apply(maybeObserver);
