...
public final class ObservableCombineLatest<T, R> extends Observable<R> {
    ...
    public static final class a<T, R> extends AtomicReference<Disposable> implements Observer<T> {
        ...
        public void onComplete() {
            /*
                r5 = this;
                io.reactivex.rxjava3.internal.operators.observable.ObservableCombineLatest$b<T, R> r0 = r5.a
                int r1 = r5.b
                monitor-enter(r0)
        ...
        public void onError(java.lang.Throwable r5) {
            /*
                r4 = this;
                io.reactivex.rxjava3.internal.operators.observable.ObservableCombineLatest$b<T, R> r0 = r4.a
                int r1 = r4.b
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r6v5, resolved type: io.reactivex.rxjava3.internal.queue.SpscLinkedArrayQueue<java.lang.Object[]> */
                ...
                while (!this.g) {
                    if (z || this.i.get() == null) {
                        ...
                        if (z2 && z3) {
                            ...
                            try {
                                Object obj = (Object) this.b.apply(poll);
    ...
    public void subscribeActual(Observer<? super R> observer) {
        ...
        for (int i3 = 0; i3 < length && !bVar.h && !bVar.g; i3++) {
