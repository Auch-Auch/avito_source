    ...
    public static final class a<T, R> extends AtomicInteger implements Disposable {
        ...
        public void b() {
            /*
                ...
                return
            L_0x0009:
                io.reactivex.rxjava3.internal.operators.observable.ObservableZip$b<T, R>[] r0 = r1.c
                io.reactivex.rxjava3.core.Observer<? super R> r2 = r1.a
                T[] r3 = r1.d
                boolean r4 = r1.e
                r5 = 1
                r6 = 1
            ...
            L_0x0017:
                ...
                boolean r13 = r12.c
                io.reactivex.rxjava3.internal.queue.SpscLinkedArrayQueue<T> r14 = r12.b
            ...
            L_0x0088:
                ...
                return
            L_0x0092:
                io.reactivex.rxjava3.functions.Function<? super java.lang.Object[], ? extends R> r7 = r1.b     // Catch:{ all -> 0x00aa }
            ...
            L_0x00aa:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: io.reactivex.rxjava3.internal.operators.observable.ObservableZip.a.b():void");
        }
