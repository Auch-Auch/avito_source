...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    public static <T> Flowable<T> fromOptional(@NonNull Optional<T> optional) {
        ...
        return optional.map(b.a).orElseGet(e.a);
    }
    ...
    /* JADX DEBUG: Type inference failed for r2v2. Raw type applied. Possible types: io.reactivex.rxjava3.core.Flowable<R>, io.reactivex.rxjava3.core.Flowable<U> */
    @CheckReturnValue
    @NonNull
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @SchedulerSupport("none")
    ...
    /* JADX DEBUG: Type inference failed for r2v2. Raw type applied. Possible types: io.reactivex.rxjava3.core.Flowable<R>, io.reactivex.rxjava3.core.Flowable<T> */
    @CheckReturnValue
    @NonNull
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    ...
    public final <U, V> Flowable<T> e(Publisher<U> publisher, Function<? super T, ? extends Publisher<V>> function, Publisher<? extends T> publisher2) {
        Objects.requireNonNull(function, "itemTimeoutIndicator is null");
        return RxJavaPlugins.onAssembly(new FlowableTimeout(this, publisher, function, null));
    }
    ...
    /* JADX DEBUG: Type inference failed for r4v1. Raw type applied. Possible types: io.reactivex.rxjava3.core.Flowable<io.reactivex.rxjava3.flowables.GroupedFlowable<K, V>>, io.reactivex.rxjava3.core.Flowable<io.reactivex.rxjava3.flowables.GroupedFlowable<K, T>> */
    @CheckReturnValue
    @NonNull
    @BackpressureSupport(BackpressureKind.ERROR)
    @SchedulerSupport("none")
    ...
    /* JADX DEBUG: Type inference failed for r0v3. Raw type applied. Possible types: io.reactivex.rxjava3.core.Flowable<U>, io.reactivex.rxjava3.core.Flowable<T> */
    @CheckReturnValue
    @NonNull
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    ...
    /* JADX DEBUG: Type inference failed for r2v1. Raw type applied. Possible types: io.reactivex.rxjava3.core.Flowable<U extends java.util.Collection<? super T>>, io.reactivex.rxjava3.core.Flowable<java.util.List<T>> */
    @CheckReturnValue
    @NonNull
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public final Flowable<List<T>> buffer(int i, int i2) {
        return (Flowable<U>) buffer(i, i2, ArrayListSupplier.asSupplier());
    }
    ...
    /* JADX DEBUG: Type inference failed for r3v1. Raw type applied. Possible types: io.reactivex.rxjava3.core.Flowable<io.reactivex.rxjava3.flowables.GroupedFlowable<K, V>>, io.reactivex.rxjava3.core.Flowable<io.reactivex.rxjava3.flowables.GroupedFlowable<K, T>> */
    @CheckReturnValue
    @NonNull
    @BackpressureSupport(BackpressureKind.ERROR)
    @SchedulerSupport("none")
    ...
    /* JADX DEBUG: Type inference failed for r2v3. Raw type applied. Possible types: io.reactivex.rxjava3.core.Flowable<U>, io.reactivex.rxjava3.core.Flowable<T> */
    @CheckReturnValue
    @NonNull
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    ...
    public final <V> Flowable<T> timeout(@NonNull Function<? super T, ? extends Publisher<V>> function, @NonNull Publisher<? extends T> publisher) {
        Objects.requireNonNull(publisher, "fallback is null");
        Objects.requireNonNull(function, "itemTimeoutIndicator is null");
        return RxJavaPlugins.onAssembly(new FlowableTimeout(this, null, function, publisher));
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: io.reactivex.rxjava3.core.Flowable<T> */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX DEBUG: Type inference failed for r8v1. Raw type applied. Possible types: io.reactivex.rxjava3.core.Flowable<R>, io.reactivex.rxjava3.core.Flowable<V> */
    @CheckReturnValue
    @NonNull
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    ...
    /* JADX DEBUG: Type inference failed for r9v1. Raw type applied. Possible types: io.reactivex.rxjava3.core.Flowable<U extends java.util.Collection<? super T>>, io.reactivex.rxjava3.core.Flowable<java.util.List<T>> */
    @CheckReturnValue
    @NonNull
    @BackpressureSupport(BackpressureKind.ERROR)
    @SchedulerSupport("io.reactivex:computation")
    public final Flowable<List<T>> buffer(long j, long j2, @NonNull TimeUnit timeUnit) {
        return (Flowable<U>) buffer(j, j2, timeUnit, Schedulers.computation(), ArrayListSupplier.asSupplier());
    }
    ...
    public final Flowable<List<T>> buffer(long j, long j2, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler) {
        return (Flowable<U>) buffer(j, j2, timeUnit, scheduler, ArrayListSupplier.asSupplier());
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: io.reactivex.rxjava3.functions.Function<? super T, ? extends org.reactivestreams.Publisher<V>> */
    /* JADX WARN: Multi-variable type inference failed */
    @CheckReturnValue
    @NonNull
    @BackpressureSupport(BackpressureKind.FULL)
    ...
    public final <U, V> Flowable<T> timeout(@NonNull Publisher<U> publisher, @NonNull Function<? super T, ? extends Publisher<V>> function) {
        ...
        return e(publisher, function, null);
    }
    ...
    public final Flowable<List<T>> buffer(long j, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler, int i) {
        return (Flowable<U>) buffer(j, timeUnit, scheduler, i, ArrayListSupplier.asSupplier(), false);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> just(T t, T t2, T t3, T t4, T t5, T t7) {
        Objects.requireNonNull(t, "item1 is null");
        Objects.requireNonNull(t2, "item2 is null");
        Objects.requireNonNull(t3, "item3 is null");
        Objects.requireNonNull(t4, "item4 is null");
    ...
    public final Flowable<List<T>> buffer(long j, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler) {
        return (Flowable<U>) buffer(j, timeUnit, scheduler, Integer.MAX_VALUE, ArrayListSupplier.asSupplier(), false);
    }
    ...
    public final <TOpening, TClosing> Flowable<List<T>> buffer(@NonNull Publisher<? extends TOpening> publisher, @NonNull Function<? super TOpening, ? extends Publisher<? extends TClosing>> function) {
        return (Flowable<U>) buffer(publisher, function, ArrayListSupplier.asSupplier());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> just(T t, T t2, T t3, T t4, T t5, T t7, T t8) {
        Objects.requireNonNull(t, "item1 is null");
        Objects.requireNonNull(t2, "item2 is null");
        Objects.requireNonNull(t3, "item3 is null");
        Objects.requireNonNull(t4, "item4 is null");
    ...
    public final <B> Flowable<List<T>> buffer(@NonNull Publisher<B> publisher) {
        return (Flowable<U>) buffer(publisher, ArrayListSupplier.asSupplier());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> just(T t, T t2, T t3, T t4, T t5, T t7, T t8, T t9) {
        Objects.requireNonNull(t, "item1 is null");
        Objects.requireNonNull(t2, "item2 is null");
        Objects.requireNonNull(t3, "item3 is null");
        Objects.requireNonNull(t4, "item4 is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> just(T t, T t2, T t3, T t4, T t5, T t7, T t8, T t9, T t10) {
        Objects.requireNonNull(t, "item1 is null");
        Objects.requireNonNull(t2, "item2 is null");
        Objects.requireNonNull(t3, "item3 is null");
        Objects.requireNonNull(t4, "item4 is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> just(T t, T t2, T t3, T t4, T t5, T t7, T t8, T t9, T t10, T t11) {
        Objects.requireNonNull(t, "item1 is null");
        Objects.requireNonNull(t2, "item2 is null");
        Objects.requireNonNull(t3, "item3 is null");
        Objects.requireNonNull(t4, "item4 is null");
