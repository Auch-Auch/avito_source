...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public static <T> Observable<T> fromOptional(@NonNull Optional<T> optional) {
        ...
        return optional.map(g.a).orElseGet(d.a);
    }
    ...
    public static Observable<Integer> range(int i, int i2) {
        if (i2 < 0) {
            throw new IllegalArgumentException(a.M2("count >= 0 required but it was ", i2));
        } else if (i2 == 0) {
            return empty();
        } else {
            if (i2 == 1) {
    ...
    public static Observable<Long> rangeLong(long j, long j2) {
        ...
        if (i < 0) {
            throw new IllegalArgumentException(a.T2("count >= 0 required but it was ", j2));
        } else if (i == 0) {
            return empty();
        } else {
            if (j2 == 1) {
    ...
    public final <U, V> Observable<T> c(@NonNull ObservableSource<U> observableSource, @NonNull Function<? super T, ? extends ObservableSource<V>> function, @Nullable ObservableSource<? extends T> observableSource2) {
        ...
        return RxJavaPlugins.onAssembly(new ObservableTimeout(this, observableSource, function, null));
    }
    ...
    /* JADX DEBUG: Type inference failed for r2v2. Raw type applied. Possible types: io.reactivex.rxjava3.core.Observable<R>, io.reactivex.rxjava3.core.Observable<U> */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("none")
    ...
    /* JADX DEBUG: Type inference failed for r2v2. Raw type applied. Possible types: io.reactivex.rxjava3.core.Observable<R>, io.reactivex.rxjava3.core.Observable<T> */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("none")
    ...
    public final Maybe<T> elementAt(long j) {
        ...
        throw new IndexOutOfBoundsException(a.T2("index >= 0 required but it was ", j));
    }
    ...
    /* JADX DEBUG: Type inference failed for r4v1. Raw type applied. Possible types: io.reactivex.rxjava3.core.Observable<io.reactivex.rxjava3.observables.GroupedObservable<K, V>>, io.reactivex.rxjava3.core.Observable<io.reactivex.rxjava3.observables.GroupedObservable<K, T>> */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("none")
    ...
    public final Observable<T> skip(long j) {
        int i = (j > 0 ? 1 : (j == 0 ? 0 : -1));
        if (i < 0) {
            throw new IllegalArgumentException(a.T2("count >= 0 expected but it was ", j));
        } else if (i == 0) {
    ...
    public final Observable<T> skipLast(int i) {
        if (i < 0) {
            throw new IllegalArgumentException(a.M2("count >= 0 required but it was ", i));
        } else if (i == 0) {
            return RxJavaPlugins.onAssembly(this);
        } else {
    ...
    /* JADX DEBUG: Type inference failed for r0v3. Raw type applied. Possible types: io.reactivex.rxjava3.core.Observable<U>, io.reactivex.rxjava3.core.Observable<T> */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("none")
    ...
    public final Observable<T> take(long j) {
        ...
        throw new IllegalArgumentException(a.T2("count >= 0 required but it was ", j));
    }
    ...
    /* JADX DEBUG: Type inference failed for r4v1. Raw type applied. Possible types: io.reactivex.rxjava3.core.Single<java.util.Map<K, java.util.Collection<V>>>, io.reactivex.rxjava3.core.Single<java.util.Map<K, java.util.Collection<T>>> */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("none")
    public final <K> Single<Map<K, Collection<T>>> toMultimap(@NonNull Function<? super T, ? extends K> function) {
        return (Single<Map<K, Collection<V>>>) toMultimap(function, Functions.identity(), HashMapSupplier.asSupplier(), ArrayListSupplier.asFunction());
    }
    ...
    /* JADX DEBUG: Type inference failed for r2v1. Raw type applied. Possible types: io.reactivex.rxjava3.core.Observable<U extends java.util.Collection<? super T>>, io.reactivex.rxjava3.core.Observable<java.util.List<T>> */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("none")
    public final Observable<List<T>> buffer(int i, int i2) {
        return (Observable<U>) buffer(i, i2, ArrayListSupplier.asSupplier());
    }
    ...
    /* JADX DEBUG: Type inference failed for r3v1. Raw type applied. Possible types: io.reactivex.rxjava3.core.Observable<io.reactivex.rxjava3.observables.GroupedObservable<K, V>>, io.reactivex.rxjava3.core.Observable<io.reactivex.rxjava3.observables.GroupedObservable<K, T>> */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("none")
    ...
    /* JADX DEBUG: Type inference failed for r2v3. Raw type applied. Possible types: io.reactivex.rxjava3.core.Observable<U>, io.reactivex.rxjava3.core.Observable<T> */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("none")
    ...
    public final <V> Observable<T> timeout(@NonNull Function<? super T, ? extends ObservableSource<V>> function, @NonNull ObservableSource<? extends T> observableSource) {
        Objects.requireNonNull(observableSource, "fallback is null");
        Objects.requireNonNull(function, "itemTimeoutIndicator is null");
        return RxJavaPlugins.onAssembly(new ObservableTimeout(this, null, function, observableSource));
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r9v0, resolved type: io.reactivex.rxjava3.functions.BiFunction<? super T, ? super U, ? extends V> */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX DEBUG: Type inference failed for r8v1. Raw type applied. Possible types: io.reactivex.rxjava3.core.Observable<R>, io.reactivex.rxjava3.core.Observable<V> */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("none")
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: io.reactivex.rxjava3.core.Observable<T> */
    /* JADX WARN: Multi-variable type inference failed */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("none")
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: io.reactivex.rxjava3.functions.Supplier<? extends java.util.Map<K, V>> */
    /* JADX WARN: Multi-variable type inference failed */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("none")
    ...
    /* JADX DEBUG: Type inference failed for r9v1. Raw type applied. Possible types: io.reactivex.rxjava3.core.Observable<U extends java.util.Collection<? super T>>, io.reactivex.rxjava3.core.Observable<java.util.List<T>> */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("io.reactivex:computation")
    public final Observable<List<T>> buffer(long j, long j2, @NonNull TimeUnit timeUnit) {
        return (Observable<U>) buffer(j, j2, timeUnit, Schedulers.computation(), ArrayListSupplier.asSupplier());
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: io.reactivex.rxjava3.functions.Supplier<? extends java.util.Map<K, java.util.Collection<V>>> */
    /* JADX WARN: Multi-variable type inference failed */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("none")
    ...
    public final Observable<List<T>> buffer(long j, long j2, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler) {
        return (Observable<U>) buffer(j, j2, timeUnit, scheduler, ArrayListSupplier.asSupplier());
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: io.reactivex.rxjava3.functions.Function<? super T, ? extends io.reactivex.rxjava3.core.ObservableSource<V>> */
    /* JADX WARN: Multi-variable type inference failed */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("none")
    ...
    public final Observable<List<T>> buffer(long j, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler, int i) {
        return (Observable<U>) buffer(j, timeUnit, scheduler, i, ArrayListSupplier.asSupplier(), false);
    }
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T> Observable<T> just(@NonNull T t, @NonNull T t2, @NonNull T t3, @NonNull T t4, @NonNull T t5, @NonNull T t7) {
        Objects.requireNonNull(t, "item1 is null");
        Objects.requireNonNull(t2, "item2 is null");
        Objects.requireNonNull(t3, "item3 is null");
        Objects.requireNonNull(t4, "item4 is null");
        ...
        return fromArray(t, t2, t3, t4, t5, t7);
    }
    ...
    public final Observable<List<T>> buffer(long j, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler) {
        return (Observable<U>) buffer(j, timeUnit, scheduler, Integer.MAX_VALUE, ArrayListSupplier.asSupplier(), false);
    }
    ...
    public final <TOpening, TClosing> Observable<List<T>> buffer(@NonNull ObservableSource<? extends TOpening> observableSource, @NonNull Function<? super TOpening, ? extends ObservableSource<? extends TClosing>> function) {
        return (Observable<U>) buffer(observableSource, function, ArrayListSupplier.asSupplier());
    }
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T> Observable<T> just(@NonNull T t, @NonNull T t2, @NonNull T t3, @NonNull T t4, @NonNull T t5, @NonNull T t7, @NonNull T t8) {
        Objects.requireNonNull(t, "item1 is null");
        Objects.requireNonNull(t2, "item2 is null");
        Objects.requireNonNull(t3, "item3 is null");
        Objects.requireNonNull(t4, "item4 is null");
        ...
        return fromArray(t, t2, t3, t4, t5, t7, t8);
    }
    ...
    public final <B> Observable<List<T>> buffer(@NonNull ObservableSource<B> observableSource) {
        return (Observable<U>) buffer(observableSource, ArrayListSupplier.asSupplier());
    }
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T> Observable<T> just(@NonNull T t, @NonNull T t2, @NonNull T t3, @NonNull T t4, @NonNull T t5, @NonNull T t7, @NonNull T t8, @NonNull T t9) {
        Objects.requireNonNull(t, "item1 is null");
        Objects.requireNonNull(t2, "item2 is null");
        Objects.requireNonNull(t3, "item3 is null");
        Objects.requireNonNull(t4, "item4 is null");
        ...
        return fromArray(t, t2, t3, t4, t5, t7, t8, t9);
    }
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T> Observable<T> just(@NonNull T t, @NonNull T t2, @NonNull T t3, @NonNull T t4, @NonNull T t5, @NonNull T t7, @NonNull T t8, @NonNull T t9, @NonNull T t10) {
        Objects.requireNonNull(t, "item1 is null");
        Objects.requireNonNull(t2, "item2 is null");
        Objects.requireNonNull(t3, "item3 is null");
        Objects.requireNonNull(t4, "item4 is null");
        ...
        return fromArray(t, t2, t3, t4, t5, t7, t8, t9, t10);
    }
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T> Observable<T> just(@NonNull T t, @NonNull T t2, @NonNull T t3, @NonNull T t4, @NonNull T t5, @NonNull T t7, @NonNull T t8, @NonNull T t9, @NonNull T t10, @NonNull T t11) {
        Objects.requireNonNull(t, "item1 is null");
        Objects.requireNonNull(t2, "item2 is null");
        Objects.requireNonNull(t3, "item3 is null");
        Objects.requireNonNull(t4, "item4 is null");
        ...
        return fromArray(t, t2, t3, t4, t5, t7, t8, t9, t10, t11);
    }
