...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public static <T> Maybe<T> fromOptional(@NonNull Optional<T> optional) {
        ...
        return optional.map(f.a).orElseGet(a.a);
    }
    ...
    /* JADX DEBUG: Type inference failed for r2v2. Raw type applied. Possible types: io.reactivex.rxjava3.core.Maybe<R>, io.reactivex.rxjava3.core.Maybe<U> */
    @CheckReturnValue
    @NonNull
    @SchedulerSupport("none")
