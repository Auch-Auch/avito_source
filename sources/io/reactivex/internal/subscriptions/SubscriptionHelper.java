...
public enum SubscriptionHelper implements Subscription {
    ...
    public static void reportMoreProduced(long j) {
        RxJavaPlugins.onError(new ProtocolViolationException(a.T2("More produced than requested: ", j)));
    }
    ...
    public static boolean validate(long j) {
        ...
        RxJavaPlugins.onError(new IllegalArgumentException(a.T2("n > 0 required but it was ", j)));
        return false;
    }
