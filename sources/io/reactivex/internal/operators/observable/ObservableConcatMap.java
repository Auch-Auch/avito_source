...
public final class ObservableConcatMap<T, U> extends s6.a.c.b.c.a<T, U> {
    ...
    public static final class a<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public static final class C0415a<R> extends AtomicReference<Disposable> implements Observer<R> {
            private static final long serialVersionUID = 2620149119579502636L;
            public final Observer<? super R> a;
            public final a<?, R> b;

            public C0415a(Observer<? super R> observer, a<?, R> aVar) {
                this.a = observer;
                this.b = aVar;
            }
        ...
        public a(Observer<? super R> observer, Function<? super T, ? extends ObservableSource<? extends R>> function, int i2, boolean z) {
            ...
            this.c = i2;
            this.f = z;
            this.e = new C0415a<>(observer, this);
        }
