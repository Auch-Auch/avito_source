...
public final class ObservableJoin<TLeft, TRight, TLeftEnd, TRightEnd, R> extends s6.a.c.b.c.a<TLeft, R> {
    ...
    public static final class a<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AtomicInteger implements Disposable, ObservableGroupJoin.b {
        ...
        @Override // io.reactivex.internal.operators.observable.ObservableGroupJoin.b
        public void e(boolean z, ObservableGroupJoin.c cVar) {
            synchronized (this) {
                        ...
                        if (num == n) {
                            ...
                            try {
                                ...
                                for (TRight tright : this.e.values()) {
                                    try {
                                        observer.onNext((Object) ObjectHelper.requireNonNull(this.i.apply(poll, tright), "The resultSelector returned a null value"));
                                    } catch (Throwable th) {
                            ...
                            try {
                                ...
                                for (TLeft tleft : this.d.values()) {
                                    try {
                                        observer.onNext((Object) ObjectHelper.requireNonNull(this.i.apply(tleft, poll), "The resultSelector returned a null value"));
                                    } catch (Throwable th3) {
