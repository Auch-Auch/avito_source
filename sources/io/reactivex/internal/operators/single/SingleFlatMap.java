...
public final class SingleFlatMap<T, R> extends Single<R> {
    ...
    public static final class a<T, R> extends AtomicReference<Disposable> implements SingleObserver<T>, Disposable {
        ...
        public static final class C0433a<R> implements SingleObserver<R> {
            public final AtomicReference<Disposable> a;
            public final SingleObserver<? super R> b;

            public C0433a(AtomicReference<Disposable> atomicReference, SingleObserver<? super R> singleObserver) {
        ...
        public void onSuccess(T t) {
            try {
                ...
                if (!isDisposed()) {
                    singleSource.subscribe(new C0433a(this, this.a));
                }
            } catch (Throwable th) {
