...
public final class FlowableInternalHelper {
    ...
    public static final class f<T, U> implements Function<T, Publisher<T>> {
        ...
        @Override // io.reactivex.functions.Function
        public Object apply(Object obj) throws Exception {
            return new FlowableTakePublisher((Publisher) ObjectHelper.requireNonNull(this.a.apply(obj), "The itemDelay returned a null Publisher"), 1).map(Functions.justFunction(obj)).defaultIfEmpty(obj);
        }
    }
