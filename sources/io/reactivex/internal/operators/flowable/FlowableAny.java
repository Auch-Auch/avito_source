...
public final class FlowableAny<T> extends s6.a.c.b.a.a<T, Boolean> {
    ...
    public static final class a<T> extends DeferredScalarSubscription<Boolean> implements FlowableSubscriber<T> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: io.reactivex.internal.operators.flowable.FlowableAny$a<T> */
