...
public final class FlowableSubscribeOn<T> extends s6.a.c.b.a.a<T, T> {
    ...
    public static final class a<T> extends AtomicReference<Thread> implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        public static final class RunnableC0389a implements Runnable {
            ...
            public RunnableC0389a(Subscription subscription, long j) {
                this.a = subscription;
                this.b = j;
            }
        ...
        public void a(long j, Subscription subscription) {
            if (this.e || Thread.currentThread() == get()) {
                ...
                this.b.schedule(new RunnableC0389a(subscription, j));
            }
        }
