...
public final class MaybeOnErrorNext<T> extends s6.a.c.b.b.a<T, T> {
    ...
    public static final class a<T> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
        ...
        public static final class C0396a<T> implements MaybeObserver<T> {
            public final MaybeObserver<? super T> a;
            public final AtomicReference<Disposable> b;

            public C0396a(MaybeObserver<? super T> maybeObserver, AtomicReference<Disposable> atomicReference) {
        ...
        public void onError(Throwable th) {
            if (this.c || (th instanceof Exception)) {
                try {
                    ...
                    maybeSource.subscribe(new C0396a(this.a, this));
                } catch (Throwable th2) {
