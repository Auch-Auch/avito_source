...
public final class MaybeSwitchIfEmptySingle<T> extends Single<T> implements HasUpstreamMaybeSource<T> {
    ...
    public static final class a<T> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
        ...
        public static final class C0398a<T> implements SingleObserver<T> {
            public final SingleObserver<? super T> a;
            public final AtomicReference<Disposable> b;

            public C0398a(SingleObserver<? super T> singleObserver, AtomicReference<Disposable> atomicReference) {
        ...
        public void onComplete() {
            ...
            if (disposable != DisposableHelper.DISPOSED && compareAndSet(disposable, null)) {
                this.b.subscribe(new C0398a(this.a, this));
            }
        }
