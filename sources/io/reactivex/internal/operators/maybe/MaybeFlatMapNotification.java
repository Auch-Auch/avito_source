...
public final class MaybeFlatMapNotification<T, R> extends s6.a.c.b.b.a<T, R> {
    ...
    public static final class a<T, R> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
        ...
        public final class C0394a implements MaybeObserver<R> {
            public C0394a() {
            }
        ...
        public void onComplete() {
            try {
                ((MaybeSource) ObjectHelper.requireNonNull(this.d.call(), "The onCompleteSupplier returned a null MaybeSource")).subscribe(new C0394a());
            } catch (Exception e2) {
        ...
        public void onError(Throwable th) {
            try {
                ((MaybeSource) ObjectHelper.requireNonNull(this.c.apply(th), "The onErrorMapper returned a null MaybeSource")).subscribe(new C0394a());
            } catch (Exception e2) {
                Exceptions.throwIfFatal(e2);
        ...
        public void onSuccess(T t) {
            try {
                ((MaybeSource) ObjectHelper.requireNonNull(this.b.apply(t), "The onSuccessMapper returned a null MaybeSource")).subscribe(new C0394a());
            } catch (Exception e2) {
                Exceptions.throwIfFatal(e2);
                this.a.onError(e2);
            }
