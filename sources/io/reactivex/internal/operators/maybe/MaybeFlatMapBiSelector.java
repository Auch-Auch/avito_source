...
public final class MaybeFlatMapBiSelector<T, U, R> extends s6.a.c.b.b.a<T, R> {
    ...
    public static final class a<T, U, R> implements MaybeObserver<T>, Disposable {
        ...
        public static final class C0393a<T, U, R> extends AtomicReference<Disposable> implements MaybeObserver<U> {
            private static final long serialVersionUID = -2897979525538174559L;
            public final MaybeObserver<? super R> a;
            public final BiFunction<? super T, ? super U, ? extends R> b;
            public T c;

            public C0393a(MaybeObserver<? super R> maybeObserver, BiFunction<? super T, ? super U, ? extends R> biFunction) {
        ...
        public a(MaybeObserver<? super R> maybeObserver, Function<? super T, ? extends MaybeSource<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction) {
            this.b = new C0393a<>(maybeObserver, biFunction);
            this.a = function;
        }
