...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> just(T t, T t2, T t3, T t4, T t5, T t7) {
        ObjectHelper.requireNonNull(t, "item1 is null");
        ObjectHelper.requireNonNull(t2, "item2 is null");
        ObjectHelper.requireNonNull(t3, "item3 is null");
        ObjectHelper.requireNonNull(t4, "item4 is null");
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> just(T t, T t2, T t3, T t4, T t5, T t7, T t8) {
        ObjectHelper.requireNonNull(t, "item1 is null");
        ObjectHelper.requireNonNull(t2, "item2 is null");
        ObjectHelper.requireNonNull(t3, "item3 is null");
        ObjectHelper.requireNonNull(t4, "item4 is null");
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> just(T t, T t2, T t3, T t4, T t5, T t7, T t8, T t9) {
        ObjectHelper.requireNonNull(t, "item1 is null");
        ObjectHelper.requireNonNull(t2, "item2 is null");
        ObjectHelper.requireNonNull(t3, "item3 is null");
        ObjectHelper.requireNonNull(t4, "item4 is null");
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> just(T t, T t2, T t3, T t4, T t5, T t7, T t8, T t9, T t10) {
        ObjectHelper.requireNonNull(t, "item1 is null");
        ObjectHelper.requireNonNull(t2, "item2 is null");
        ObjectHelper.requireNonNull(t3, "item3 is null");
        ObjectHelper.requireNonNull(t4, "item4 is null");
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> just(T t, T t2, T t3, T t4, T t5, T t7, T t8, T t9, T t10, T t11) {
        ObjectHelper.requireNonNull(t, "item1 is null");
        ObjectHelper.requireNonNull(t2, "item2 is null");
        ObjectHelper.requireNonNull(t3, "item3 is null");
        ObjectHelper.requireNonNull(t4, "item4 is null");
