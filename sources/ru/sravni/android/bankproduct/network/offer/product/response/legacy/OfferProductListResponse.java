...
public final class OfferProductListResponse {
    ...
    public static final class ItemResponse {
        ...
        public static final class OfferGroupResponse {
            ...
            public static final class OfferResponse {
                ...
                public static final class DetailParamResponse {
                    ...
                    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: ru.sravni.android.bankproduct.network.offer.product.response.legacy.OfferProductListResponse$ItemResponse$OfferGroupResponse$OfferResponse$DetailParamResponse */
                ...
                public OfferResponse(@NotNull String str, @NotNull OfferProductDisplaySettingsResponse offerProductDisplaySettingsResponse, @Nullable Integer num, @Nullable String str2, @NotNull String str3, @Nullable String str4, @Nullable String str5, @Nullable String str6, @Nullable String str7, @Nullable String str8, @Nullable String str9, @NotNull List<MainParamResponse> list, @NotNull List<DetailParamResponse> list2, @Nullable String str10) {
                ...
                public static /* synthetic */ OfferResponse copy$default(OfferResponse offerResponse, String str, OfferProductDisplaySettingsResponse offerProductDisplaySettingsResponse, Integer num, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, List list, List list2, String str10, int i, Object obj) {
                ...
                public final OfferResponse copy(@NotNull String str, @NotNull OfferProductDisplaySettingsResponse offerProductDisplaySettingsResponse, @Nullable Integer num, @Nullable String str2, @NotNull String str3, @Nullable String str4, @Nullable String str5, @Nullable String str6, @Nullable String str7, @Nullable String str8, @Nullable String str9, @NotNull List<MainParamResponse> list, @NotNull List<DetailParamResponse> list2, @Nullable String str10) {
                    ...
                    Intrinsics.checkParameterIsNotNull(list, "mainParams");
                    Intrinsics.checkParameterIsNotNull(list2, "detailParams");
                    return new OfferResponse(str, offerProductDisplaySettingsResponse, num, str2, str3, str4, str5, str6, str7, str8, str9, list, list2, str10);
                }
                ...
                public String toString() {
                    ...
                    return a.t(L, this.requestParams, ")");
                }

                /* JADX INFO: this call moved to the top of the method (can break code semantics) */
                public /* synthetic */ OfferResponse(String str, OfferProductDisplaySettingsResponse offerProductDisplaySettingsResponse, Integer num, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, List list, List list2, String str10, int i, j jVar) {
            ...
            /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: ru.sravni.android.bankproduct.network.offer.product.response.legacy.OfferProductListResponse$ItemResponse$OfferGroupResponse */
            /* JADX WARN: Multi-variable type inference failed */
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: ru.sravni.android.bankproduct.network.offer.product.response.legacy.OfferProductListResponse$ItemResponse */
        /* JADX WARN: Multi-variable type inference failed */
