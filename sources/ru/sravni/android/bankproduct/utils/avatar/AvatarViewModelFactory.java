...
public final class AvatarViewModelFactory implements ViewModelProvider.Factory {
    ...
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        ...
        return new AvatarViewModel(this.a, this.b, this.c);
    }
}
