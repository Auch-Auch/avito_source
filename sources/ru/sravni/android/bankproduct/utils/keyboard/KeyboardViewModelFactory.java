...
public final class KeyboardViewModelFactory implements ViewModelProvider.Factory {
    ...
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        ...
        return new KeyboardViewModel(this.a, this.b);
    }
}
