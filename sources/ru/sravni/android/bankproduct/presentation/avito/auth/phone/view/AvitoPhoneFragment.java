package ru.sravni.android.bankproduct.presentation.avito.auth.phone.view;
...
import ru.sravni.android.bankproduct.databinding.AvitoPhoneFragmentSravniBinding;
...
public final class AvitoPhoneFragment extends CommonFragment {
    ...
    public View onCreateView(@NotNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        ViewDataBinding inflate = DataBindingUtil.inflate(layoutInflater, R.layout.avito_phone_fragment_sravni, viewGroup, false);
        Intrinsics.checkExpressionValueIsNotNull(inflate, "DataBindingUtil.inflate(…      false\n            )");
        AvitoPhoneFragmentSravniBinding avitoPhoneFragmentSravniBinding = (AvitoPhoneFragmentSravniBinding) inflate;
        IProfilePhoneViewModel iProfilePhoneViewModel = (IProfilePhoneViewModel) KodeinAwareKt.getDirect(this).getDkodein().Instance(TypesKt.TT(new TypeReference<IProfilePhoneViewModel>() { // from class: ru.sravni.android.bankproduct.presentation.avito.auth.phone.view.AvitoPhoneFragment$onCreateView$$inlined$instance$1
        }), null);
        this.e = iProfilePhoneViewModel;
        if (iProfilePhoneViewModel == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
        }
        avitoPhoneFragmentSravniBinding.setPhoneViewModel(iProfilePhoneViewModel);
        avitoPhoneFragmentSravniBinding.setLifecycleOwner(getViewLifecycleOwner());
        View root = avitoPhoneFragmentSravniBinding.getRoot();
        ...
        if (activity != null) {
            ...
            return avitoPhoneFragmentSravniBinding.getRoot();
        }
