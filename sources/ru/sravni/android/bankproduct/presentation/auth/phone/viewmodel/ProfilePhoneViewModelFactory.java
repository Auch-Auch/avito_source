...
public final class ProfilePhoneViewModelFactory implements ViewModelProvider.Factory {
    ...
    public final ILoginAnalytic f;
    public final String g;

    public ProfilePhoneViewModelFactory(@NotNull INavigator iNavigator, @NotNull IAuthInteractor iAuthInteractor, @NotNull IErrorLogger iErrorLogger, @NotNull IThrowableWrapper iThrowableWrapper, @NotNull IPreviousModuleInfo iPreviousModuleInfo, @NotNull ILoginAnalytic iLoginAnalytic, @NotNull String str) {
    ...
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        ...
        return new ProfilePhoneViewModel(this.a, this.b, this.c, this.d, this.e, this.f, this.g);
    }
}
