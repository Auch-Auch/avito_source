...
public final class TokenTokenFailDialogViewModelFactory implements ViewModelProvider.Factory {
    ...
    public TokenTokenFailDialogViewModelFactory(@NotNull INavigator iNavigator, @NotNull ITokenInteractor iTokenInteractor, @NotNull IBottomSnackbarShower iBottomSnackbarShower, @NotNull IResourceProvider iResourceProvider) {
        ...
        this.a = iNavigator;
        this.b = iTokenInteractor;
        this.c = iBottomSnackbarShower;
    ...
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        ...
        return new TokenTokenFailDialogViewModel(this.a, this.b, this.c, this.d);
    }
}
