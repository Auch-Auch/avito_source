package ru.sravni.android.bankproduct.presentation.splash;
...
public final class PresentationSplashErrorDescriptionMapper implements IThrowableErrorDescriptionMapper {
    ...
    public ErrorDescription mapToError(@NotNull Throwable th) {
        ...
        if (th instanceof UnknownNextAfterScreenException) {
            return new ErrorDescription(10, "UNAS", "Unknown and unsupported NextAfterScreen enum value", null, 8, null);
        }
        return null;
    }
}
