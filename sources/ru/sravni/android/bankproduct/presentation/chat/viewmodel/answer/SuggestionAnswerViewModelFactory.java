...
public final class SuggestionAnswerViewModelFactory implements ViewModelProvider.Factory {
    ...
    public SuggestionAnswerViewModelFactory(@NotNull IChatInteractor iChatInteractor, @NotNull IKeyboardTypeConverter iKeyboardTypeConverter, @NotNull IErrorLogger iErrorLogger, @NotNull IThrowableWrapper iThrowableWrapper) {
    ...
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        ...
        return new SuggestionAnswerViewModel(this.a, this.b, this.c, this.d);
    }
}
