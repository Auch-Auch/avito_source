...
public final class PassportScanViewModelFactory implements ViewModelProvider.Factory {
    ...
    public PassportScanViewModelFactory(@NotNull IThrowableWrapper iThrowableWrapper, @NotNull IErrorHandlerWithShow iErrorHandlerWithShow, @NotNull IResourceProvider iResourceProvider, @NotNull IErrorLogger iErrorLogger) {
    ...
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        ...
        return new PassportScanAnswerViewModel(this.a, this.b, this.c, this.d);
    }
}
