...
public final class OsagoOffersAnswerViewModelFactory implements ViewModelProvider.Factory {
    ...
    public OsagoOffersAnswerViewModelFactory(@NotNull INavigator iNavigator, @NotNull IErrorHandlerWithShow iErrorHandlerWithShow, @NotNull IThrowableWrapper iThrowableWrapper, @NotNull IProductNameDictionary iProductNameDictionary) {
    ...
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        ...
        return new OsagoOffersAnswerViewModel(this.a, this.b, this.c, this.d);
    }
}
