...
public final class CreditDetailAnswerViewModelFactory implements ViewModelProvider.Factory {
    ...
    public CreditDetailAnswerViewModelFactory(@NotNull INavigator iNavigator, @NotNull IErrorHandlerWithShow iErrorHandlerWithShow, @NotNull IThrowableWrapper iThrowableWrapper, @NotNull IResourceProvider iResourceProvider) {
    ...
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        ...
        return new CreditDetailAnswerViewModel(this.a, this.b, this.c, this.d);
    }
}
