...
public final class GoToDashboardAnswerViewModelFactory implements ViewModelProvider.Factory {
    ...
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        ...
        return new GoToDashboardAnswerViewModel(this.a);
    }
}
