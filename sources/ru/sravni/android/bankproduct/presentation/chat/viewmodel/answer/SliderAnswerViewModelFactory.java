...
public final class SliderAnswerViewModelFactory implements ViewModelProvider.Factory {
    ...
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        ...
        return new SliderAnswerViewModel(this.a, this.b);
    }
}
