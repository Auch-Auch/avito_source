...
public final class PresentationBottomNavivationErrorDescriptionMapper implements IThrowableErrorDescriptionMapper {
    ...
    public ErrorDescription mapToError(@NotNull Throwable th) {
        ...
        if (th instanceof ScreenNotFoundError) {
            return PresentationBottomNavivationErrorDescriptionMapperKt.access$screenNotFoundErrorDescription((ScreenNotFoundError) th);
        }
        return null;
    }
}
