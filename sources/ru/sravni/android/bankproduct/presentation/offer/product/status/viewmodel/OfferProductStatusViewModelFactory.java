...
public final class OfferProductStatusViewModelFactory implements ViewModelProvider.Factory {
    ...
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        ...
        return new OfferProductStatusViewModel(this.a, this.b);
    }
}
