...
public final class OfferProductInfoFromListViewModelFactory implements ViewModelProvider.Factory {
    ...
    public OfferProductInfoFromListViewModelFactory(@NotNull IOfferProductInteractor iOfferProductInteractor, @NotNull IOfferProductInfoController iOfferProductInfoController, @NotNull IFeatureToggleRouterDomain iFeatureToggleRouterDomain, @NotNull IProductNameDictionary iProductNameDictionary) {
    ...
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        ...
        return new OfferProductInfoFromListViewModel(this.a, this.b, this.c, this.d);
    }
}
