...
public final class PresentationOfferProductStatusKodeinModuleKt {
    ...
    public static final class a extends Lambda implements Function1<Kodein.Builder, Unit> {
        ...
        public Unit invoke(Kodein.Builder builder) {
            ...
            builder2.Bind(TypesKt.TT(new PresentationOfferProductStatusKodeinModuleKt$presentationOfferProductStatusKodeinModule$1$$special$$inlined$bind$1()), null, null).with(new Provider(builder2.getContextType(), TypesKt.TT(new PresentationOfferProductStatusKodeinModuleKt$presentationOfferProductStatusKodeinModule$1$$special$$inlined$provider$1()), a7.c.a.a.o.f.b.c.a.a.a));
