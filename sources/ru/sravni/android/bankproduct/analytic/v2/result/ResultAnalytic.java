...
public final class ResultAnalytic implements IResultAnalytic, IBaseAnalytic {
    ...
    public ResultAnalytic(@NotNull IAnalyticEventLogger iAnalyticEventLogger) {
        Intrinsics.checkParameterIsNotNull(iAnalyticEventLogger, "eventLogger");
        this.b = new BaseAnalytic("result", iAnalyticEventLogger);
    ...
    public void sendResultEditEvent(@NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4) {
        ...
        Intrinsics.checkParameterIsNotNull(str3, AnalyticFieldsName.field);
        Intrinsics.checkParameterIsNotNull(str4, "previousStep");
        Map mutableMapOf = r.mutableMapOf(TuplesKt.to(AnalyticFieldsName.searchId, str), TuplesKt.to(AnalyticFieldsName.field, str3), TuplesKt.to(AnalyticFieldsName.productName, str2));
        IBaseAnalytic.DefaultImpls.sendEvent$default(this, getModuleName() + BaseAnalyticKt.ANALYTIC_ACTION_EDIT, str4, mutableMapOf, null, 8, null);
    }

    @Override // ru.sravni.android.bankproduct.analytic.v2.result.IResultAnalytic
    public void sendResultFailEvent(@NotNull String str, @NotNull String str2, @Nullable Boolean bool, @NotNull String str3, @Nullable Boolean bool2) {
        a.a1(str, "errorType", str2, AnalyticFieldsName.productName, str3, "previousStep");
        Map<String, String> mutableMapOf = r.mutableMapOf(TuplesKt.to(AnalyticFieldsName.productName, str2), TuplesKt.to(AnalyticFieldsName.route, String.valueOf(bool)));
        if (Intrinsics.areEqual(bool2, Boolean.TRUE)) {
            mutableMapOf.put("push", String.valueOf(bool2.booleanValue()));
        }
        if (bool != null) {
            bool.booleanValue();
            TuplesKt.to(AnalyticFieldsName.route, String.valueOf(bool.booleanValue()));
        }
        sendFailEvent(str, str3, mutableMapOf);
    }

    @Override // ru.sravni.android.bankproduct.analytic.v2.result.IResultAnalytic
    public void sendResultOpenEvent(@NotNull String str, @NotNull String str2, int i, @Nullable Boolean bool, @NotNull String str3, @Nullable Boolean bool2) {
        a.a1(str, AnalyticFieldsName.searchId, str2, AnalyticFieldsName.productName, str3, "previousStep");
        Map mutableMapOf = r.mutableMapOf(TuplesKt.to(AnalyticFieldsName.searchId, str), TuplesKt.to(AnalyticFieldsName.offersCount, String.valueOf(i)), TuplesKt.to(AnalyticFieldsName.productName, str2));
        if (Intrinsics.areEqual(bool2, Boolean.TRUE)) {
            mutableMapOf.put("push", String.valueOf(bool2.booleanValue()));
        }
        if (bool != null) {
        ...
        IBaseAnalytic.DefaultImpls.sendOpenEvent$default(this, str3, mutableMapOf, null, 4, null);
    }
}
