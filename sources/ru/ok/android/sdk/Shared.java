...
public interface Shared {
    ...
    public static final String PARAM_ALLOW_DEBUG_OK_SSO = "allowDebugOkSso";
    ...
    public static final String PARAM_SDK_TOKEN = "sdkToken";
    ...
    public static final List<String> WIDGET_SIGNED_ARGS = Arrays.asList("st.attachment", "st.return", "st.redirect_uri", "st.state");
}
