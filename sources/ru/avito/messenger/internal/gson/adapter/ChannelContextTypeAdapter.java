...
public final class ChannelContextTypeAdapter extends KeyRuntimeTypeAdapter<ChannelContext> {
    ...
    public static final class a extends Lambda implements Function2<TypeId, JsonObject, ChannelContext> {
        ...
        public ChannelContext invoke(TypeId typeId, JsonObject jsonObject) {
    ...
    public /* synthetic */ ChannelContextTypeAdapter(Map map, Logger logger, int i, j jVar) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r9v0, resolved type: java.util.Map<ru.avito.messenger.internal.gson.TypeId, ? extends java.lang.reflect.Type> */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ChannelContextTypeAdapter(@NotNull Map<TypeId, ? extends Type> map, @Nullable Logger logger) {
