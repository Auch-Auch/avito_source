...
public class b {
        ...
        for (int i = 0; i < 10; i += 2) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                while (i4 < 1023) {
                    ...
                    short s = sArr2[i5];
                    sArr[i4] = (short) (i6 + i8);
                    sArr[i7] = AppCompatDelegateImpl.i.k1(((i6 + 36867) - i8) * s);
                    i4 += i2 * 2;
                    i5 = i9;
                }
            }
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                ...
                while (i12 < 1023) {
                    ...
                    int i17 = i13 + 1;
                    short s2 = sArr2[i13];
                    sArr[i12] = AppCompatDelegateImpl.i.k((short) (i14 + i16));
                    sArr[i15] = AppCompatDelegateImpl.i.k1(((i14 + 36867) - i16) * s2);
                    i12 += i10 * 2;
                    i13 = i17;
                }
            }
    ...
    public static void b(short[] sArr, short[] sArr2) {
        for (int i = 0; i < 1024; i++) {
            sArr[i] = AppCompatDelegateImpl.i.k1((sArr[i] & UShort.MAX_VALUE) * (65535 & sArr2[i]));
        }
    }
}
