...
public class m extends l {
    ...
    public static final boolean isBlank(@org.jetbrains.annotations.NotNull java.lang.CharSequence r4) {
        ...
        L_0x0024:
            ...
            boolean r3 = t6.y.a.isWhitespace(r3)
        ...
        L_0x003f:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: t6.y.m.isBlank(java.lang.CharSequence):boolean");
    }
    ...
    public static final String repeat(@NotNull CharSequence charSequence, int i) {
        ...
        int i2 = 1;
        if (!(i >= 0)) {
            throw new IllegalArgumentException(("Count 'n' must be non-negative, but was " + i + FormatterType.defaultDecimalSeparator).toString());
        } else if (i == 0) {
            return "";
        } else {
            if (i == 1) {
    ...
    public static final String replaceFirst(@NotNull String str, @NotNull String str2, @NotNull String str3, boolean z) {
        a.Z0(str, "$this$replaceFirst", str2, "oldValue", str3, "newValue");
    ...
    public static final String replace(@NotNull String str, @NotNull String str2, @NotNull String str3, boolean z) {
        ...
        int coerceAtLeast = e.coerceAtLeast(length, 1);
