...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
    ...
    public Object f;
    public int g;
    public final /* synthetic */ FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1 h;
    ...
    public FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1(Continuation continuation, FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1 flowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1) {
        ...
        this.h = flowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1;
    }
    ...
    public final Continuation<Unit> create(@NotNull FlowCollector<? super R> flowCollector, @NotNull T[] tArr, @NotNull Continuation<? super Unit> continuation) {
        FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1 flowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1 = new FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1(continuation, this.h);
        flowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1.b = flowCollector;
        flowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1.c = tArr;
