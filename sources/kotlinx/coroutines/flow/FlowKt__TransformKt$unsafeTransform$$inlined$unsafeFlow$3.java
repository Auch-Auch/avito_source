...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$3 implements Flow<R> {
    ...
    public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        Object collect = this.a.collect(new FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$3$lambda$1(flowCollector, this), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        InlineMarker.mark(4);
        new ContinuationImpl(this, continuation) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$3.1
            public /* synthetic */ Object a;
            public int b;
            public final /* synthetic */ FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$3 c;
