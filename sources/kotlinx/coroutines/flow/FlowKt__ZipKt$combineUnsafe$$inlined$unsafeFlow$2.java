...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2 implements Flow<R> {
    ...
    public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        Object combineInternal = CombineKt.combineInternal(flowCollector, this.a, l0.a, new FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2$lambda$1(null, this), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        InlineMarker.mark(4);
        new ContinuationImpl(this, continuation) { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2.1
            public /* synthetic */ Object a;
            public int b;
            public final /* synthetic */ FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2 c;
        ...
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, l0Var, flowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2$lambda$1, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
