...
public final class FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2 implements Flow<R> {
    ...
    public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        Object collect = this.a.collect(new FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2$lambda$1(flowCollector, this), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        InlineMarker.mark(4);
        new ContinuationImpl(this, continuation) { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2.1
            public /* synthetic */ Object a;
            public int b;
            public final /* synthetic */ FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2 c;
