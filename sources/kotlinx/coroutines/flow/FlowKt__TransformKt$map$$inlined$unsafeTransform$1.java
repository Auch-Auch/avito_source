...
public final class FlowKt__TransformKt$map$$inlined$unsafeTransform$1 implements Flow<R> {
    ...
    public Object collect(@NotNull final FlowCollector flowCollector, @NotNull Continuation continuation) {
        Object collect = this.a.collect(new FlowCollector<T>() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1.2
            ...
            public Object emit$$forInline(Object obj, @NotNull Continuation continuation2) {
                InlineMarker.mark(4);
                new ContinuationImpl(this, continuation2) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$map$.inlined.unsafeTransform.1.2.1
    ...
    public Object collect$$forInline(@NotNull final FlowCollector flowCollector, @NotNull Continuation continuation) {
        InlineMarker.mark(4);
        new ContinuationImpl(this, continuation) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1.1
            public /* synthetic */ Object a;
            public int b;
            public final /* synthetic */ FlowKt__TransformKt$map$$inlined$unsafeTransform$1 c;
        ...
        InlineMarker.mark(5);
        Flow flow = this.a;
        AnonymousClass2 r1 = new FlowCollector<T>() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1.2
            @Override // kotlinx.coroutines.flow.FlowCollector
            @org.jetbrains.annotations.Nullable
            /* Code decompiled incorrectly, please refer to instructions dump. */
            public java.lang.Object emit(java.lang.Object r11, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation r12) {
