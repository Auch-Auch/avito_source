...
public final class FlowKt__DelayKt$debounceInternal$1$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public Object d;
    public int e;
    public final /* synthetic */ FlowKt__DelayKt$debounceInternal$1 f;
    ...
    public FlowKt__DelayKt$debounceInternal$1$values$1(FlowKt__DelayKt$debounceInternal$1 flowKt__DelayKt$debounceInternal$1, Continuation continuation) {
        ...
        this.f = flowKt__DelayKt$debounceInternal$1;
    }
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        flowKt__DelayKt$debounceInternal$1$values$1.b = (ProducerScope) obj;
    ...
    public final Object invoke(ProducerScope<? super Object> producerScope, Continuation<? super Unit> continuation) {
        ...
        return flowKt__DelayKt$debounceInternal$1$values$1.invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            Flow flow = this.f.k;
            FlowKt__DelayKt$debounceInternal$1$values$1$invokeSuspend$$inlined$collect$1 flowKt__DelayKt$debounceInternal$1$values$1$invokeSuspend$$inlined$collect$1 = new FlowCollector<T>(producerScope) { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$values$1$invokeSuspend$$inlined$collect$1
