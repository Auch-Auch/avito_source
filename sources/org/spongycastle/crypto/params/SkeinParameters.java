...
public class SkeinParameters implements CipherParameters {
    ...
    public static class Builder {
        ...
        public SkeinParameters build() {
            return new SkeinParameters(this.a, null);
        }
        ...
        public Builder setPersonalisation(Date date, String str, String str2) {
            try {
                ...
                throw new IllegalStateException(a2.b.a.a.a.Z2("Byte I/O failed: ", e));
            }
        }
    ...
    public SkeinParameters(Hashtable hashtable, a aVar) {
        this.a = hashtable;
    }
}
