...
public class JPAKEParticipant {
    ...
    public BigInteger calculateKeyingMaterial() {
        int i2 = this.p;
        if (i2 >= 50) {
            StringBuilder L = a.L("Key already calculated for ");
            L.append(this.a);
            ...
            StringBuilder L2 = a.L("Round2 payload must be validated prior to creating key for ");
            L2.append(this.a);
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        if (this.p < 10) {
            ...
            this.p = 10;
            return new JPAKERound1Payload(this.a, this.k, this.l, calculateZeroKnowledgeProof, calculateZeroKnowledgeProof2);
        }
        StringBuilder L = a.L("Round1 payload already created for ");
        L.append(this.a);
        throw new IllegalStateException(L.toString());
    }
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        int i2 = this.p;
        if (i2 >= 30) {
            StringBuilder L = a.L("Round2 payload already created for ");
            L.append(this.a);
            throw new IllegalStateException(L.toString());
        } else if (i2 >= 20) {
            ...
            StringBuilder L2 = a.L("Round1 payload must be validated prior to creating Round2 payload for ");
            L2.append(this.a);
            throw new IllegalStateException(L2.toString());
        }
    }
    ...
    public JPAKERound3Payload createRound3PayloadToSend(BigInteger bigInteger) {
        int i2 = this.p;
        if (i2 >= 60) {
            StringBuilder L = a.L("Round3 payload already created for ");
            L.append(this.a);
            throw new IllegalStateException(L.toString());
        } else if (i2 >= 50) {
            ...
            StringBuilder L2 = a.L("Keying material must be calculated prior to creating Round3 payload for ");
            L2.append(this.a);
            throw new IllegalStateException(L2.toString());
        }
    }
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        ...
        StringBuilder L = a.L("Validation already attempted for round1 payload for");
        L.append(this.a);
        throw new IllegalStateException(L.toString());
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        int i2 = this.p;
        if (i2 >= 40) {
            StringBuilder L = a.L("Validation already attempted for round2 payload for");
            L.append(this.a);
            throw new IllegalStateException(L.toString());
        } else if (i2 >= 20) {
            ...
            StringBuilder L2 = a.L("Round1 payload must be validated prior to validating Round2 payload for ");
            L2.append(this.a);
            throw new IllegalStateException(L2.toString());
        }
    }
    ...
    public void validateRound3PayloadReceived(JPAKERound3Payload jPAKERound3Payload, BigInteger bigInteger) throws CryptoException {
        int i2 = this.p;
        if (i2 >= 70) {
            StringBuilder L = a.L("Validation already attempted for round3 payload for");
            L.append(this.a);
            throw new IllegalStateException(L.toString());
        } else if (i2 >= 50) {
            ...
            StringBuilder L2 = a.L("Keying material must be calculated validated prior to validating Round3 payload for ");
            L2.append(this.a);
            throw new IllegalStateException(L2.toString());
        }
    }
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        JPAKEUtil.validateNotNull(cArr, Preference.PASSWORD);
