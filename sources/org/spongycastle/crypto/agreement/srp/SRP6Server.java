...
public class SRP6Server {
    ...
    public BigInteger calculateSecret(BigInteger bigInteger) throws CryptoException {
        ...
        BigInteger calculateU = SRP6Util.calculateU(this.digest, this.N, validatePublicValue, this.B);
        this.u = calculateU;
        BigInteger modPow = this.v.modPow(calculateU, this.N).multiply(this.A).mod(this.N).modPow(this.b, this.N);
        this.S = modPow;
        return modPow;
    }
