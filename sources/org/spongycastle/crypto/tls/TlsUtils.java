...
public class TlsUtils {
    ...
    public static byte[] PRF(TlsContext tlsContext, byte[] bArr, String str, byte[] bArr2, int i) {
        if (!tlsContext.getServerVersion().isSSL()) {
            byte[] e = e(Strings.toByteArray(str), bArr2);
            int prfAlgorithm = tlsContext.getSecurityParameters().getPrfAlgorithm();
            if (prfAlgorithm == 0) {
                return a(bArr, e, i);
            }
            byte[] bArr3 = new byte[i];
            g(createPRFHash(prfAlgorithm), bArr, e, bArr3);
            return bArr3;
        }
    ...
    public static byte[] PRF_legacy(byte[] bArr, String str, byte[] bArr2, int i) {
        return a(bArr, e(Strings.toByteArray(str), bArr2), i);
    }
    ...
    public static byte[] a(byte[] bArr, byte[] bArr2, int i) {
        ...
        g(createHash((short) 1), bArr3, bArr2, bArr5);
        g(createHash((short) 2), bArr4, bArr2, bArr6);
    ...
    public static byte[] b(TlsContext tlsContext, int i) {
        ...
        byte[] e = e(securityParameters.getServerRandom(), securityParameters.getClientRandom());
        if (!isSSL(tlsContext)) {
            return PRF(tlsContext, masterSecret, "key expansion", e, i);
        }
        ...
        while (i2 < i) {
            byte[] bArr3 = c[i3];
            createHash2.update(bArr3, 0, bArr3.length);
            createHash2.update(masterSecret, 0, masterSecret.length);
            createHash2.update(e, 0, e.length);
            createHash2.doFinal(bArr, 0);
            createHash.update(masterSecret, 0, masterSecret.length);
            createHash.update(bArr, 0, digestSize2);
            createHash.doFinal(bArr2, i2);
            i2 += digestSize;
            i3++;
        }
    ...
    public static byte[] c(TlsContext tlsContext, byte[] bArr) {
        byte[] bArr2;
        SecurityParameters securityParameters = tlsContext.getSecurityParameters();
        if (securityParameters.o) {
            bArr2 = securityParameters.getSessionHash();
        } else {
            bArr2 = e(securityParameters.getClientRandom(), securityParameters.getServerRandom());
        }
        if (isSSL(tlsContext)) {
            Digest createHash = createHash((short) 1);
            Digest createHash2 = createHash((short) 2);
        ...
        return PRF(tlsContext, bArr, securityParameters.o ? ExporterLabel.extended_master_secret : "master secret", bArr2, 48);
    }
    ...
    public static byte[] d(TlsContext tlsContext, String str, byte[] bArr) {
        if (isSSL(tlsContext)) {
            return bArr;
        }
        SecurityParameters securityParameters = tlsContext.getSecurityParameters();
    ...
    public static short f(Certificate certificate) throws IOException {
    ...
    public static void g(Digest digest, byte[] bArr, byte[] bArr2, byte[] bArr3) {
    ...
    public static Vector getDefaultDSSSignatureAlgorithms() {
        return j(new SignatureAndHashAlgorithm(2, 2));
    }

    public static Vector getDefaultECDSASignatureAlgorithms() {
        return j(new SignatureAndHashAlgorithm(2, 3));
    }

    public static Vector getDefaultRSASignatureAlgorithms() {
        return j(new SignatureAndHashAlgorithm(2, 1));
    }
    ...
    public static void h(TlsHandshakeHash tlsHandshakeHash, Vector vector) {
        if (vector != null) {
            for (int i = 0; i < vector.size(); i++) {
    ...
    public static void i(Certificate certificate, int i) throws IOException {
    ...
    public static Vector j(Object obj) {
    ...
    public static long readUint32(byte[] bArr, int i) {
        int i2 = i + 1;
        int i3 = i2 + 1;
        return ((long) ((bArr[i3 + 1] & 255) | ((bArr[i] & 255) << 24) | ((bArr[i2] & 255) << 16) | ((bArr[i3] & 255) << 8))) & BodyPartID.bodyIdMax;
    }
