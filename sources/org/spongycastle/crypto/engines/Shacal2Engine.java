...
public class Shacal2Engine implements BlockCipher {
    ...
    public final void b(int[] iArr, byte[] bArr, int i) {
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws DataLengthException, IllegalStateException {
        if (this.b == null) {
            ...
            for (int i5 = 63; i5 > -1; i5--) {
                int i6 = (iArr2[0] - ((((iArr2[1] >>> 2) | (iArr2[1] << -2)) ^ ((iArr2[1] >>> 13) | (iArr2[1] << -13))) ^ ((iArr2[1] >>> 22) | (iArr2[1] << -22)))) - (((iArr2[1] & iArr2[2]) ^ (iArr2[1] & iArr2[3])) ^ (iArr2[2] & iArr2[3]));
                iArr2[0] = iArr2[1];
                iArr2[1] = iArr2[2];
                iArr2[2] = iArr2[3];
                iArr2[3] = iArr2[4] - i6;
                ...
                iArr2[5] = iArr2[6];
                iArr2[6] = iArr2[7];
                iArr2[7] = (((i6 - c[i5]) - this.b[i5]) - ((((iArr2[4] >>> 6) | (iArr2[4] << -6)) ^ ((iArr2[4] >>> 11) | (iArr2[4] << -11))) ^ ((iArr2[4] >>> 25) | (iArr2[4] << -25)))) - ((iArr2[4] & iArr2[5]) ^ ((~iArr2[4]) & iArr2[6]));
            }
            b(iArr2, bArr2, i2);
            return 32;
        }
        ...
        if (bArr.length != 0 && bArr.length <= 64) {
            if (bArr.length >= 16 && bArr.length % 8 == 0) {
                ...
                for (int i7 = 16; i7 < 64; i7++) {
                    ...
                    int i8 = i7 - 2;
                    int i9 = i7 - 15;
                    iArr2[i7] = ((iArr2[i8] >>> 10) ^ (((iArr2[i8] >>> 17) | (iArr2[i8] << -17)) ^ ((iArr2[i8] >>> 19) | (iArr2[i8] << -19)))) + iArr2[i7 - 7] + ((iArr2[i9] >>> 3) ^ (((iArr2[i9] >>> 7) | (iArr2[i9] << -7)) ^ ((iArr2[i9] >>> 18) | (iArr2[i9] << -18)))) + iArr2[i7 - 16];
                }
                return;
            }
        }
