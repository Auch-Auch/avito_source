...
public class ChaChaEngine extends Salsa20Engine {
    ...
    public void retreatCounter(long j) {
        ...
        if (i != 0) {
            int[] iArr = this.engineState;
            if ((((long) iArr[13]) & BodyPartID.bodyIdMax) >= (((long) i) & BodyPartID.bodyIdMax)) {
                iArr[13] = iArr[13] - i;
            } else {
        ...
        int[] iArr2 = this.engineState;
        if ((((long) iArr2[12]) & BodyPartID.bodyIdMax) >= (BodyPartID.bodyIdMax & ((long) i2))) {
            iArr2[12] = iArr2[12] - i2;
        } else if (iArr2[13] != 0) {
            iArr2[13] = iArr2[13] - 1;
            iArr2[12] = iArr2[12] - i2;
