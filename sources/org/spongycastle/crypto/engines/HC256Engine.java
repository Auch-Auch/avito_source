...
public class HC256Engine implements StreamCipher {
    ...
    public final int d() {
        ...
        if (i3 < 1024) {
            ...
            int i7 = iArr[i4];
            int c2 = iArr[(i4 - 10) & 1023] + (c(i6, 23) ^ c(i5, 10));
            int[] iArr2 = this.b;
            iArr[i4] = c2 + iArr2[(i5 ^ i6) & 1023] + i7;
            int[] iArr3 = this.a;
            ...
            int i11 = iArr4[i4];
            int c3 = iArr4[(i4 - 10) & 1023] + (c(i10, 23) ^ c(i9, 10));
            int[] iArr5 = this.a;
            iArr4[i4] = c3 + iArr5[(i9 ^ i10) & 1023] + i11;
            int[] iArr6 = this.b;
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        throw new IllegalArgumentException(a.E(cipherParameters, a.L("Invalid parameter passed to HC256 init - ")));
    }
