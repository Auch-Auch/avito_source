...
public class CamelliaEngine implements BlockCipher {
    ...
    public static void h(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i4 + 0;
        int i6 = i3 + 1;
        int i7 = i2 - 32;
        int i8 = i3 + 2;
        ...
        if (cipherParameters instanceof KeyParameter) {
            ...
            if (!this.b) {
                ...
                if (z) {
                    ...
                    iArr5[2] = iArr[2];
                    iArr5[3] = iArr[3];
                    h(45, iArr, 0, this.c, 16);
                    g(15, iArr, 0, this.e, 4);
                    g(17, iArr, 0, this.c, 32);
                    h(34, iArr, 0, this.c, 44);
                    g(15, iArr, 4, this.c, 4);
                    g(15, iArr, 4, this.e, 0);
                    g(30, iArr, 4, this.c, 24);
                    h(34, iArr, 4, this.c, 36);
                    g(15, iArr2, 0, this.c, 8);
                    g(30, iArr2, 0, this.c, 20);
                    int[] iArr6 = this.e;
                    iArr6[8] = iArr2[1];
                    iArr6[9] = iArr2[2];
                    iArr6[10] = iArr2[3];
                    iArr6[11] = iArr2[0];
                    h(49, iArr2, 0, this.c, 40);
                    int[] iArr7 = this.c;
                    iArr7[0] = iArr3[0];
                    iArr7[1] = iArr3[1];
                    iArr7[2] = iArr3[2];
                    iArr7[3] = iArr3[3];
                    g(30, iArr3, 0, iArr7, 12);
                    g(30, iArr3, 0, this.c, 28);
                    h(51, iArr3, 0, this.d, 4);
                } else {
                    int[] iArr8 = this.d;
                    iArr8[4] = iArr[0];
                    iArr8[5] = iArr[1];
                ...
                iArr11[2] = iArr[2];
                iArr11[3] = iArr[3];
                g(15, iArr, 0, this.c, 4);
                g(30, iArr, 0, this.c, 12);
                g(15, iArr, 0, iArr4, 0);
                int[] iArr12 = this.c;
                iArr12[18] = iArr4[2];
                iArr12[19] = iArr4[3];
                g(17, iArr, 0, this.e, 4);
                g(17, iArr, 0, this.c, 24);
                g(17, iArr, 0, this.c, 32);
                int[] iArr13 = this.c;
                iArr13[0] = iArr2[0];
                iArr13[1] = iArr2[1];
                iArr13[2] = iArr2[2];
                iArr13[3] = iArr2[3];
                g(15, iArr2, 0, iArr13, 8);
                g(15, iArr2, 0, this.e, 0);
                g(15, iArr2, 0, iArr4, 0);
                int[] iArr14 = this.c;
                iArr14[16] = iArr4[0];
                iArr14[17] = iArr4[1];
                g(15, iArr2, 0, iArr14, 20);
                h(34, iArr2, 0, this.c, 28);
                g(17, iArr2, 0, this.d, 4);
            } else {
                int[] iArr15 = this.d;
                iArr15[4] = iArr[0];
                iArr15[5] = iArr[1];
    ...
    public int processBlock(byte[] bArr, int i2, byte[] bArr2, int i3) throws DataLengthException, IllegalStateException {
        if (!this.a) {
            ...
            for (int i6 = 0; i6 < 4; i6++) {
                this.f[i6] = a(bArr, (i6 * 4) + i2);
                int[] iArr4 = this.f;
                iArr4[i6] = iArr4[i6] ^ this.d[i6];
            }
            b(this.f, this.c, 0);
            b(this.f, this.c, 4);
            b(this.f, this.c, 8);
