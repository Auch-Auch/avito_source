...
public class Skein {
    ...
    public static class Mappings extends a {
        ...
        public final void a(ConfigurableProvider configurableProvider, int i, int i2) {
            String R2 = a2.b.a.a.a.R2("Skein-MAC-", i, "-", i2);
            ...
            sb.append("_");
            sb.append(i2);
            configurableProvider.addAlgorithm("Mac." + R2, sb.toString());
            configurableProvider.addAlgorithm(a2.b.a.a.a.F(configurableProvider, "Alg.Alias.Mac.Skein-MAC" + i + "/" + i2, R2, "KeyGenerator.", R2), str + "$SkeinMacKeyGenerator_" + i + "_" + i2);
            configurableProvider.addAlgorithm("Alg.Alias.KeyGenerator.Skein-MAC" + i + "/" + i2, R2);
        }
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            StringBuilder sb = new StringBuilder();
            String str = a;
            addHMACAlgorithm(configurableProvider, "Skein-256-128", a2.b.a.a.a.t(a2.b.a.a.a.Y(a2.b.a.a.a.Y(a2.b.a.a.a.Y(a2.b.a.a.a.Y(a2.b.a.a.a.Y(a2.b.a.a.a.Y(a2.b.a.a.a.Y(a2.b.a.a.a.Y(a2.b.a.a.a.Y(a2.b.a.a.a.Y(a2.b.a.a.a.Y(a2.b.a.a.a.Y(a2.b.a.a.a.Y(sb, str, "$Digest_256_128", configurableProvider, "MessageDigest.Skein-256-128"), str, "$Digest_256_160", configurableProvider, "MessageDigest.Skein-256-160"), str, "$Digest_256_224", configurableProvider, "MessageDigest.Skein-256-224"), str, "$Digest_256_256", configurableProvider, "MessageDigest.Skein-256-256"), str, "$Digest_512_128", configurableProvider, "MessageDigest.Skein-512-128"), str, "$Digest_512_160", configurableProvider, "MessageDigest.Skein-512-160"), str, "$Digest_512_224", configurableProvider, "MessageDigest.Skein-512-224"), str, "$Digest_512_256", configurableProvider, "MessageDigest.Skein-512-256"), str, "$Digest_512_384", configurableProvider, "MessageDigest.Skein-512-384"), str, "$Digest_512_512", configurableProvider, "MessageDigest.Skein-512-512"), str, "$Digest_1024_384", configurableProvider, "MessageDigest.Skein-1024-384"), str, "$Digest_1024_512", configurableProvider, "MessageDigest.Skein-1024-512"), str, "$Digest_1024_1024", configurableProvider, "MessageDigest.Skein-1024-1024"), str, "$HashMac_256_128"), a2.b.a.a.a.c3(str, "$HMacKeyGenerator_256_128"));
            addHMACAlgorithm(configurableProvider, "Skein-256-160", a2.b.a.a.a.t(new StringBuilder(), str, "$HashMac_256_160"), a2.b.a.a.a.c3(str, "$HMacKeyGenerator_256_160"));
            addHMACAlgorithm(configurableProvider, "Skein-256-224", a2.b.a.a.a.t(new StringBuilder(), str, "$HashMac_256_224"), a2.b.a.a.a.c3(str, "$HMacKeyGenerator_256_224"));
            addHMACAlgorithm(configurableProvider, "Skein-256-256", a2.b.a.a.a.t(new StringBuilder(), str, "$HashMac_256_256"), a2.b.a.a.a.c3(str, "$HMacKeyGenerator_256_256"));
            addHMACAlgorithm(configurableProvider, "Skein-512-128", a2.b.a.a.a.t(new StringBuilder(), str, "$HashMac_512_128"), a2.b.a.a.a.c3(str, "$HMacKeyGenerator_512_128"));
            addHMACAlgorithm(configurableProvider, "Skein-512-160", a2.b.a.a.a.t(new StringBuilder(), str, "$HashMac_512_160"), a2.b.a.a.a.c3(str, "$HMacKeyGenerator_512_160"));
            addHMACAlgorithm(configurableProvider, "Skein-512-224", a2.b.a.a.a.t(new StringBuilder(), str, "$HashMac_512_224"), a2.b.a.a.a.c3(str, "$HMacKeyGenerator_512_224"));
            addHMACAlgorithm(configurableProvider, "Skein-512-256", a2.b.a.a.a.t(new StringBuilder(), str, "$HashMac_512_256"), a2.b.a.a.a.c3(str, "$HMacKeyGenerator_512_256"));
            addHMACAlgorithm(configurableProvider, "Skein-512-384", a2.b.a.a.a.t(new StringBuilder(), str, "$HashMac_512_384"), a2.b.a.a.a.c3(str, "$HMacKeyGenerator_512_384"));
            addHMACAlgorithm(configurableProvider, "Skein-512-512", a2.b.a.a.a.t(new StringBuilder(), str, "$HashMac_512_512"), a2.b.a.a.a.c3(str, "$HMacKeyGenerator_512_512"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-384", a2.b.a.a.a.t(new StringBuilder(), str, "$HashMac_1024_384"), a2.b.a.a.a.c3(str, "$HMacKeyGenerator_1024_384"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-512", a2.b.a.a.a.t(new StringBuilder(), str, "$HashMac_1024_512"), a2.b.a.a.a.c3(str, "$HMacKeyGenerator_1024_512"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-1024", a2.b.a.a.a.t(new StringBuilder(), str, "$HashMac_1024_1024"), a2.b.a.a.a.c3(str, "$HMacKeyGenerator_1024_1024"));
