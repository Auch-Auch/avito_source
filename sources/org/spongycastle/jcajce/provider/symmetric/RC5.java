...
public final class RC5 {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = a;
            a.o1(sb, str, "$ECB32", configurableProvider, "Cipher.RC5");
            a.o1(a.Y(a.Y(a.Y(a.c0(configurableProvider, "KeyGenerator.RC5", a.F(configurableProvider, "Cipher.RC5-64", a.F(configurableProvider, "Alg.Alias.Cipher.RC5-32", "RC5", str, "$ECB64"), str, "$KeyGen32"), "Alg.Alias.KeyGenerator.RC5-32", "RC5"), str, "$KeyGen64", configurableProvider, "KeyGenerator.RC5-64"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.RC5"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.RC5-64"), str, "$Mac32", configurableProvider, "Mac.RC5MAC");
            configurableProvider.addAlgorithm("Mac.RC5MAC/CFB8", a.F(configurableProvider, "Alg.Alias.Mac.RC5", "RC5MAC", str, "$CFB8Mac32"));
