...
public final class RC6 {
    ...
    public static class Mappings extends b {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = a;
            addGMacAlgorithm(configurableProvider, "RC6", a.t(a.Y(a.Y(a.Y(sb, str, "$ECB", configurableProvider, "Cipher.RC6"), str, "$KeyGen", configurableProvider, "KeyGenerator.RC6"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.RC6"), str, "$GMAC"), a.c3(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "RC6", a.t(new StringBuilder(), str, "$Poly1305"), a.c3(str, "$Poly1305KeyGen"));
        }
    }
