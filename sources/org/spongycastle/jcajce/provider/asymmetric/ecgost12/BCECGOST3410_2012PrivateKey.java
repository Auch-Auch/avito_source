...
public class BCECGOST3410_2012PrivateKey implements ECPrivateKey, org.spongycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    public final DERBitString b(BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey) {
        try {
    ...
    public final void c(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.e = new ECNamedCurveSpec(ECGOST3410NamedCurves.getName(this.c.getPublicKeyParamSet()), EC5Util.convertCurve(parameterSpec.getCurve(), parameterSpec.getSeed()), new ECPoint(parameterSpec.getG().getAffineXCoord().toBigInteger(), parameterSpec.getG().getAffineYCoord().toBigInteger()), parameterSpec.getN(), parameterSpec.getH());
    ...
    public boolean equals(Object obj) {
        ...
        if (!getD().equals(bCECGOST3410_2012PrivateKey.getD()) || !a().equals(bCECGOST3410_2012PrivateKey.a())) {
            return false;
        }
        return true;
    }
    ...
    public byte[] getEncoded() {
        ...
        if (this.c != null) {
            ...
            try {
                return new PrivateKeyInfo(new AlgorithmIdentifier(aSN1ObjectIdentifier, this.c), new DEROctetString(bArr)).getEncoded(ASN1Encoding.DER);
            } catch (IOException unused) {
                return null;
            }
        } else {
    ...
    public BCECGOST3410_2012PrivateKey(BCECGOST3410_2012PrivateKey bCECGOST3410_2012PrivateKey) {
        ...
        this.g = bCECGOST3410_2012PrivateKey.g;
        this.f = bCECGOST3410_2012PrivateKey.f;
    ...
    public BCECGOST3410_2012PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters, BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey, ECParameterSpec eCParameterSpec) {
        ...
        this.c = bCECGOST3410_2012PublicKey.getGostParams();
        this.f = b(bCECGOST3410_2012PublicKey);
    }
