...
public class EC5Util {
    ...
    static {
        ...
        a.put(new ECCurve.Fp(byName2.getCurve().getField().getCharacteristic(), byName2.getCurve().getA().toBigInteger(), byName2.getCurve().getB().toBigInteger()), byName2.getCurve());
    }
    ...
    public static ECParameterSpec convertToSpec(X962Parameters x962Parameters, ECCurve eCCurve) {
        ...
        if (x962Parameters.isNamedCurve()) {
            ...
            if (instance.getH() != null) {
                eCParameterSpec = new ECParameterSpec(convertCurve, new java.security.spec.ECPoint(instance.getG().getAffineXCoord().toBigInteger(), instance.getG().getAffineYCoord().toBigInteger()), instance.getN(), instance.getH().intValue());
            } else {
                eCParameterSpec = new ECParameterSpec(convertCurve, new java.security.spec.ECPoint(instance.getG().getAffineXCoord().toBigInteger(), instance.getG().getAffineYCoord().toBigInteger()), instance.getN(), 1);
            }
    ...
    public static ECCurve convertCurve(EllipticCurve ellipticCurve) {
        ...
        if (field instanceof ECFieldFp) {
            ECCurve.Fp fp = new ECCurve.Fp(((ECFieldFp) field).getP(), a3, b);
        ...
        } else if (midTermsOfReductionPolynomial[0] < midTermsOfReductionPolynomial[1] && midTermsOfReductionPolynomial[0] < midTermsOfReductionPolynomial[2]) {
            iArr[0] = midTermsOfReductionPolynomial[0];
        ...
        return new ECCurve.F2m(m, iArr[0], iArr[1], iArr[2], a3, b);
    }
