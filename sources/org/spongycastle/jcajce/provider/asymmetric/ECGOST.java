...
public class ECGOST {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            StringBuilder c0 = a.c0(configurableProvider, "Alg.Alias.Signature.GOST-3410-2001", "ECGOST3410", "KeyAgreement.ECGOST3410", "org.spongycastle.jcajce.provider.asymmetric.ecgost.KeyAgreementSpi$ECVKO");
            c0.append("Alg.Alias.KeyAgreement.");
            c0.append(aSN1ObjectIdentifier);
            configurableProvider.addAlgorithm(c0.toString(), "ECGOST3410");
            ...
            StringBuilder c02 = a.c0(configurableProvider, "KeyAgreement.ECGOST3410-2012-256", "org.spongycastle.jcajce.provider.asymmetric.ecgost12.KeyAgreementSpi$ECVKO256", "KeyAgreement.ECGOST3410-2012-512", "org.spongycastle.jcajce.provider.asymmetric.ecgost12.KeyAgreementSpi$ECVKO512");
            c02.append("Alg.Alias.KeyAgreement.");
            c02.append(aSN1ObjectIdentifier3);
            configurableProvider.addAlgorithm(c02.toString(), "ECGOST3410-2012-256");
