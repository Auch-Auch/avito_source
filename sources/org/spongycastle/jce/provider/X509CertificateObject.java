...
public class X509CertificateObject extends X509Certificate implements PKCS12BagAttributeCarrier {
    ...
    public X509CertificateObject(Certificate certificate) throws CertificateParsingException {
        ...
        try {
            byte[] c2 = c("2.5.29.19");
            if (c2 != null) {
                this.b = BasicConstraints.getInstance(ASN1Primitive.fromByteArray(c2));
            }
            try {
                byte[] c3 = c("2.5.29.15");
                if (c3 != null) {
    ...
    public final void a(java.security.PublicKey r5, java.security.Signature r6) throws java.security.cert.CertificateException, java.security.NoSuchAlgorithmException, java.security.SignatureException, java.security.InvalidKeyException {
        /*
            r4 = this;
            org.spongycastle.asn1.x509.Certificate r0 = r4.a
            org.spongycastle.asn1.x509.AlgorithmIdentifier r0 = r0.getSignatureAlgorithm()
            org.spongycastle.asn1.x509.Certificate r1 = r4.a
        ...
        L_0x0060:
            ...
            org.spongycastle.asn1.x509.AlgorithmIdentifier r0 = r0.getSignatureAlgorithm()
            org.spongycastle.asn1.ASN1Encodable r0 = r0.getParameters()
            org.spongycastle.asn1.ASN1Null r1 = x6.e.d.a.j.a
    ...
    public boolean hasUnsupportedCriticalExtension() {
        ...
        if (getVersion() != 3 || (extensions = this.a.getTBSCertificate().getExtensions()) == null) {
            return false;
        }
        Enumeration oids = extensions.oids();
        while (oids.hasMoreElements()) {
            ...
            if (!id.equals(g.l) && !id.equals(g.a) && !id.equals(g.b) && !id.equals(g.c) && !id.equals(g.h) && !id.equals(g.d) && !id.equals(g.e) && !id.equals(g.f) && !id.equals(g.g) && !id.equals(g.i) && !id.equals(g.j) && extensions.getExtension(aSN1ObjectIdentifier).isCritical()) {
                return true;
            }
        }
        return false;
    ...
    public final void verify(PublicKey publicKey) throws CertificateException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
        Signature signature;
        String b2 = j.b(this.a.getSignatureAlgorithm());
        try {
    ...
    public void checkValidity(Date date) throws CertificateExpiredException, CertificateNotYetValidException {
        if (date.getTime() > getNotAfter().getTime()) {
            ...
            L.append(this.a.getEndDate().getTime());
            ...
            L2.append(this.a.getStartDate().getTime());
