...
public class AttributeCertificateIssuer implements CertSelector, Selector {
    ...
    public final boolean a(X500Principal x500Principal, GeneralNames generalNames) {
    ...
    public boolean match(Certificate certificate) {
        ...
        if (aSN1Encodable instanceof V2Form) {
            ...
            } else if (!v2Form.getBaseCertificateID().getSerial().getValue().equals(x509Certificate.getSerialNumber()) || !a(x509Certificate.getIssuerX500Principal(), v2Form.getBaseCertificateID().getIssuer())) {
                return false;
            } else {
                return true;
            }
        } else {
            if (a(x509Certificate.getSubjectX500Principal(), (GeneralNames) aSN1Encodable)) {
                return true;
            }
        }
        return false;
    ...
    public AttributeCertificateIssuer(X509Principal x509Principal) {
        this.a = new V2Form(GeneralNames.getInstance(new DERSequence(new GeneralName(x509Principal))));
    }
