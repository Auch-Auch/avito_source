...
public class X509CertStoreSelector extends X509CertSelector implements Selector {
    public static X509CertStoreSelector getInstance(X509CertSelector x509CertSelector) {
        if (x509CertSelector != null) {
            ...
            try {
                ...
                throw new IllegalArgumentException(a.Z2("error in passed in selector: ", e));
            }
        } else {
    ...
    @Override // java.security.cert.X509CertSelector, java.lang.Object, java.security.cert.CertSelector, org.spongycastle.util.Selector
    public Object clone() {
