...
public abstract class Nat {
    public static int add(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = (((long) iArr[i2]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr2[i2])) + j;
            iArr3[i2] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3) {
        int i4 = i3 + 0;
        long j = (((long) iArr[i4]) & BodyPartID.bodyIdMax) + (((long) i2) & BodyPartID.bodyIdMax);
        iArr[i4] = (int) j;
        int i5 = i3 + 1;
        long j2 = (BodyPartID.bodyIdMax & ((long) iArr[i5])) + 1 + (j >>> 32);
        iArr[i5] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int add33To(int i, int i2, int[] iArr) {
        ...
        iArr[0] = (int) j;
        long j2 = (BodyPartID.bodyIdMax & ((long) iArr[1])) + 1 + (j >>> 32);
        iArr[1] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addBothTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = (((long) iArr[i2]) & BodyPartID.bodyIdMax) + (((long) iArr2[i2]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr3[i2])) + j;
            iArr3[i2] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2) {
        int i3 = i2 + 0;
        long j2 = (((long) iArr[i3]) & BodyPartID.bodyIdMax) + (j & BodyPartID.bodyIdMax);
        iArr[i3] = (int) j2;
        int i4 = i2 + 1;
        long j3 = (BodyPartID.bodyIdMax & ((long) iArr[i4])) + (j >>> 32) + (j2 >>> 32);
        iArr[i4] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordTo(int i, long j, int[] iArr) {
        ...
        iArr[0] = (int) j2;
        long j3 = (BodyPartID.bodyIdMax & ((long) iArr[1])) + (j >>> 32) + (j2 >>> 32);
        iArr[1] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int mul31BothAdd(int i, int i2, int[] iArr, int i3, int[] iArr2, int[] iArr3, int i4) {
        ...
        do {
            int i6 = i4 + i5;
            long j4 = ((((long) iArr2[i5]) & BodyPartID.bodyIdMax) * j2) + ((((long) iArr[i5]) & BodyPartID.bodyIdMax) * j) + (((long) iArr3[i6]) & BodyPartID.bodyIdMax) + j3;
            iArr3[i6] = (int) j4;
            j3 = j4 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            int i3 = i2 + i;
            long mulWordAddTo = j + (BodyPartID.bodyIdMax & ((long) iArr3[i3])) + (((long) mulWordAddTo(i, iArr[i2], iArr2, 0, iArr3, i2)) & BodyPartID.bodyIdMax);
    ...
    public static int mulWordAddTo(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        do {
            int i6 = i4 + i5;
            long j3 = ((((long) iArr[i3 + i5]) & BodyPartID.bodyIdMax) * j) + (((long) iArr2[i6]) & BodyPartID.bodyIdMax) + j2;
            iArr2[i6] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulWordDwordAddAt(int i, int i2, long j, int[] iArr, int i3) {
        ...
        int i4 = i3 + 0;
        long j3 = ((j & BodyPartID.bodyIdMax) * j2) + (((long) iArr[i4]) & BodyPartID.bodyIdMax) + 0;
        iArr[i4] = (int) j3;
        long j4 = j2 * (j >>> 32);
        int i5 = i3 + 1;
        long j5 = j4 + (((long) iArr[i5]) & BodyPartID.bodyIdMax) + (j3 >>> 32);
        iArr[i5] = (int) j5;
        long j6 = j5 >>> 32;
        int i6 = i3 + 2;
        long j7 = j6 + (((long) iArr[i6]) & BodyPartID.bodyIdMax);
        iArr[i6] = (int) j7;
        if ((j7 >>> 32) == 0) {
            return 0;
        }
    ...
    public static void square(int i, int[] iArr, int[] iArr2) {
        ...
        while (true) {
            i5--;
            long j = ((long) iArr[i5]) & BodyPartID.bodyIdMax;
            long j2 = j * j;
            int i7 = i6 - 1;
    ...
    public static int squareWordAdd(int[] iArr, int i, int[] iArr2) {
        ...
        do {
            int i3 = i + i2;
            long j3 = ((((long) iArr[i2]) & BodyPartID.bodyIdMax) * j) + (((long) iArr2[i3]) & BodyPartID.bodyIdMax) + j2;
            iArr2[i3] = (int) j3;
            j2 = j3 >>> 32;
            i2++;
        } while (i2 < i);
    ...
    public static int subBothFrom(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = (((((long) iArr3[i2]) & BodyPartID.bodyIdMax) - (((long) iArr[i2]) & BodyPartID.bodyIdMax)) - (BodyPartID.bodyIdMax & ((long) iArr2[i2]))) + j;
            iArr3[i2] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subFrom(int i, int[] iArr, int[] iArr2) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = ((((long) iArr2[i2]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) iArr[i2]))) + j;
            iArr2[i2] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i4 + i5;
            long j2 = (((long) iArr[i2 + i5]) & BodyPartID.bodyIdMax) + (((long) iArr2[i3 + i5]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr3[i6])) + j;
            iArr3[i6] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            int i5 = i3 + i4;
            long j2 = (((long) iArr[i2 + i4]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr2[i5])) + j;
            iArr2[i5] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int mulWord(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i5 = 0;
        do {
            long j3 = ((((long) iArr[i3 + i5]) & BodyPartID.bodyIdMax) * j) + j2;
            iArr2[i4 + i5] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int sub(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        long j = 0;
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = ((((long) iArr[i2 + i5]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) iArr2[i3 + i5]))) + j;
            iArr3[i4 + i5] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subBothFrom(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i4 + i5;
            long j2 = (((((long) iArr3[i6]) & BodyPartID.bodyIdMax) - (((long) iArr[i2 + i5]) & BodyPartID.bodyIdMax)) - (BodyPartID.bodyIdMax & ((long) iArr2[i3 + i5]))) + j;
            iArr3[i6] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subFrom(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            int i5 = i3 + i4;
            long j2 = ((((long) iArr2[i5]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) iArr[i2 + i4]))) + j;
            iArr2[i5] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int addWordAt(int i, int i2, int[] iArr, int i3, int i4) {
        int i5 = i3 + i4;
        long j = (((long) i2) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr[i5]));
        iArr[i5] = (int) j;
        if ((j >>> 32) == 0) {
            return 0;
        }
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            int i7 = i5 + i;
            long mulWordAddTo = j + (BodyPartID.bodyIdMax & ((long) iArr3[i7])) + (((long) mulWordAddTo(i, iArr[i2 + i6], iArr2, i3, iArr3, i5)) & BodyPartID.bodyIdMax);
    ...
    public static int squareWordAdd(int[] iArr, int i, int i2, int[] iArr2, int i3) {
        ...
        do {
            int i6 = i2 + i5;
            long j3 = ((((long) iArr[i + i4]) & BodyPartID.bodyIdMax) * j) + (((long) iArr2[i6]) & BodyPartID.bodyIdMax) + j2;
            iArr2[i6] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
            i4++;
    ...
    public static int subWordFrom(int i, int i2, int[] iArr, int i3) {
        int i4 = i3 + 0;
        long j = (((long) iArr[i4]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) i2));
        iArr[i4] = (int) j;
        if ((j >> 32) == 0) {
            return 0;
        }
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3, int i4) {
        ...
        iArr[i5] = (int) j;
        int i6 = i5 + 1;
        long j2 = (BodyPartID.bodyIdMax & ((long) iArr[i6])) + 1 + (j >>> 32);
        iArr[i6] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2, int i3) {
        ...
        iArr[i4] = (int) j2;
        int i5 = i4 + 1;
        long j3 = (BodyPartID.bodyIdMax & ((long) iArr[i5])) + (j >>> 32) + (j2 >>> 32);
        iArr[i5] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
