...
public abstract class Mod {
    public static void a(int[] iArr, int i, int[] iArr2, int[] iArr3) {
        if (i < 0) {
    ...
    public static int b(int[] iArr, int[] iArr2, int i, int[] iArr3, int i2) {
        int i3;
        int length = iArr.length;
        int i4 = 0;
        while (iArr2[0] == 0) {
        ...
        if (i6 > 0) {
            Nat.shiftDownBits(i, iArr2, i6, 0);
            i4 += i6;
        }
    ...
    public static void invert(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        if (!Nat.isZero(length, iArr2)) {
            ...
            create[0] = 1;
            int b = (1 & copy[0]) == 0 ? b(iArr, copy, length, create, 0) : 0;
            if (Nat.isOne(length, copy)) {
                a(iArr, b, create, iArr3);
                return;
            }
            ...
            while (true) {
                ...
                if (copy[i3] == 0 && copy2[i3] == 0) {
                    ...
                    b = b(iArr, copy, i2, create, (Nat.subFrom(length, create2, create) - i) + b);
                    ...
                    i = b(iArr, copy2, i2, create2, (Nat.subFrom(length, create, create2) - b) + i);
                    if (Nat.isOne(i2, copy2)) {
                        a(iArr, i, create2, iArr3);
                        return;
                    }
                }
            }
