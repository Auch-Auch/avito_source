...
public class SecT163R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECFieldElement z0 = a.z0(eCFieldElement5, eCFieldElement, eCFieldElement2);
        if (z0.isZero()) {
            return new SecT163R2Point(curve, z0, curve.getB().sqrt(), this.withCompression);
        }
        ...
        return new SecT163R2Point(curve, square, eCFieldElement4.squarePlusProduct(z0, eCFieldElement).add(square).add(eCFieldElement3), new ECFieldElement[]{eCFieldElement3}, this.withCompression);
    }
