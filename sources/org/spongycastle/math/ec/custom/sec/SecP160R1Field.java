...
public class SecP160R1Field {
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j6 = (((long) iArr[0]) & BodyPartID.bodyIdMax) + j + (j << 31) + 0;
        iArr2[0] = (int) j6;
        long j7 = (((long) iArr[1]) & BodyPartID.bodyIdMax) + j2 + (j2 << 31) + (j6 >>> 32);
        iArr2[1] = (int) j7;
        long j8 = (((long) iArr[2]) & BodyPartID.bodyIdMax) + j3 + (j3 << 31) + (j7 >>> 32);
        iArr2[2] = (int) j8;
        long j9 = (((long) iArr[3]) & BodyPartID.bodyIdMax) + j4 + (j4 << 31) + (j8 >>> 32);
        iArr2[3] = (int) j9;
        long j10 = (BodyPartID.bodyIdMax & ((long) iArr[4])) + j5 + (j5 << 31) + (j9 >>> 32);
        iArr2[4] = (int) j10;
        reduce32((int) (j10 >>> 32), iArr2);
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i != 0 && Nat160.mulWordsAdd(-2147483647, i, iArr, 0) != 0) || (iArr[4] == -1 && Nat160.gte(iArr, a))) {
