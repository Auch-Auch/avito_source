...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECFieldElement z0 = a.z0(eCFieldElement4, eCFieldElement, eCFieldElement5);
        if (z0.isZero()) {
            return new SecT163K1Point(curve, z0, curve.getB(), this.withCompression);
        }
        ECFieldElement square = z0.square();
        if (isOne) {
            eCFieldElement2 = z0;
        } else {
            eCFieldElement2 = z0.multiply(eCFieldElement5);
        }
        ECFieldElement square2 = eCFieldElement4.add(eCFieldElement3).square();
        return new SecT163K1Point(curve, square, square2.add(z0).add(eCFieldElement5).multiply(square2).add(square), new ECFieldElement[]{eCFieldElement2}, this.withCompression);
    }
