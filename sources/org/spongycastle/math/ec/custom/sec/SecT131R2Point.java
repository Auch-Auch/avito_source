...
public class SecT131R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        if (z0.isZero()) {
            return new SecT131R2Point(curve, z0, curve.getB().sqrt(), this.withCompression);
        }
        ...
        return new SecT131R2Point(curve, square, eCFieldElement4.squarePlusProduct(z0, eCFieldElement).add(square).add(eCFieldElement3), new ECFieldElement[]{eCFieldElement3}, this.withCompression);
    }
