...
public class Curve25519Field {
    ...
    public static int a(int[] iArr) {
        ...
        long j4 = (((long) iArr[8]) & BodyPartID.bodyIdMax) + 19 + j3;
        iArr[8] = (int) j4;
        long j5 = j4 >> 32;
        if (j5 != 0) {
            j5 = (long) Nat.incAt(15, iArr, 9);
        }
        long j6 = ((((long) iArr[15]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) (iArr2[15] + 1)))) + j5;
        iArr[15] = (int) j6;
        return (int) (j6 >> 32);
    }
    ...
    public static int b(int[] iArr) {
        ...
        long j3 = ((BodyPartID.bodyIdMax & ((long) iArr[7])) - 2147483648L) + j2;
        iArr[7] = (int) j3;
        return (int) (j3 >> 32);
    }
    ...
    public static void subtract(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat256.sub(iArr, iArr2, iArr3) != 0) {
            long j = (((long) iArr3[0]) & BodyPartID.bodyIdMax) - 19;
            iArr3[0] = (int) j;
            long j2 = j >> 32;
            if (j2 != 0) {
                j2 = (long) Nat.decAt(7, iArr3, 1);
            }
            iArr3[7] = (int) ((BodyPartID.bodyIdMax & ((long) iArr3[7])) + 2147483648L + j2);
        }
    }

    public static void subtractExt(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat.sub(16, iArr, iArr2, iArr3) != 0) {
            long j = ((long) iArr3[0]) & BodyPartID.bodyIdMax;
            int[] iArr4 = b;
            long j2 = j + (((long) iArr4[0]) & BodyPartID.bodyIdMax);
            iArr3[0] = (int) j2;
            long j3 = j2 >> 32;
            if (j3 != 0) {
                j3 = (long) Nat.incAt(8, iArr3, 1);
            }
            long j4 = ((((long) iArr3[8]) & BodyPartID.bodyIdMax) - 19) + j3;
            iArr3[8] = (int) j4;
            long j5 = j4 >> 32;
            if (j5 != 0) {
                j5 = (long) Nat.decAt(15, iArr3, 9);
            }
            iArr3[15] = (int) ((((long) iArr3[15]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) (iArr4[15] + 1))) + j5);
        }
    }
