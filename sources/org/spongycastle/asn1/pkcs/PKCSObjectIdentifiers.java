...
public interface PKCSObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier data = a.y0("1.2.840.113549.1.7.1");
    ...
    public static final ASN1ObjectIdentifier digestedData = a.y0("1.2.840.113549.1.7.5");
    public static final ASN1ObjectIdentifier encryptedData = a.y0("1.2.840.113549.1.7.6");
    public static final ASN1ObjectIdentifier encryptionAlgorithm;
    public static final ASN1ObjectIdentifier envelopedData = a.y0("1.2.840.113549.1.7.3");
    ...
    public static final ASN1ObjectIdentifier pkcs_7 = a.y0("1.2.840.113549.1.7");
    ...
    public static final ASN1ObjectIdentifier signedAndEnvelopedData = a.y0("1.2.840.113549.1.7.4");
    public static final ASN1ObjectIdentifier signedData = a.y0("1.2.840.113549.1.7.2");
    ...
    static {
        ...
        id_pSpecified = aSN1ObjectIdentifier.branch(AdvertDetailsPresenterKt.AUTO_CATEGORY_ID);
        ...
        sha224WithRSAEncryption = aSN1ObjectIdentifier.branch(LocationMessagesKt.MAP_SNIPPET_WITH_MARKERS_ZOOM);
        ...
        id_hmacWithSHA256 = aSN1ObjectIdentifier5.branch(AdvertDetailsPresenterKt.AUTO_CATEGORY_ID).intern();
        ...
        pkcs_9_at_extendedCertificateAttributes = aSN1ObjectIdentifier6.branch(AdvertDetailsPresenterKt.AUTO_CATEGORY_ID).intern();
        pkcs_9_at_signingDescription = aSN1ObjectIdentifier6.branch("13").intern();
        pkcs_9_at_extensionRequest = aSN1ObjectIdentifier6.branch(LocationMessagesKt.MAP_SNIPPET_WITH_MARKERS_ZOOM).intern();
        ...
        id_ct_compressedData = aSN1ObjectIdentifier7.branch(AdvertDetailsPresenterKt.AUTO_CATEGORY_ID);
        ...
        id_alg = branch3;
        id_alg_PWRI_KEK = branch3.branch(AdvertDetailsPresenterKt.AUTO_CATEGORY_ID);
        id_rsa_KEM = branch3.branch(LocationMessagesKt.MAP_SNIPPET_WITH_MARKERS_ZOOM);
        ...
        id_aa_signatureTimeStampToken = aSN1ObjectIdentifier9.branch(LocationMessagesKt.MAP_SNIPPET_WITH_MARKERS_ZOOM);
