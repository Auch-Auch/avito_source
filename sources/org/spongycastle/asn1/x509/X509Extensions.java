...
public class X509Extensions extends ASN1Object {
    ...
    public X509Extensions(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (instance.size() == 3) {
                this.a.put(instance.getObjectAt(0), new X509Extension(ASN1Boolean.getInstance(instance.getObjectAt(1)), ASN1OctetString.getInstance(instance.getObjectAt(2))));
                ...
                throw new IllegalArgumentException(a.C(instance, a.L("Bad sequence size: ")));
            }
