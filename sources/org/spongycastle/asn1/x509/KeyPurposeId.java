...
public class KeyPurposeId extends ASN1Object {
    ...
    static {
        ...
        id_kp_OCSPSigning = new KeyPurposeId(aSN1ObjectIdentifier.branch(AdvertDetailsPresenterKt.AUTO_CATEGORY_ID));
        ...
        id_kp_eapOverLAN = new KeyPurposeId(aSN1ObjectIdentifier.branch(LocationMessagesKt.MAP_SNIPPET_WITH_MARKERS_ZOOM));
