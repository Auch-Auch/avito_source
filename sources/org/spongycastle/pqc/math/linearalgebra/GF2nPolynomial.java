...
public class GF2nPolynomial {
    ...
    public final GF2nPolynomial[] divide(GF2nPolynomial gF2nPolynomial) throws RuntimeException, ArithmeticException {
        ...
        while (true) {
            ...
            if (i >= 0) {
                GF2nElement gF2nElement2 = (GF2nElement) gF2nPolynomial2.a[gF2nPolynomial2.getDegree()].multiply(gF2nElement);
                ...
                gF2nPolynomial2.shrink();
                gF2nPolynomialArr[0].a[i] = (GF2nElement) gF2nElement2.clone();
            ...
            for (int i = 0; i < size(); i++) {
                for (int i2 = 0; i2 < gF2nPolynomial.size(); i2++) {
                    ...
                    if (gF2nElementArr[i3] == null) {
                        gF2nElementArr[i3] = (GF2nElement) this.a[i].multiply(gF2nPolynomial.a[i2]);
                    } else {
                        gF2nElementArr[i3] = (GF2nElement) gF2nElementArr[i3].add(this.a[i].multiply(gF2nPolynomial.a[i2]));
                    }
                }
            }
            return gF2nPolynomial2;
