...
public class ArrayEncoder {
    ...
    public static final int[] c = {1, 1, 1, 0, 0, 0, 1, 0, 1};
    public static final int[] d = {1, 1, 1, 1, 0, 0, 0, 1, 0};
    public static final int[] e = {1, 0, 1, 0, 0, 1, 1, 1, 0};
    ...
    public static int[] decodeMod3Sves(byte[] bArr, int i) {
        ...
        while (i2 < bArr.length * 8) {
            ...
            int i5 = i4 + 1;
            int i6 = i5 + 1;
            int c2 = a.c2(a(bArr, i4), 2, a(bArr, i2) * 4, a(bArr, i5));
            int i7 = i3 + 1;
            iArr[i3] = a[c2];
            i3 = i7 + 1;
            iArr[i7] = b[c2];
    ...
    public static int[] decodeModQ(byte[] bArr, int i, int i2) {
        ...
        for (int i5 = 0; i5 < i3; i5++) {
            ...
            iArr[i4] = iArr[i4] + (a(bArr, i5) << (i5 % numberOfLeadingZeros));
        }
        return iArr;
    }
    ...
    public static int[] decodeMod3Tight(InputStream inputStream, int i) throws IOException {
        return decodeMod3Tight(Util.readFullLength(inputStream, (int) Math.ceil(((Math.log(3.0d) * ((double) i)) / Math.log(2.0d)) / 8.0d)), i);
    }
}
