...
public class LongPolynomial5 {
    ...
    public LongPolynomial5 mult(TernaryPolynomial ternaryPolynomial) {
        ...
        int i;
        int[] iArr = new int[2];
        iArr[1] = (((ternaryPolynomial.size() + 4) / 5) + this.a.length) - 1;
        iArr[0] = 5;
        ...
        int i16 = (this.b % 5) * 12;
        for (int length2 = this.a.length - 1; length2 < copyOf.length; length2++) {
            long[] jArr4 = this.a;
            if (length2 == jArr4.length - 1) {
                j = this.b == 5 ? 0 : copyOf[length2] >> i16;
                i = 0;
            } else {
                j = copyOf[length2];
                i = (length2 * 5) - this.b;
        ...
        return new LongPolynomial5(copyOf, this.b);
    }
