...
public class ComputeInField {
    ...
    public final void b(boolean r10) throws java.lang.RuntimeException {
        ...
        L_0x005a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.pqc.crypto.rainbow.util.ComputeInField.b(boolean):void");
    }
        ...
        if (invElem != 0) {
            ...
            for (int length = this.a.length - 2; length >= 0; length--) {
                ...
                for (int length2 = sArr4.length - 1; length2 > length; length2--) {
                    s = GF2Field.addElem(s, GF2Field.multElem(this.a[length][length2], this.b[length2]));
                }
    ...
    public short[][] inverse(short[][] sArr) {
        try {
            ...
            if (sArr.length == sArr[0].length) {
                ...
                iArr2[0] = length3;
                short[][] sArr6 = (short[][]) Array.newInstance(short.class, iArr2);
                while (true) {
                    short[][] sArr7 = this.a;
                    if (i >= sArr7.length) {
                        return sArr6;
