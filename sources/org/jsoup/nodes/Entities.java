...
public class Entities {
    ...
    public enum EscapeMode {
        ...
        EscapeMode(String str, int i) {
            ...
            while (!characterReader.isEmpty()) {
                ...
                int parseInt = Integer.parseInt(characterReader.consumeToAny(Entities.a), 36);
                ...
                this.d[parseInt2] = consumeTo;
                if (i2 != -1) {
                    Entities.b.put(consumeTo, new String(new int[]{parseInt, i2}, 0, 2));
                }
                i3++;
            }
            Validate.isTrue(i3 == i ? true : z, "Unexpected count of entities loaded");
        }
    ...
    public static void a(Appendable appendable, EscapeMode escapeMode, int i) throws IOException {
        ...
        int binarySearch = Arrays.binarySearch(escapeMode.c, i);
        if (binarySearch >= 0) {
            CharSequence[] charSequenceArr = escapeMode.d;
            if (binarySearch < charSequenceArr.length - 1) {
                int i2 = binarySearch + 1;
                if (escapeMode.c[i2] == i) {
                    charSequence = charSequenceArr[i2];
                }
            }
            charSequence = charSequenceArr[binarySearch];
        } else {
            charSequence = "";
        }
        if (!"".equals(charSequence)) {
            appendable.append(Typography.amp).append(charSequence).append(';');
        } else {
    ...
    public static void b(Appendable appendable, String str, Document.OutputSettings outputSettings, boolean z, boolean z2, boolean z3) throws IOException {
        ...
        CharsetEncoder charsetEncoder = outputSettings.c.get();
                    ...
                    if (c2 == '&') {
                        ...
                        if (c2 != '>') {
                            if (c2 != 160) {
                                ...
                                if (ordinal != 0) {
                                    if (ordinal != 1) {
                                        z7 = charsetEncoder.canEncode(c2);
                                    }
                                } else if (c2 >= 128) {
                                    z7 = false;
                                }
    ...
    public static int codepointsForName(String str, int[] iArr) {
        ...
        int a3 = EscapeMode.extended.a(str);
        if (a3 == -1) {
            return 0;
        }
        iArr[0] = a3;
    ...
    public static String escape(String str, Document.OutputSettings outputSettings) {
        ...
        try {
            b(borrowBuilder, str, outputSettings, false, false, false);
    ...
    public static String getByName(String str) {
        ...
        int a3 = EscapeMode.extended.a(str);
        return a3 != -1 ? new String(new int[]{a3}, 0, 1) : "";
    }
