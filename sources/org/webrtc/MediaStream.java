...
public class MediaStream {
    ...
    public void dispose() {
        ...
        while (!this.audioTracks.isEmpty()) {
            try {
                ...
                Logging.e(TAG, "dispose: failed to remove audio track, not in the list");
            }
        }
        while (!this.videoTracks.isEmpty()) {
            try {
                ...
                Logging.e(TAG, "dispose: failed to remove video track, not in the list");
            }
        }
        while (!this.preservedVideoTracks.isEmpty()) {
            try {
                ...
                Logging.e(TAG, "dispose: failed to remove preserved video track, not in the list");
            }
        }
    ...
    public String toString() {
        ...
        L.append(getId());
        L.append(":A=");
        L.append(this.audioTracks.size());
        L.append(":V=");
        L.append(this.videoTracks.size());
        L.append("]");
        return L.toString();
    }
