...
public class ThreadUtils {
    ...
    public static <V> V invokeAtFrontUninterruptibly(Handler handler, final Callable<V> callable) {
        if (handler.getLooper().getThread() == Thread.currentThread()) {
            ...
            final AnonymousClass1Result r0 = new Object() { // from class: org.webrtc.ThreadUtils.1Result
                public Object value;
            };
            final AnonymousClass1CaughtException r1 = new Object() { // from class: org.webrtc.ThreadUtils.1CaughtException
                public Exception e;
            };
