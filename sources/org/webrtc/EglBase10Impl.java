...
public class EglBase10Impl implements EglBase10 {
    ...
    private EGLContext createEglContext(@Nullable EGLContext eGLContext, EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i) {
        ...
        if (eGLContext == null || eGLContext != EGL10.EGL_NO_CONTEXT) {
            ...
            StringBuilder L = a.L("Failed to create EGL context: 0x");
            L.append(Integer.toHexString(this.egl.eglGetError()));
        ...
        if ((obj instanceof SurfaceHolder) || (obj instanceof SurfaceTexture)) {
            ...
            if (this.eglSurface == EGL10.EGL_NO_SURFACE) {
                ...
                if (eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                    StringBuilder L = a.L("Failed to create window surface: 0x");
                    L.append(Integer.toHexString(this.egl.eglGetError()));
                    throw new RuntimeException(L.toString());
                }
                return;
    ...
    private EGLConfig getEglConfig(EGLDisplay eGLDisplay, int[] iArr) {
        ...
        if (!this.egl.eglChooseConfig(eGLDisplay, iArr, eGLConfigArr, 1, iArr2)) {
            StringBuilder L = a.L("eglChooseConfig failed: 0x");
            L.append(Integer.toHexString(this.egl.eglGetError()));
            throw new RuntimeException(L.toString());
        } else if (iArr2[0] > 0) {
    ...
    private EGLDisplay getEglDisplay() {
        ...
        if (eglGetDisplay != EGL10.EGL_NO_DISPLAY) {
            ...
            StringBuilder L = a.L("Unable to initialize EGL10: 0x");
            L.append(Integer.toHexString(this.egl.eglGetError()));
            throw new RuntimeException(L.toString());
        }
        StringBuilder L2 = a.L("Unable to get EGL10 display: 0x");
        L2.append(Integer.toHexString(this.egl.eglGetError()));
    ...
    public void createPbufferSurface(int i, int i2) {
        ...
        if (this.eglSurface == EGL10.EGL_NO_SURFACE) {
            ...
            if (eglCreatePbufferSurface == EGL10.EGL_NO_SURFACE) {
                StringBuilder N = a.N("Failed to create pixel buffer surface with size ", i, "x", i2, ": 0x");
                N.append(Integer.toHexString(this.egl.eglGetError()));
