...
public class PeerConnectionFactory {
    ...
    public static class InitializationOptions {
        ...
        private InitializationOptions(Context context, String str, boolean z, NativeLibraryLoader nativeLibraryLoader2, String str2, @Nullable Loggable loggable2, @Nullable Logging.Severity severity) {
            this.applicationContext = context;
            this.fieldTrials = str;
            this.enableInternalTracer = z;
            this.nativeLibraryLoader = nativeLibraryLoader2;
