...
public class TextureBufferImpl implements VideoFrame.TextureBuffer {
    ...
    public TextureBufferImpl(int i, int i2, VideoFrame.TextureBuffer.Type type2, int i3, Matrix matrix, Handler handler, YuvConverter yuvConverter2, @Nullable final Runnable runnable) {
        this(i, i2, i, i2, type2, i3, matrix, handler, yuvConverter2, new RefCountMonitor() { // from class: org.webrtc.TextureBufferImpl.1
    ...
    public VideoFrame.I420Buffer toI420() {
        return (VideoFrame.I420Buffer) ThreadUtils.invokeAtFrontUninterruptibly(this.toI420Handler, new Callable() { // from class: x6.f.a0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return TextureBufferImpl.this.a();
            }
        });
    }
    ...
    private TextureBufferImpl(int i, int i2, int i3, int i4, VideoFrame.TextureBuffer.Type type2, int i5, Matrix matrix, Handler handler, YuvConverter yuvConverter2, RefCountMonitor refCountMonitor2) {
        ...
        this.refCountDelegate = new RefCountDelegate(new Runnable(refCountMonitor2) { // from class: x6.f.z
            public final /* synthetic */ TextureBufferImpl.RefCountMonitor b;
            ...
            public final void run() {
                ...
                TextureBufferImpl.RefCountMonitor refCountMonitor3 = this.b;
                Objects.requireNonNull(textureBufferImpl);
                refCountMonitor3.onDestroy(textureBufferImpl);
            }
        });
