...
public final class RequestFactory {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                if (this.isMultipart) {
                    ...
                    if (!value5.isEmpty()) {
                        Headers of = Headers.of(HttpHeaders.CONTENT_DISPOSITION, a.e3("form-data; name=\"", value5, "\""), "Content-Transfer-Encoding", part.encoding());
                ...
                for (int i2 = i - 1; i2 >= 0; i2--) {
                    ...
                    if ((parameterHandler instanceof ParameterHandler.Tag) && ((ParameterHandler.Tag) parameterHandler).cls.equals(rawType10)) {
                        ...
                        L.append(rawType10.getName());
                        L.append(" is duplicate of parameter #");
                        L.append(i2 + 1);
                        L.append(" and would always overwrite its value.");
                        throw Utils.parameterError(method2, i, L.toString(), new Object[0]);
                    }
                }
    ...
    public Request create(Object[] objArr) throws IOException {
        ...
        throw new IllegalArgumentException(a.j(a.M("Argument count (", length, ") doesn't match expected count ("), parameterHandlerArr.length, ")"));
    }
}
