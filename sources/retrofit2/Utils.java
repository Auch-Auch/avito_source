...
public final class Utils {
    ...
    public static final class WildcardTypeImpl implements WildcardType {
        ...
        public String toString() {
            if (this.lowerBound != null) {
                ...
                L.append(Utils.typeToString(this.lowerBound));
                return L.toString();
            } else if (this.upperBound == Object.class) {
                return "?";
            } else {
                StringBuilder L2 = a.L("? extends ");
                L2.append(Utils.typeToString(this.upperBound));
                return L2.toString();
            }
        }
    }
    ...
    public static Type getParameterUpperBound(int i, ParameterizedType parameterizedType) {
        ...
        if (i < 0 || i >= actualTypeArguments.length) {
            StringBuilder M = a.M("Index ", i, " not in range [0,");
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i, String str, Object... objArr) {
        StringBuilder Q = a.Q(str, " (parameter #");
        Q.append(i + 1);
        Q.append(")");
        return methodError(method, th, Q.toString(), objArr);
    }
    ...
    public static RuntimeException methodError(Method method, @Nullable Throwable th, String str, Object... objArr) {
        StringBuilder Q = a.Q(String.format(str, objArr), "\n    for method ");
        Q.append(method.getDeclaringClass().getSimpleName());
        Q.append(".");
    ...
    public static RuntimeException parameterError(Method method, int i, String str, Object... objArr) {
        ...
        Q.append(i + 1);
        Q.append(")");
        return methodError(method, Q.toString(), objArr);
    }
}
