...
public final class CodedOutputStream {
    ...
    public void writeRawBytes(ByteString byteString, int i, int i2) throws IOException {
        ...
        a();
        if (i7 <= this.b) {
            byteString.copyTo(this.a, i6, 0, i7);
            this.c = i7;
        } else {
            OutputStream outputStream = this.e;
            if (i6 < 0) {
                throw new IndexOutOfBoundsException(a.m2(30, "Source offset < 0: ", i6));
            } else if (i7 >= 0) {
                int i8 = i6 + i7;
                if (i8 > byteString.size()) {
                    throw new IndexOutOfBoundsException(a.m2(39, "Source end offset exceeded: ", i8));
                } else if (i7 > 0) {
                    byteString.b(outputStream, i6, i7);
                }
            } else {
                throw new IndexOutOfBoundsException(a.m2(23, "Length < 0: ", i7));
            }
        }
        this.d += i7;
    }
