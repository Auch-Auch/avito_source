...
public enum KotlinTarget {
    ...
    FIELD(AnalyticFieldsName.field, false, 2),
    ...
    @NotNull
    public static final HashMap<String, KotlinTarget> b = new HashMap<>();
    @NotNull
    ...
    static {
        ...
        ArraysKt___ArraysKt.toSet(values());
        ...
        c = r.mapOf(TuplesKt.to(annotationUseSiteTarget, kotlinTarget3), TuplesKt.to(annotationUseSiteTarget2, kotlinTarget4), TuplesKt.to(AnnotationUseSiteTarget.PROPERTY, PROPERTY), TuplesKt.to(AnnotationUseSiteTarget.FILE, FILE), TuplesKt.to(AnnotationUseSiteTarget.PROPERTY_GETTER, PROPERTY_GETTER), TuplesKt.to(AnnotationUseSiteTarget.PROPERTY_SETTER, PROPERTY_SETTER), TuplesKt.to(AnnotationUseSiteTarget.RECEIVER, kotlinTarget3), TuplesKt.to(AnnotationUseSiteTarget.SETTER_PARAMETER, kotlinTarget3), TuplesKt.to(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, kotlinTarget4));
    }
    ...
    /* access modifiers changed from: public */
    KotlinTarget(String str, boolean z, int i) {
        this.a = (i & 2) != 0 ? true : z;
    }
}
