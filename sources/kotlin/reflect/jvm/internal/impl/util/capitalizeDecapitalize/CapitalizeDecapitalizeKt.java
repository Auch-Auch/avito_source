...
public final class CapitalizeDecapitalizeKt {
    ...
    public static final String decapitalizeSmartForCompiler(@NotNull String str, boolean z) {
        Object obj;
        Intrinsics.checkNotNullParameter(str, "<this>");
        if ((str.length() == 0) || !a(str, 0, z)) {
            return str;
        }
        if (str.length() == 1 || !a(str, 1, z)) {
            return z ? decapitalizeAsciiOnly(str) : m.decapitalize(str);
        }
        ...
        while (true) {
            ...
            obj = it.next();
            if (!a(str, ((Number) obj).intValue(), z)) {
                break;
            }
        }
        ...
        return Intrinsics.stringPlus(b, substring2);
    }
