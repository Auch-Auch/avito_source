...
public final class ProtoTypeTableUtilKt {
    ...
    public static final List<ProtoBuf.Type> supertypes(@NotNull ProtoBuf.Class r3, @NotNull TypeTable typeTable) {
        ...
        if (supertypeList == null) {
            ...
            supertypeList = new ArrayList<>(e.collectionSizeOrDefault(supertypeIdList, 10));
            for (T t : supertypeIdList) {
                Intrinsics.checkNotNullExpressionValue(t, "it");
                supertypeList.add(typeTable.get(t.intValue()));
            }
        }
    ...
    public static final List<ProtoBuf.Type> upperBounds(@NotNull ProtoBuf.TypeParameter typeParameter, @NotNull TypeTable typeTable) {
        ...
        if (upperBoundList == null) {
            ...
            upperBoundList = new ArrayList<>(e.collectionSizeOrDefault(upperBoundIdList, 10));
            for (T t : upperBoundIdList) {
                Intrinsics.checkNotNullExpressionValue(t, "it");
                upperBoundList.add(typeTable.get(t.intValue()));
            }
        }
