...
public class MemberComparator implements Comparator<DeclarationDescriptor> {
    ...
    public static final DescriptorRenderer a = DescriptorRenderer.Companion.withOptions(new a());
    ...
    public static class NameAndTypeMemberComparator implements Comparator<DeclarationDescriptor> {
        ...
        public static Integer a(DeclarationDescriptor declarationDescriptor, DeclarationDescriptor declarationDescriptor2) {
            int b = b(declarationDescriptor2) - b(declarationDescriptor);
            if (b != 0) {
        ...
        public int compare(DeclarationDescriptor declarationDescriptor, DeclarationDescriptor declarationDescriptor2) {
            Integer a = a(declarationDescriptor, declarationDescriptor2);
            if (a != null) {
                return a.intValue();
            }
            return 0;
    ...
    public static class a implements Function1<DescriptorRendererOptions, Unit> {
    ...
    public int compare(DeclarationDescriptor declarationDescriptor, DeclarationDescriptor declarationDescriptor2) {
        int ordinal;
        Integer a3 = NameAndTypeMemberComparator.a(declarationDescriptor, declarationDescriptor2);
        if (a3 != null) {
            return a3.intValue();
        }
        if ((declarationDescriptor instanceof TypeAliasDescriptor) && (declarationDescriptor2 instanceof TypeAliasDescriptor)) {
            ...
            if (extensionReceiverParameter != null) {
                DescriptorRenderer descriptorRenderer2 = a;
            ...
            for (int i = 0; i < Math.min(valueParameters.size(), valueParameters2.size()); i++) {
                DescriptorRenderer descriptorRenderer3 = a;
            ...
            for (int i2 = 0; i2 < Math.min(typeParameters.size(), typeParameters2.size()); i2++) {
                ...
                for (int i3 = 0; i3 < upperBounds.size(); i3++) {
                    DescriptorRenderer descriptorRenderer4 = a;
        ...
        DescriptorRenderer descriptorRenderer5 = a;
