...
public class Reflection {
    ...
    public static void setUpperBounds(KTypeParameter kTypeParameter, KType... kTypeArr) {
        a.setUpperBounds(kTypeParameter, ArraysKt___ArraysKt.toList(kTypeArr));
    }
    ...
    public static KType nullableTypeOf(Class cls, KTypeProjection... kTypeProjectionArr) {
        return a.typeOf(getOrCreateKotlinClass(cls), ArraysKt___ArraysKt.toList(kTypeProjectionArr), true);
    }

    @SinceKotlin(version = "1.4")
    public static KType typeOf(Class cls, KTypeProjection... kTypeProjectionArr) {
        return a.typeOf(getOrCreateKotlinClass(cls), ArraysKt___ArraysKt.toList(kTypeProjectionArr), false);
    }
}
