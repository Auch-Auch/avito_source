...
public final class MediaBrowserCompat {
        ...
        public void onReceiveResult(int i, Bundle bundle) {
            if (this.mCallback != null) {
                ...
                if (i == -1) {
                    ...
                    StringBuilder M = a.M("Unknown result code: ", i, " (extras=");
    ...
    public static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        public void sendCustomAction(@NonNull final String str, final Bundle bundle, @Nullable final CustomActionCallback customActionCallback) {
            if (isConnected()) {
                ...
                sb.append("extras ");
                sb.append(bundle);
                throw new IllegalStateException(a.t(sb, " because the browser is not connected to the ", "service."));
            }
        }
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            public void onServiceConnected(final ComponentName componentName, final IBinder iBinder) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.1
                    ...
                    public void run() {
                        boolean z = MediaBrowserCompat.DEBUG;
                        if (z) {
                            StringBuilder L = a.L("MediaServiceConnection.onServiceConnected name=");
                        ...
                        if (MediaServiceConnection.this.isCurrent("onServiceConnected")) {
                            ...
                            if (z) {
                                try {
                                    ...
                                    StringBuilder L2 = a.L("RemoteException during connect for ");
                                    L2.append(MediaBrowserImplBase.this.mServiceComponent);
                                    L2.toString();
            ...
            public void onServiceDisconnected(final ComponentName componentName) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.2
                    ...
                    public void run() {
                        if (MediaBrowserCompat.DEBUG) {
                            StringBuilder L = a.L("MediaServiceConnection.onServiceDisconnected name=");
                            L.append(componentName);
                            L.append(" this=");
                            L.append(this);
                            L.append(" mServiceConnection=");
        ...
        private static String getStateLabel(int i) {
            ...
            if (i != 3) {
                return i != 4 ? a.M2("UNKNOWN/", i) : "CONNECT_STATE_SUSPENDED";
            }
        ...
        private boolean isCurrent(Messenger messenger, String str) {
            ...
            Q.append(this.mCallbacksMessenger);
            Q.append(" this=");
            Q.append(this);
            Q.toString();
            return false;
        ...
        public void connect() {
                    ...
                    public void run() {
                        ...
                        if (mediaBrowserImplBase.mState != 0) {
                            ...
                            if (MediaBrowserCompat.DEBUG && mediaBrowserImplBase.mServiceConnection != null) {
                                StringBuilder L = a.L("mServiceConnection should be null. Instead it is ");
                                L.append(MediaBrowserImplBase.this.mServiceConnection);
                                throw new RuntimeException(L.toString());
                            } else if (mediaBrowserImplBase.mServiceBinderWrapper != null) {
                                StringBuilder L2 = a.L("mServiceBinderWrapper should be null. Instead it is ");
                                L2.append(MediaBrowserImplBase.this.mServiceBinderWrapper);
                                ...
                                try {
                                    ...
                                    StringBuilder L3 = a.L("Failed binding to service ");
                                    L3.append(MediaBrowserImplBase.this.mServiceComponent);
                                    L3.toString();
                                }
                                if (!z) {
                                ...
                                StringBuilder L4 = a.L("mCallbacksMessenger should be null. Instead it is ");
                                L4.append(MediaBrowserImplBase.this.mCallbacksMessenger);
            ...
            throw new IllegalStateException(a.t(a.L("connect() called while neigther disconnecting nor disconnected (state="), getStateLabel(this.mState), ")"));
        }
                ...
                public void run() {
                    ...
                    if (messenger != null) {
                        try {
                            ...
                            StringBuilder L = a.L("RemoteException during connect for ");
        ...
        public void dump() {
            StringBuilder L = a.L("  mServiceComponent=");
            ...
            StringBuilder L2 = a.L("  mServiceConnection=");
            L2.append(this.mServiceConnection);
            L2.toString();
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException(a.t(a.L("getExtras() called while not connected (state="), getStateLabel(this.mState), ")"));
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException(a.t(a.L("getRoot() called while not connected(state="), getStateLabel(this.mState), ")"));
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException(a.j(a.L("getServiceComponent() called while not connected (state="), this.mState, ")"));
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException(a.j(a.L("getSessionToken() called while not connected(state="), this.mState, ")"));
        }
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserServiceCallbackImpl
        public void onConnectionFailed(Messenger messenger) {
            StringBuilder L = a.L("onConnectFailed for ");
            L.append(this.mServiceComponent);
            L.toString();
        ...
        public void onLoadChildren(Messenger messenger, String str, List list, Bundle bundle, Bundle bundle2) {
            ...
            if (isCurrent(messenger, "onLoadChildren")) {
                if (MediaBrowserCompat.DEBUG) {
                    StringBuilder L = a.L("onLoadChildren for ");
                    L.append(this.mServiceComponent);
                    L.append(" id=");
                    L.append(str);
                    L.toString();
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            if (isConnected()) {
                ...
                throw new IllegalStateException(a.t(a.L("search() called while not connected (state="), getStateLabel(this.mState), ")"));
            }
        }
