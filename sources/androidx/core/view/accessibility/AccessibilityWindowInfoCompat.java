...
public class AccessibilityWindowInfoCompat {
    ...
    public AccessibilityNodeInfoCompat getAnchor() {
        if (Build.VERSION.SDK_INT >= 24) {
            return AccessibilityNodeInfoCompat.e(((AccessibilityWindowInfo) this.a).getAnchor());
        }
        return null;
    }
    ...
    public AccessibilityNodeInfoCompat getRoot() {
        return AccessibilityNodeInfoCompat.e(((AccessibilityWindowInfo) this.a).getRoot());
    }
