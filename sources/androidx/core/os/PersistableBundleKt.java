        ...
        for (Pair<String, ? extends Object> pair : pairArr) {
            ...
            if (component2 == null) {
                ...
                if (Build.VERSION.SDK_INT >= 22) {
                    ...
                    throw new IllegalArgumentException(a.d3("Illegal value type boolean for key \"", component1, Typography.quote));
                }
                ...
                if (String.class.isAssignableFrom(componentType)) {
                    ...
                    throw new IllegalArgumentException(a.e("Illegal value array type ", componentType.getCanonicalName(), " for key \"", component1, Typography.quote));
                }
            } else {
                throw new IllegalArgumentException(a.e("Illegal value type ", component2.getClass().getCanonicalName(), " for key \"", component1, Typography.quote));
            }
        }
