...
public class PercentLayoutHelper {
    ...
    public static class PercentLayoutInfo {
        ...
        public void fillLayoutParams(ViewGroup.LayoutParams layoutParams, int i, int i2) {
            ...
            boolean z = false;
            boolean z2 = (aVar.b || i3 == 0) && this.widthPercent < 0.0f;
            if ((aVar.a || i4 == 0) && this.heightPercent < 0.0f) {
                z = true;
            }
        ...
        public void restoreLayoutParams(ViewGroup.LayoutParams layoutParams) {
            a aVar = this.a;
            if (!aVar.b) {
                layoutParams.width = ((ViewGroup.MarginLayoutParams) aVar).width;
            }
            if (!aVar.a) {
                layoutParams.height = ((ViewGroup.MarginLayoutParams) aVar).height;
            }
            aVar.b = false;
            aVar.a = false;
        }
        ...
        public void restoreMarginLayoutParams(ViewGroup.MarginLayoutParams marginLayoutParams) {
            ...
            a aVar = this.a;
            marginLayoutParams.leftMargin = ((ViewGroup.MarginLayoutParams) aVar).leftMargin;
            marginLayoutParams.topMargin = ((ViewGroup.MarginLayoutParams) aVar).topMargin;
            marginLayoutParams.rightMargin = ((ViewGroup.MarginLayoutParams) aVar).rightMargin;
            marginLayoutParams.bottomMargin = ((ViewGroup.MarginLayoutParams) aVar).bottomMargin;
            MarginLayoutParamsCompat.setMarginStart(marginLayoutParams, MarginLayoutParamsCompat.getMarginStart(aVar));
        ...
        public void fillMarginLayoutParams(View view, ViewGroup.MarginLayoutParams marginLayoutParams, int i, int i2) {
            ...
            MarginLayoutParamsCompat.setMarginStart(aVar, MarginLayoutParamsCompat.getMarginStart(marginLayoutParams));
    ...
    public boolean handleMeasuredStateTooSmall() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            ViewGroup.LayoutParams layoutParams = childAt.getLayoutParams();
            if ((layoutParams instanceof PercentLayoutParams) && (percentLayoutInfo = ((PercentLayoutParams) layoutParams).getPercentLayoutInfo()) != null) {
                if ((childAt.getMeasuredWidthAndState() & ViewCompat.MEASURED_STATE_MASK) == 16777216 && percentLayoutInfo.widthPercent >= 0.0f && ((ViewGroup.MarginLayoutParams) percentLayoutInfo.a).width == -2) {
                    layoutParams.width = -2;
                    z = true;
                }
                if ((childAt.getMeasuredHeightAndState() & ViewCompat.MEASURED_STATE_MASK) == 16777216 && percentLayoutInfo.heightPercent >= 0.0f && ((ViewGroup.MarginLayoutParams) percentLayoutInfo.a).height == -2) {
