...
public abstract class SimpleItemAnimator extends RecyclerView.ItemAnimator {
    ...
    public abstract boolean mo732animateAdd(RecyclerView.ViewHolder viewHolder);
    ...
    public boolean animateAppearance(@NonNull RecyclerView.ViewHolder viewHolder, @Nullable RecyclerView.ItemAnimator.ItemHolderInfo itemHolderInfo, @NonNull RecyclerView.ItemAnimator.ItemHolderInfo itemHolderInfo2) {
        ...
        if (itemHolderInfo == null || ((i = itemHolderInfo.left) == (i2 = itemHolderInfo2.left) && itemHolderInfo.top == itemHolderInfo2.top)) {
            return mo732animateAdd(viewHolder);
        }
        return mo733animateMove(viewHolder, i, itemHolderInfo.top, i2, itemHolderInfo2.top);
    }
    ...
    public boolean animateDisappearance(@NonNull RecyclerView.ViewHolder viewHolder, @NonNull RecyclerView.ItemAnimator.ItemHolderInfo itemHolderInfo, @Nullable RecyclerView.ItemAnimator.ItemHolderInfo itemHolderInfo2) {
        ...
        if (viewHolder.j() || (i == left && i2 == top)) {
            return mo734animateRemove(viewHolder);
        }
        view.layout(left, top, view.getWidth() + left, view.getHeight() + top);
        return mo733animateMove(viewHolder, i, i2, left, top);
    }

    /* renamed from: animateMove */
    public abstract boolean mo733animateMove(RecyclerView.ViewHolder viewHolder, int i, int i2, int i3, int i4);
    ...
    public abstract boolean mo734animateRemove(RecyclerView.ViewHolder viewHolder);

    @Override // androidx.recyclerview.widget.RecyclerView.ItemAnimator
    public boolean canReuseUpdatedViewHolder(@NonNull RecyclerView.ViewHolder viewHolder) {
        return !this.g || viewHolder.i();
    }
