...
public abstract class ConstraintHelper extends View {
    ...
    public final void a(String str) {
        if (str != null && str.length() != 0 && this.myContext != null) {
            ...
            int e = e(trim);
            if (e != 0) {
                this.b.put(Integer.valueOf(e), trim);
                b(e);
            }
        }
    }
    ...
    public void updatePreLayout(ConstraintLayout constraintLayout) {
        ...
        if (helper != null) {
            ...
            for (int i = 0; i < this.mCount; i++) {
                ...
                if (viewById == null && (d = d(constraintLayout, (str = this.b.get(Integer.valueOf(i2))))) != 0) {
                    this.mIds[i] = d;
                    this.b.put(Integer.valueOf(d), str);
                    viewById = constraintLayout.getViewById(d);
                }
                if (viewById != null) {
    ...
    public void validateParams() {
        if (this.mHelperWidget != null) {
            ...
            if (layoutParams instanceof ConstraintLayout.LayoutParams) {
                ((ConstraintLayout.LayoutParams) layoutParams).s = (ConstraintWidget) this.mHelperWidget;
            }
        }
    }
