...
import l6.i.a.a;
public abstract class CursorAdapter extends BaseAdapter implements Filterable, a.AbstractC0528a {
    @Deprecated
    ...
    @Override // l6.i.a.a.AbstractC0528a
    ...
    public Filter getFilter() {
        if (this.mCursorFilter == null) {
            this.mCursorFilter = new l6.i.a.a(this);
        }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (!this.mDataValid) {
            ...
            throw new IllegalStateException(a2.b.a.a.a.M2("couldn't move cursor to position ", i));
        }
    }
