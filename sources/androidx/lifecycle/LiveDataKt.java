...
public final class LiveDataKt {
    ...
    public static final <T> Observer<T> observe(@NotNull LiveData<T> liveData, @NotNull LifecycleOwner lifecycleOwner, @NotNull Function1<? super T, Unit> function1) {
        ...
        LiveDataKt$observe$wrappedObserver$1 liveDataKt$observe$wrappedObserver$1 = new Observer<T>(function1) { // from class: androidx.lifecycle.LiveDataKt$observe$wrappedObserver$1
