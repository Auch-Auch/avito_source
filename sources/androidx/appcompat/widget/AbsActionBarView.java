...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    public boolean isOverflowMenuShowPending() {
        b bVar = this.mActionMenuPresenter;
        return bVar != null && (bVar.r != null || bVar.c());
    }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        b bVar = this.mActionMenuPresenter;
        if (bVar != null) {
            bVar.l = ActionBarPolicy.get(bVar.mContext).getMaxActionButtons();
    ...
    public int positionChild(View view, int i, int i2, int i3, boolean z) {
        ...
        int R1 = a2.b.a.a.a.R1(i3, measuredHeight, 2, i2);
        if (z) {
            view.layout(i - measuredWidth, R1, i, measuredHeight + R1);
        } else {
            view.layout(i, R1, i + measuredWidth, measuredHeight + R1);
        }
