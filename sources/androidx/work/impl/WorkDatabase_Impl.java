...
public final class WorkDatabase_Impl extends WorkDatabase {
    ...
    public volatile RawWorkInfoDao r;
    ...
    public class a extends RoomOpenHelper.Delegate {
        ...
        public void dropAllTables(SupportSQLiteDatabase supportSQLiteDatabase) {
            ...
            List<RoomDatabase.Callback> list = workDatabase_Impl.mCallbacks;
            if (list != null) {
                int size = list.size();
                for (int i2 = 0; i2 < size; i2++) {
                    WorkDatabase_Impl.this.mCallbacks.get(i2).onDestructiveMigration(supportSQLiteDatabase);
                }
            }
        }
        ...
        public void onCreate(SupportSQLiteDatabase supportSQLiteDatabase) {
            ...
            if (list != null) {
                int size = list.size();
                for (int i2 = 0; i2 < size; i2++) {
                    WorkDatabase_Impl.this.mCallbacks.get(i2).onCreate(supportSQLiteDatabase);
                }
            }
        }
        ...
        public void onOpen(SupportSQLiteDatabase supportSQLiteDatabase) {
            ...
            if (list != null) {
                int size = list.size();
                for (int i2 = 0; i2 < size; i2++) {
                    WorkDatabase_Impl.this.mCallbacks.get(i2).onOpen(supportSQLiteDatabase);
                }
            }
        }
    ...
    public SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration databaseConfiguration) {
        return databaseConfiguration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new a(11), "cf029002fffdcadf079e8d0a1c9a70ac", "8aff2efc47fafe870c738f727dfcfc6e")).build());
    }
    ...
    public RawWorkInfoDao rawWorkInfoDao() {
        ...
        synchronized (this) {
            if (this.r == null) {
                this.r = new RawWorkInfoDao_Impl(this);
            }
            rawWorkInfoDao = this.r;
        }
