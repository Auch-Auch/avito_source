...
public final class PerformanceVasTrackerImpl implements PerformanceVasTracker {
    ...
    @Inject
    public PerformanceVasTrackerImpl(@PerformanceVasAnalytics @NotNull ScreenDiInjectTracker screenDiInjectTracker, @PerformanceVasAnalytics @NotNull ScreenInitTracker screenInitTracker, @PerformanceVasAnalytics @NotNull ScreenFlowTrackerProvider screenFlowTrackerProvider) {
    ...
    @Override // com.avito.android.vas_performance.tracker.PerformanceVasTracker
    public void startDrawing() {
        ContentDrawingTracker contentDrawing = this.f.getContentDrawing(ScreenPublicConstsKt.CONTENT_TYPE_MNZ_PERFORMANCE_VAS);
    ...
    public void startLoading() {
        ContentLoadingTracker contentLoadingFromRemoteStorage = this.f.getContentLoadingFromRemoteStorage(ScreenPublicConstsKt.CONTENT_TYPE_MNZ_PERFORMANCE_VAS);
    ...
    public void startPreparing() {
        ViewDataPreparingTracker viewPreparing = this.f.getViewPreparing(ScreenPublicConstsKt.CONTENT_TYPE_MNZ_PERFORMANCE_VAS);
        viewPreparing.start();
        Unit unit = Unit.INSTANCE;
