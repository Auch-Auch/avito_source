...
public final class PerformanceVasDiffUtil extends DiffUtil.Callback {
    ...
    public PerformanceVasDiffUtil(@NotNull List<? extends Item> list, @NotNull List<? extends Item> list2) {
    ...
    public boolean areContentsTheSame(int i, int i2) {
        ...
        if (!(item instanceof PerformanceVasItem) || !(item2 instanceof PerformanceVasItem) || ((PerformanceVasItem) item).getPriceValue() == ((PerformanceVasItem) item2).getPriceValue()) {
            return true;
        }
        return false;
    }
    ...
    public boolean areItemsTheSame(int i, int i2) {
        Item item = this.a.get(i);
        Item item2 = this.b.get(i2);
        if (!(item instanceof PerformanceVasItem) || !(item2 instanceof PerformanceVasItem)) {
            return this.a.get(i).getId() == this.b.get(i2).getId();
        }
        return Intrinsics.areEqual(((PerformanceVasItem) item).getTitle(), ((PerformanceVasItem) item2).getTitle());
    }
