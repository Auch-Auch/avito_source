...
public final class PerformanceVasItemPresenterImpl implements PerformanceVasItemPresenter {
    ...
    public PerformanceVasItemPresenterImpl() {
        PublishSubject<PerformanceVasItem> create = PublishSubject.create();
        Intrinsics.checkNotNullExpressionValue(create, "PublishSubject.create<PerformanceVasItem>()");
        this.a = create;
        this.b = create;
    }

    @Override // com.avito.android.vas_performance.ui.items.vas.PerformanceVasItemPresenter
    @NotNull
    public Observable<PerformanceVasItem> getVasClicksObservable() {
        return this.b;
    }
