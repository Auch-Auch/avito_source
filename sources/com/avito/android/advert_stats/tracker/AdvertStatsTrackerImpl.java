...
public final class AdvertStatsTrackerImpl implements AdvertStatsTracker {
    ...
    @Inject
    public AdvertStatsTrackerImpl(@NotNull ScreenDiInjectTracker screenDiInjectTracker, @NotNull ScreenInitTracker screenInitTracker, @NotNull ScreenFlowTrackerProvider screenFlowTrackerProvider) {
    ...
    @Override // com.avito.android.advert_stats.tracker.AdvertStatsTracker
    public void startDrawing() {
        ContentDrawingTracker contentDrawing = this.f.getContentDrawing("statistics");
    ...
    public void startLoading() {
        ContentLoadingTracker contentLoadingFromRemoteStorage = this.f.getContentLoadingFromRemoteStorage("statistics");
    ...
    public void startPreparing() {
        ViewDataPreparingTracker viewPreparing = this.f.getViewPreparing("statistics");
        viewPreparing.start();
        Unit unit = Unit.INSTANCE;
    ...
    @Override // com.avito.android.advert_stats.tracker.AdvertStatsTracker
    public void trackPreparingError() {
        ViewDataPreparingTracker viewDataPreparingTracker = this.b;
        if (viewDataPreparingTracker != null) {
            viewDataPreparingTracker.trackViewDataPreparing(null, true);
        }
        this.b = null;
    }
}
