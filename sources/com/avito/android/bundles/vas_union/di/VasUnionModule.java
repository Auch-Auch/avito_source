...
import com.avito.android.bundles.vas_union.VasUnionConverterImpl;
...
public final class VasUnionModule {
    ...
    public interface Declarations {
        ...
        @Binds
        @NotNull
        ViewModelProvider.Factory provideUnionViewModelFactory(@NotNull VasUnionViewModelFactory vasUnionViewModelFactory);

        @PerFragment
        @Binds
        @NotNull
        VasUnionRepository provideVasUnionRepository(@NotNull VasUnionRepositoryImpl vasUnionRepositoryImpl);

        @PerFragment
        @Binds
        @NotNull
        VasUnionConverter provideVasUnionsConverter(@NotNull VasUnionConverterImpl vasUnionConverterImpl);
    }
    ...
    @NotNull
    @PerFragment
    public static final VasUnionViewModel provideViewModel(@NotNull Fragment fragment, @NotNull ViewModelProvider.Factory factory) {
        Intrinsics.checkNotNullParameter(fragment, "fragment");
        Intrinsics.checkNotNullParameter(factory, "factory");
        ViewModel viewModel = new ViewModelProvider(fragment, factory).get(VasUnionViewModel.class);
        Intrinsics.checkNotNullExpressionValue(viewModel, "ViewModelProvider(fragme…ionViewModel::class.java)");
        return (VasUnionViewModel) viewModel;
    }
