...
public final class SearchSubscriptionsTrackerImpl implements SearchSubscriptionsTracker {
    ...
    @Inject
    public SearchSubscriptionsTrackerImpl(@NotNull ScreenDiInjectTracker screenDiInjectTracker, @NotNull ScreenInitTracker screenInitTracker, @NotNull ScreenFlowTrackerProvider screenFlowTrackerProvider) {
    ...
    @Override // com.avito.android.tracker.SearchSubscriptionsTracker
    public void startInit() {
        this.d.start();
    }

    @Override // com.avito.android.tracker.SearchSubscriptionsTracker
    public void startSubscriptionsDraw() {
        ContentDrawingTracker contentDrawing = this.e.getContentDrawing("subscriptions");
    ...
    @Override // com.avito.android.tracker.SearchSubscriptionsTracker
    public void startSubscriptionsLoading() {
        ContentLoadingTracker contentLoadingFromRemoteStorage = this.e.getContentLoadingFromRemoteStorage("subscriptions");
    ...
    @Override // com.avito.android.tracker.SearchSubscriptionsTracker
    public void trackSubscriptionsDraw() {
    ...
    @Override // com.avito.android.tracker.SearchSubscriptionsTracker
    public void trackSubscriptionsErrorDraw() {
        ContentDrawingTracker contentDrawingTracker = this.b;
        if (contentDrawingTracker != null) {
    ...
    @Override // com.avito.android.tracker.SearchSubscriptionsTracker
    public void trackSubscriptionsLoadError() {
    ...
    @Override // com.avito.android.tracker.SearchSubscriptionsTracker
    public void trackSubscriptionsLoaded() {
        ContentLoadingTracker contentLoadingTracker = this.a;
        if (contentLoadingTracker != null) {
