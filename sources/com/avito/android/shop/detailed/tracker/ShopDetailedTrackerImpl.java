...
public final class ShopDetailedTrackerImpl implements ShopDetailedTracker {
    ...
    @Inject
    public ShopDetailedTrackerImpl(@NotNull ScreenDiInjectTracker screenDiInjectTracker, @NotNull ScreenInitTracker screenInitTracker, @NotNull ScreenFlowTrackerProvider screenFlowTrackerProvider) {
    ...
    @Override // com.avito.android.shop.detailed.tracker.ShopDetailedTracker
    public void startInit() {
        this.d.start();
    }

    @Override // com.avito.android.shop.detailed.tracker.ShopDetailedTracker
    public void startShopDraw() {
        ContentDrawingTracker contentDrawing = this.e.getContentDrawing(ScreenPublicConstsKt.CONTENT_TYPE_SHOP);
    ...
    @Override // com.avito.android.shop.detailed.tracker.ShopDetailedTracker
    public void startShopServerLoading() {
        ContentLoadingTracker contentLoadingFromRemoteStorage = this.e.getContentLoadingFromRemoteStorage(ScreenPublicConstsKt.CONTENT_TYPE_SHOP);
    ...
    @Override // com.avito.android.shop.detailed.tracker.ShopDetailedTracker
    public void trackShopErrorDraw() {
        ContentDrawingTracker contentDrawingTracker = this.b;
        if (contentDrawingTracker != null) {
    ...
    @Override // com.avito.android.shop.detailed.tracker.ShopDetailedTracker
    public void trackShopLoadError() {
