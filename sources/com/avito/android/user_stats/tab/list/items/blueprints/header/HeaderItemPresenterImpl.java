...
public final class HeaderItemPresenterImpl implements HeaderItemPresenter {
    public void bindView(@NotNull HeaderItemView headerItemView, @NotNull HeaderItem headerItem, int i) {
        ...
        headerItemView.setValue(headerItem.getValue());
        headerItemView.setRelativeValue(headerItem.getRelativeValue());
    }
}
