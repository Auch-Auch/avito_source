...
public final class SetPhoneForAllInteractor implements PhoneActionInteractor {
    ...
    public Single<Unit> performAction(@NotNull String str, @Nullable String str2) {
        ...
        Single<Unit> flatMap = a.e2(this.b, ProfileApi.DefaultImpls.applyPhoneToItemsSingle$default(this.a, str, null, 2, null), "api.applyPhoneToItemsSin…scribeOn(schedulers.io())").flatMap(SetPhoneForAllInteractor$performAction$$inlined$toTyped$1.INSTANCE);
