...
public final class PhoneManagementResourceProviderImpl implements PhoneManagementResourceProvider {
    ...
    public String attachPhoneNumberTitle() {
        String string = this.a.getString(R.string.attach_phone_number);
        Intrinsics.checkNotNullExpressionValue(string, "resources.getString(R.string.attach_phone_number)");
        return string;
    }
