...
public final class LandlinePhoneVerificationInteractor$startVerificationStatusPolling$1$$special$$inlined$toTyped$1<T, R> implements Function<TypedResult<T>, SingleSource<? extends T>> {
    public static final LandlinePhoneVerificationInteractor$startVerificationStatusPolling$1$$special$$inlined$toTyped$1 INSTANCE = new LandlinePhoneVerificationInteractor$startVerificationStatusPolling$1$$special$$inlined$toTyped$1();
