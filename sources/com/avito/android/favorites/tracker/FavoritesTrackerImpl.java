...
public final class FavoritesTrackerImpl implements FavoritesTracker {
    ...
    @Inject
    public FavoritesTrackerImpl(@NotNull ScreenDiInjectTracker screenDiInjectTracker, @NotNull ScreenInitTracker screenInitTracker, @NotNull ScreenFlowTrackerProvider screenFlowTrackerProvider) {
    ...
    @Override // com.avito.android.favorites.tracker.FavoritesTracker
    ...
    @Override // com.avito.android.favorites.tracker.FavoritesTracker
    public void trackAdvertsErrorDraw() {
        ContentDrawingTracker contentDrawingTracker = this.b;
        if (contentDrawingTracker != null) {
    ...
    @Override // com.avito.android.favorites.tracker.FavoritesTracker
    public void trackAdvertsLoadError() {
    ...
    @Override // com.avito.android.favorites.tracker.FavoritesTracker
    public void trackAdvertsLoaded() {
        ContentLoadingTracker contentLoadingTracker = this.a;
        if (contentLoadingTracker != null) {
