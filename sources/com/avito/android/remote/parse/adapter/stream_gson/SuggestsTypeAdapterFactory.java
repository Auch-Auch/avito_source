...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\n\u0010\u000bJ3\u0010\b\u001a\n\u0012\u0004\u0012\u00028\u0000\u0018\u00010\u0007\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0004\u001a\u00020\u00032\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00028\u00000\u0005H\u0016¢\u0006\u0004\b\b\u0010\t¨\u0006\f"}, d2 = {"Lcom/avito/android/remote/parse/adapter/stream_gson/SuggestsTypeAdapterFactory;", "Lcom/google/gson/TypeAdapterFactory;", "T", "Lcom/google/gson/Gson;", "gson", "Lcom/google/gson/reflect/TypeToken;", "type", "Lcom/google/gson/TypeAdapter;", "create", "(Lcom/google/gson/Gson;Lcom/google/gson/reflect/TypeToken;)Lcom/google/gson/TypeAdapter;", "<init>", "()V", "models_release"}, k = 1, mv = {1, 4, 2})
public final class SuggestsTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(@NotNull Gson gson, @NotNull TypeToken<T> typeToken) {
        ...
        if (Intrinsics.areEqual(typeToken.getRawType(), SuggestDeeplink.class)) {
            return new DeeplinkActionTypeAdapter(gson);
        }
        if (Intrinsics.areEqual(typeToken.getRawType(), SuggestNewQuery.class)) {
            return new SuggestNewQueryTypeAdapter();
        }
        if (Intrinsics.areEqual(typeToken.getRawType(), LocalIcon.class)) {
            return new SuggestLocalIconTypeAdapter();
        }
        if (Intrinsics.areEqual(typeToken.getRawType(), GapSuggestItem.class)) {
