...
public final class UserAdvertStatusTypeAdapter extends TypeAdapter<UserAdvert.Status> {
    ...
    public UserAdvert.Status read(@NotNull JsonReader jsonReader) {
        ...
        if (jsonReader.peek() != JsonToken.NULL) {
            ...
            if (peek == jsonToken) {
                ...
                UserAdvertStatusType userAdvertStatusType = Intrinsics.areEqual(str, FirebaseAnalytics.Param.DISCOUNT) ? UserAdvertStatusType.DISCOUNT : null;
    ...
    public void write(@NotNull JsonWriter jsonWriter, @Nullable UserAdvert.Status status) {
