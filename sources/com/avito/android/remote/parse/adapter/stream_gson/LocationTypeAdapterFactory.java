...
public final class LocationTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(@NotNull Gson gson, @NotNull TypeToken<T> typeToken) {
        ...
        if (Intrinsics.areEqual(typeToken.getRawType(), Location.class)) {
