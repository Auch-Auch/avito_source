...
public final class Observables {
    ...
    public static final class c<T, R> implements Function<Long, ObservableSource<? extends Pair<? extends T, ? extends Long>>> {
        ...
        public Object apply(Long l) {
            return this.a.map(new a2.a.a.n3.z.e(l));
        }
    }
    ...
    public static final class h<T, R> implements Function<T, ObservableSource<? extends R>> {
        ...
        public Object apply(Object obj) {
            ...
            return Observables.toObservable((Sequence) function1.invoke(obj));
        }
    }
    ...
    public static final <T1, T2, R> Observable<R> combineLatestWith(@NotNull Observable<T1> observable, @NotNull Observable<T2> observable2, @NotNull Function2<? super T1, ? super T2, ? extends R> function2) {
        ...
        Observable<R> combineLatest = Observable.combineLatest(observable, observable2, new BiFunction<T1, T2, R>(function2) { // from class: com.avito.android.util.rx3.Observables$combineLatestWith$1
    ...
    /* JADX DEBUG: Type inference failed for r8v1. Raw type applied. Possible types: io.reactivex.rxjava3.core.Observable<R>, java.lang.Object, io.reactivex.rxjava3.core.Observable<T> */
    @NotNull
    ...
    public static final <T> Observable<T> deferredObservable(@NotNull Function0<? extends Observable<T>> function0) {
        ...
        Observable<T> defer = Observable.defer(new a2.a.a.n3.z.g(function0));
    ...
    public static final <T> Observable<T> doOnNextIf(@NotNull Observable<T> observable, boolean z, @NotNull Function1<? super T, Unit> function1) {
        ...
        Observable<T> doOnNext = observable.doOnNext(new a2.a.a.n3.z.f(function1));
    ...
    /* JADX DEBUG: Type inference failed for r1v2. Raw type applied. Possible types: io.reactivex.rxjava3.core.Observable<R>, java.lang.Object, io.reactivex.rxjava3.core.Observable<T> */
    @NotNull
    ...
    public static final <T1, T2, R> Observable<R> observableCombineLatest(@NotNull Observable<T1> observable, @NotNull Observable<T2> observable2, @NotNull Function2<? super T1, ? super T2, ? extends R> function2) {
        ...
        Intrinsics.checkNotNullParameter(observable2, "o2");
        Intrinsics.checkNotNullParameter(function2, "combineFunction");
        Observable<R> combineLatest = Observable.combineLatest(observable, observable2, new BiFunction<T1, T2, R>(function2) { // from class: com.avito.android.util.rx3.Observables$observableCombineLatest$1
            public final /* synthetic */ Function2 a;
    ...
    public static final <T> Observable<T> observableFromCallableWithoutComplete(@NotNull Function0<? extends T> function0) {
        ...
        Observable<T> create = Observable.create(new ObservableOnSubscribe<T>(function0) { // from class: com.avito.android.util.rx3.Observables$observableFromCallableWithoutComplete$1
            ...
            /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: io.reactivex.rxjava3.core.ObservableEmitter<T> */
    ...
    public static final <T> Observable<T> onError(@NotNull Observable<T> observable, @NotNull Function1<? super Throwable, Unit> function1) {
        ...
        Intrinsics.checkNotNullParameter(function1, "block");
        Observable<T> doOnError = observable.doOnError(new a2.a.a.n3.z.f(function1));
    ...
    public static final <T1, T2, R> Observable<R> reverseCombineLatestWith(@NotNull Observable<T1> observable, @NotNull Observable<T2> observable2, @NotNull Function2<? super T1, ? super T2, ? extends R> function2) {
        ...
        Intrinsics.checkNotNullParameter(observable2, "other");
        Intrinsics.checkNotNullParameter(function2, "combineFunction");
        Observable<R> combineLatest = Observable.combineLatest(observable2, observable, new BiFunction<T2, T1, R>(function2) { // from class: com.avito.android.util.rx3.Observables$reverseCombineLatestWith$1
            public final /* synthetic */ Function2 a;
    ...
    public static final <T1, T2, R> Observable<R> reverseZipWith(@NotNull Function0<? extends Observable<T1>> function0, @NotNull Observable<T2> observable, @NotNull Function2<? super T1, ? super T2, ? extends R> function2) {
        ...
        Observable<R> zip = Observable.zip(observable, (ObservableSource) function0.invoke(), new BiFunction<T2, T1, R>(function2) { // from class: com.avito.android.util.rx3.Observables$reverseZipWith$1
            public final /* synthetic */ Function2 a;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r2v0, types: [a2.a.a.n3.z.f] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @kotlin.Deprecated(message = "Define your own custom onError handler")
    @org.jetbrains.annotations.NotNull
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final io.reactivex.rxjava3.disposables.Disposable subscribeIgnoreResult(@org.jetbrains.annotations.NotNull io.reactivex.rxjava3.core.Observable<?> r3) {
        /*
            java.lang.String r0 = "$this$subscribeIgnoreResult"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r3, r0)
            com.avito.android.util.rx3.Observables$j r0 = com.avito.android.util.rx3.Observables.j.a
            com.avito.android.util.rx3.Observables$k r1 = com.avito.android.util.rx3.Observables.k.a
            if (r1 == 0) goto L_0x0011
            a2.a.a.n3.z.f r2 = new a2.a.a.n3.z.f
            r2.<init>(r1)
            r1 = r2
        L_0x0011:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.avito.android.util.rx3.Observables.subscribeIgnoreResult(io.reactivex.rxjava3.core.Observable):io.reactivex.rxjava3.disposables.Disposable");
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r1v0, types: [a2.a.a.n3.z.f] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @kotlin.Deprecated(message = "Define your own custom onError handler")
    @org.jetbrains.annotations.NotNull
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final <T> io.reactivex.rxjava3.disposables.Disposable subscribeOnNext(@org.jetbrains.annotations.NotNull io.reactivex.rxjava3.core.Observable<T> r2, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function1<? super T, kotlin.Unit> r3) {
        /*
            java.lang.String r0 = "$this$subscribeOnNext"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, r0)
            java.lang.String r0 = "onNext"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r3, r0)
            a2.a.a.n3.z.f r0 = new a2.a.a.n3.z.f
            r0.<init>(r3)
            com.avito.android.util.rx3.Observables$l r3 = com.avito.android.util.rx3.Observables.l.a
            if (r3 == 0) goto L_0x0019
            a2.a.a.n3.z.f r1 = new a2.a.a.n3.z.f
            r1.<init>(r3)
            r3 = r1
        L_0x0019:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.avito.android.util.rx3.Observables.subscribeOnNext(io.reactivex.rxjava3.core.Observable, kotlin.jvm.functions.Function1):io.reactivex.rxjava3.disposables.Disposable");
    }
    ...
    public static final <T> Observable<T> toObservable(@NotNull Iterator<? extends T> it) {
        ...
        return toObservable(new Object(it) { // from class: com.avito.android.util.rx3.Observables$toIterable$1
    ...
    /* JADX DEBUG: Type inference failed for r1v2. Raw type applied. Possible types: io.reactivex.rxjava3.core.Observable<R>, java.lang.Object, io.reactivex.rxjava3.core.Observable<OutT> */
    @NotNull
    public static final <KeyT, EventT, OutT> Observable<OutT> transformByKey(@NotNull Observable<EventT> observable, @NotNull Function1<? super EventT, ? extends KeyT> function1, @NotNull Function2<? super KeyT, ? super Observable<EventT>, ? extends Observable<OutT>> function2) {
        ...
        Observable observable2 = (Observable<R>) observable.groupBy(new Function<EventT, KeyT>(function1) { // from class: com.avito.android.util.rx3.Observables$transformByKey$1
            public final /* synthetic */ Function1 a;
            ...
            @Override // io.reactivex.rxjava3.functions.Function
            @Nullable
            public final KeyT apply(EventT eventt) {
                Function1 function12 = this.a;
                Intrinsics.checkNotNullExpressionValue(eventt, "event");
                return (KeyT) function12.invoke(eventt);
            }
        }).flatMap(new Function<GroupedObservable<KeyT, EventT>, ObservableSource<? extends OutT>>(function2) { // from class: com.avito.android.util.rx3.Observables$transformByKey$2
            public final /* synthetic */ Function2 a;
            ...
            public final ObservableSource<? extends OutT> apply(GroupedObservable<KeyT, EventT> groupedObservable) {
                Function2 function22 = this.a;
                Intrinsics.checkNotNullExpressionValue(groupedObservable, "groupedObs");
                return (ObservableSource) function22.invoke(groupedObservable.getKey(), groupedObservable);
            }
    ...
    public static final <T1, T2, T3, R> Observable<R> combineLatestWith(@NotNull Observable<T1> observable, @NotNull Observable<T2> observable2, @NotNull Observable<T3> observable3, @NotNull Function3<? super T1, ? super T2, ? super T3, ? extends R> function3) {
        ...
        Observable<R> combineLatest = Observable.combineLatest(observable, observable2, observable3, new io.reactivex.rxjava3.functions.Function3<T1, T2, T3, R>(function3) { // from class: com.avito.android.util.rx3.Observables$combineLatestWith$3
    ...
    public static final <T1, T2> Observable<Pair<T1, T2>> combineLatestWith(@NotNull Observable<T1> observable, @NotNull Observable<T2> observable2) {
        Intrinsics.checkNotNullParameter(observable, "$this$combineLatestWith");
        Intrinsics.checkNotNullParameter(observable2, "o2");
        Observable<Pair<T1, T2>> combineLatest = Observable.combineLatest(observable, observable2, new BiFunction<T1, T2, R>() { // from class: com.avito.android.util.rx3.Observables$combineLatestWith$$inlined$combineLatestWith$1
            @Override // io.reactivex.rxjava3.functions.BiFunction
            public final R apply(T1 t1, T2 t2) {
                Intrinsics.checkNotNullExpressionValue(t1, "t1");
                Intrinsics.checkNotNullExpressionValue(t2, "t2");
    ...
    public static final <T1, T2, T3> Observable<Triple<T1, T2, T3>> combineLatestWith(@NotNull Observable<T1> observable, @NotNull Observable<T2> observable2, @NotNull Observable<T3> observable3) {
        ...
        Intrinsics.checkNotNullParameter(observable2, "o2");
        Intrinsics.checkNotNullParameter(observable3, "o3");
        Observable<Triple<T1, T2, T3>> combineLatest = Observable.combineLatest(observable, observable2, observable3, new io.reactivex.rxjava3.functions.Function3<T1, T2, T3, R>() { // from class: com.avito.android.util.rx3.Observables$combineLatestWith$$inlined$combineLatestWith$2
            @Override // io.reactivex.rxjava3.functions.Function3
            public final R apply(T1 t1, T2 t2, T3 t3) {
                Intrinsics.checkNotNullExpressionValue(t1, "t1");
                Intrinsics.checkNotNullExpressionValue(t2, "t2");
    ...
    public static final <T1, T2, T3, R> Observable<R> observableCombineLatest(@NotNull Observable<T1> observable, @NotNull Observable<T2> observable2, @NotNull Observable<T3> observable3, @NotNull Function3<? super T1, ? super T2, ? super T3, ? extends R> function3) {
        ...
        Intrinsics.checkNotNullParameter(observable3, "o3");
        Intrinsics.checkNotNullParameter(function3, "combineFunction");
        Observable<R> combineLatest = Observable.combineLatest(observable, observable2, observable3, new io.reactivex.rxjava3.functions.Function3<T1, T2, T3, R>(function3) { // from class: com.avito.android.util.rx3.Observables$observableCombineLatest$3
            public final /* synthetic */ Function3 a;
    ...
    public static final <T> Observable<T> toObservable(@NotNull Sequence<? extends T> sequence) {
        ...
        Observable<T> fromIterable = Observable.fromIterable(new Object(sequence) { // from class: com.avito.android.util.rx3.Observables$toObservable$1
