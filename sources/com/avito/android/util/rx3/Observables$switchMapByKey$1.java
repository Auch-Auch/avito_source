...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000+\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010%\n\u0002\u0018\u0002\n\u0002\b\u0007*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u001f\u0010\u0005\u001a\u00020\u00042\u000e\u0010\u0003\u001a\n\u0012\u0006\b\u0000\u0012\u00028\u00000\u0002H\u0014¢\u0006\u0004\b\u0005\u0010\u0006R\u001c\u0010\n\u001a\b\u0012\u0004\u0012\u00028\u00000\u00078\u0002@\u0002X\u0004¢\u0006\u0006\n\u0004\b\b\u0010\tR\"\u0010\u000f\u001a\u000e\u0012\u0004\u0012\u00028\u0001\u0012\u0004\u0012\u00020\f0\u000b8\u0002@\u0002X\u0004¢\u0006\u0006\n\u0004\b\r\u0010\u000eR\u001c\u0010\u0012\u001a\b\u0012\u0004\u0012\u00028\u00010\u00018\u0002@\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0010\u0010\u0011¨\u0006\u0013"}, d2 = {"com/avito/android/util/rx3/Observables$switchMapByKey$1", "Lio/reactivex/rxjava3/core/Observable;", "Lio/reactivex/rxjava3/core/Observer;", "observer", "", "subscribeActual", "(Lio/reactivex/rxjava3/core/Observer;)V", "Lcom/jakewharton/rxrelay3/Relay;", "c", "Lcom/jakewharton/rxrelay3/Relay;", "outRelay", "", "Lio/reactivex/rxjava3/disposables/Disposable;", AuthSource.BOOKING_ORDER, "Ljava/util/Map;", "disposableMap", AuthSource.SEND_ABUSE, "Lio/reactivex/rxjava3/core/Observable;", "source", "rx"}, k = 1, mv = {1, 4, 2})
public final class Observables$switchMapByKey$1 extends Observable<OutT> {
    ...
    public Observables$switchMapByKey$1(Observable<EventT> observable, Function1 function1, Function1 function12) {
        ...
        this.f = function12;
        this.a = observable;
        Relay<OutT> serialized = PublishRelay.create().toSerialized();
    ...
    public void subscribeActual(@NotNull Observer<? super OutT> observer) {
        ...
        this.a.subscribe(new Consumer<EventT>(this) { // from class: com.avito.android.util.rx3.Observables$switchMapByKey$1$subscribeActual$1
