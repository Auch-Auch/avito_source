...
public final class EsiaSignInManagerImpl implements EsiaSignInManager {
    ...
    @Override // com.avito.android.social.EsiaSignInManager, com.avito.android.social.IsSocialNetwork
    @NotNull
    public SocialType getType() {
        return EsiaSignInManager.DefaultImpls.getType(this);
    }
    ...
    public boolean handleActivityResult(int i, int i2, @Nullable Intent intent, @Nullable Function1<? super SignInManager.Result, Unit> function1) {
        ...
        if (i2 == -1) {
            this.a = intent != null ? intent.getStringExtra(EsiaSignInManagerKt.EXTRA_ESIA_CODE) : null;
            if (intent != null) {
                intent.getStringExtra(EsiaSignInManagerKt.EXTRA_ESIA_STATE);
            }
            String str = this.a;
            if (str != null) {
                if (str.length() > 0) {
    ...
    public boolean hasToken() {
        return EsiaSignInManager.DefaultImpls.hasToken(this);
    }
    ...
    public void login(@NotNull Activity activity, @Nullable Function1<? super SignInManager.Result, Unit> function1) {
        ...
        try {
            activity.startActivityForResult(IntentsKt.makeSafeForExternalApps(EsiaAuthActivity.Companion.launchIntent(activity)), 709);
        } catch (Exception e) {
            Logs.error("ESIA_SIGN_IN_MANAGER", "esia login exception", e);
        }
    }
