...
public final class MyDraftAdvertDetailsInteractorImpl$loadDraftAdvert$2$$special$$inlined$toTyped$1<T, R> implements Function<TypedResult<T>, SingleSource<? extends T>> {
    public static final MyDraftAdvertDetailsInteractorImpl$loadDraftAdvert$2$$special$$inlined$toTyped$1 INSTANCE = new MyDraftAdvertDetailsInteractorImpl$loadDraftAdvert$2$$special$$inlined$toTyped$1();
