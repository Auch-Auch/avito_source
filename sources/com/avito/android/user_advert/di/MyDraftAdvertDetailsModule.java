...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\bÇ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/avito/android/user_advert/di/MyDraftAdvertDetailsModule;", "", "<init>", "()V", "user-advert_release"}, k = 1, mv = {1, 4, 2})
@Module(includes = {BaseAdvertDetailsModule.class, ClipboardModule.class, DialogRouterModule.class, DateTimeFormatterModule.class, ShareModule.class, AdvertAnalyticsModule.class, MyAdvertDetailsTrackerModule.class, DetailsPresentationModule.class, AppRaterModule.class, SafetyInfoModule.class, CharityModule.class, LimitsInfoModule.class})
public final class MyDraftAdvertDetailsModule {
    @NotNull
    public static final MyDraftAdvertDetailsModule INSTANCE = new MyDraftAdvertDetailsModule();
}
