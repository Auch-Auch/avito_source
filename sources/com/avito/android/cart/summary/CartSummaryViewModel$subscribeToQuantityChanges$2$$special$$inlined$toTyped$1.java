...
public final class CartSummaryViewModel$subscribeToQuantityChanges$2$$special$$inlined$toTyped$1<T, R> implements Function<TypedResult<T>, SingleSource<? extends T>> {
    public static final CartSummaryViewModel$subscribeToQuantityChanges$2$$special$$inlined$toTyped$1 INSTANCE = new CartSummaryViewModel$subscribeToQuantityChanges$2$$special$$inlined$toTyped$1();
