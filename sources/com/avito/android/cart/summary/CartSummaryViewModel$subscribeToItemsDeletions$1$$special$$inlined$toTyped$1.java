...
public final class CartSummaryViewModel$subscribeToItemsDeletions$1$$special$$inlined$toTyped$1<T, R> implements Function<TypedResult<T>, SingleSource<? extends T>> {
    public static final CartSummaryViewModel$subscribeToItemsDeletions$1$$special$$inlined$toTyped$1 INSTANCE = new CartSummaryViewModel$subscribeToItemsDeletions$1$$special$$inlined$toTyped$1();
