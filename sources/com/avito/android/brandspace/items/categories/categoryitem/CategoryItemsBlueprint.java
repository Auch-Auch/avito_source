...
import com.avito.android.brandspace.di.CategoriesItemBinder;
...
public final class CategoryItemsBlueprint implements ItemBlueprint<CarouselItemView, CarouselItem> {
    ...
    public static final class a extends Lambda implements Function2<ViewGroup, View, CarouselItemViewImpl> {
        public final /* synthetic */ CategoryItemsBlueprint a;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public a(CategoryItemsBlueprint categoryItemsBlueprint) {
            super(2);
            this.a = categoryItemsBlueprint;
        }
    ...
    @Inject
    public CategoryItemsBlueprint(@NotNull CarouselPresenter carouselPresenter, @CategoriesItemBinder @NotNull ItemBinder itemBinder) {
    ...
    public boolean isRelevantItem(@NotNull Item item) {
        ...
        return (item instanceof CarouselItem) && CarouselItemKt.isCategoryItemCarousel((CarouselItem) item);
    }
