...
import com.avito.android.brandspace.di.ImageGalleryItemBinder;
...
public final class ImageGalleryBlueprint implements ItemBlueprint<CarouselItemView, CarouselItem> {
    ...
    public static final class a extends Lambda implements Function2<ViewGroup, View, CarouselItemViewImpl> {
        public final /* synthetic */ ImageGalleryBlueprint a;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public a(ImageGalleryBlueprint imageGalleryBlueprint) {
            super(2);
            this.a = imageGalleryBlueprint;
        }
    ...
    @Inject
    public ImageGalleryBlueprint(@NotNull CarouselPresenter carouselPresenter, @ImageGalleryItemBinder @NotNull ItemBinder itemBinder) {
    ...
    public boolean isRelevantItem(@NotNull Item item) {
        ...
        return (item instanceof CarouselItem) && ImageGalleryItemKt.isImageGalleryCarousel((CarouselItem) item);
    }
