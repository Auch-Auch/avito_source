...
import com.avito.android.brandspace.di.NewsItemBinder;
...
public final class NewsBlueprint implements ItemBlueprint<CarouselItemView, CarouselItem> {
    ...
    public static final class a extends Lambda implements Function2<ViewGroup, View, CarouselItemViewImpl> {
        public final /* synthetic */ NewsBlueprint a;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public a(NewsBlueprint newsBlueprint) {
            super(2);
            this.a = newsBlueprint;
        }
    ...
    @Inject
    public NewsBlueprint(@NotNull CarouselPresenter carouselPresenter, @NewsItemBinder @NotNull ItemBinder itemBinder) {
    ...
    public boolean isRelevantItem(@NotNull Item item) {
        ...
        return (item instanceof CarouselItem) && NewsItemKt.isNewsCarousel((CarouselItem) item);
    }
