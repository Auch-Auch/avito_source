...
public final class SuggestsTrackerModule {
    ...
    public static final ContentTracker provideContentTracker(@NotNull ScreenFlowTrackerProvider screenFlowTrackerProvider) {
        ...
        return new ContentTrackerImpl("suggests", screenFlowTrackerProvider);
    }
    ...
    @IntoSet
    @NotNull
    public static final ContentTracker provideContentTrackerToSet(@Named("suggests") @NotNull ContentTracker contentTracker) {
