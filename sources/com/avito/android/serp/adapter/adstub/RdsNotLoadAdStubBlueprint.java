...
public final class RdsNotLoadAdStubBlueprint implements ItemBlueprint<NotLoadAdStubItemView, SerpCommercialBanner> {
    ...
    @Inject
    public RdsNotLoadAdStubBlueprint(@NotNull NotLoadAdStubPresenter notLoadAdStubPresenter) {
    ...
    public boolean isRelevantItem(@NotNull Item item) {
        ...
        return (item instanceof SerpCommercialBanner) && ((SerpCommercialBanner) item).getHasNotLoadedAd();
    }
