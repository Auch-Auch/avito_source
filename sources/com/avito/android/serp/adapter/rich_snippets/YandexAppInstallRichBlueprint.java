...
public final class YandexAppInstallRichBlueprint implements ItemBlueprint<AdYandexAppInstallViewHolder, YandexAppInstallBannerItem> {
    ...
    public static final class a extends Lambda implements Function2<ViewGroup, View, AdYandexAppInstallViewHolderImpl> {
        ...
        public AdYandexAppInstallViewHolderImpl invoke(ViewGroup viewGroup, View view) {
            ...
            return new AdYandexAppInstallViewHolderImpl(YandexContentRichBlueprintKt.applyYandexBannerRichStyle(view2));
        }
    }

    @Inject
    public YandexAppInstallRichBlueprint(@NotNull YandexAppInstallItemPresenter yandexAppInstallItemPresenter) {
    ...
    public boolean isRelevantItem(@NotNull Item item) {
        ...
        return (item instanceof YandexAppInstallBannerItem) && ((YandexAppInstallBannerItem) item).getDisplayType().isInformative();
    }
