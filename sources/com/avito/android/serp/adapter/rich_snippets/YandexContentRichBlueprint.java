...
public final class YandexContentRichBlueprint implements ItemBlueprint<AdYandexContentViewHolder, YandexBannerItem> {
    ...
    public static final class a extends Lambda implements Function2<ViewGroup, View, AdYandexContentViewHolderImpl> {
        ...
        public AdYandexContentViewHolderImpl invoke(ViewGroup viewGroup, View view) {
            ...
            YandexContentRichBlueprintKt.applyYandexBannerRichStyle(view2);
            return new AdYandexContentViewHolderImpl(view2);
        }
    }

    @Inject
    public YandexContentRichBlueprint(@NotNull YandexContentItemPresenter yandexContentItemPresenter) {
    ...
    public boolean isRelevantItem(@NotNull Item item) {
        ...
        return (item instanceof YandexBannerItem) && ((YandexBannerItem) item).getDisplayType().isInformative();
    }
