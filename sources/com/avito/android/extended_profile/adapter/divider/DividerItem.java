...
public final class DividerItem implements ExtendedProfileListItem {
    ...
    public static class Creator implements Parcelable.Creator<DividerItem> {
        ...
        public final DividerItem createFromParcel(@NotNull Parcel parcel) {
            ...
            return new DividerItem(parcel.readString(), (ExtendedProfileSpanLookup.GridItemType) Enum.valueOf(ExtendedProfileSpanLookup.GridItemType.class, parcel.readString()));
        }
    ...
    public DividerItem(@NotNull String str, @NotNull ExtendedProfileSpanLookup.GridItemType gridItemType) {
    ...
    public /* synthetic */ DividerItem(String str, ExtendedProfileSpanLookup.GridItemType gridItemType, int i, j jVar) {
        this((i & 1) != 0 ? "divider_item" : str, (i & 2) != 0 ? ExtendedProfileSpanLookup.GridItemType.FULL_WIDTH : gridItemType);
    }
}
