...
import com.avito.android.analytics.screens.ProfileDeliverySettingsScreen;
...
public final class ProfileDeliverySettingsTrackerModule {
    ...
    public final String providesScreenContentType() {
        return ScreenPublicConstsKt.CONTENT_TYPE_SAFEDEAL_DELIVERY_SETTINGS;
    }
    ...
    public final ScreenDiInjectTracker providesScreenDiInjectTracker$safedeal_release(@NotNull ScreenTrackerFactory screenTrackerFactory, @NotNull TimerFactory timerFactory, @NotNull String str) {
        ...
        return screenTrackerFactory.createDiInjectTracker(ProfileDeliverySettingsScreen.INSTANCE, timerFactory, str);
    }
    ...
    public final ScreenFlowTrackerProvider providesScreenFlowTrackerProvider(@NotNull ScreenTrackerFactory screenTrackerFactory, @NotNull TimerFactory timerFactory) {
        Intrinsics.checkNotNullParameter(screenTrackerFactory, "screenTrackerFactory");
        Intrinsics.checkNotNullParameter(timerFactory, "factory");
        return screenTrackerFactory.createScreenFlowTrackerProvider(ProfileDeliverySettingsScreen.INSTANCE, timerFactory);
    }
    ...
    public final ScreenInitTracker providesScreenInitTracker(@NotNull ScreenTrackerFactory screenTrackerFactory, @NotNull TimerFactory timerFactory, @NotNull String str) {
        ...
        Intrinsics.checkNotNullParameter(timerFactory, "factory");
        Intrinsics.checkNotNullParameter(str, "contentType");
        return screenTrackerFactory.createInitTracker(ProfileDeliverySettingsScreen.INSTANCE, timerFactory, str);
    }
}
