...
import com.avito.android.safedeal.delivery_courier.order_update.konveyor.select.SelectItemView;
...
public final class SelectItemViewHolder extends BaseViewHolder implements SelectItemView {
    ...
    @Override // com.avito.android.safedeal.delivery_courier.order_update.konveyor.select.SelectItemView
    ...
    public void setTextChangeListener(@Nullable Function1<? super String, Unit> function1) {
        if (function1 != null) {
            Input input = this.t;
            input.addTextChangedListener(new TextWatcher(input, function1) { // from class: com.avito.android.safedeal.delivery_courier.order_update.konveyor.select.SelectItemViewHolder$$special$$inlined$addDeformattedTextChangedListener$1
                public String a;
