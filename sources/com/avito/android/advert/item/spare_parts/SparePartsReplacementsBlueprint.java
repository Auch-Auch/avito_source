...
public final class SparePartsReplacementsBlueprint extends SparePartsBlueprint {
    @NotNull
    public final SparePartsPresenter b;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    @Inject
    public SparePartsReplacementsBlueprint(@SparePartsModule.ReplacementsPresenter @NotNull SparePartsPresenter sparePartsPresenter) {
        super(null);
    ...
    public boolean isRelevantItem(@NotNull Item item) {
        ...
        return (item instanceof SparePartsItem) && ((SparePartsItem) item).getType() == SparePartsItemType.REPLACEMENTS;
    }
