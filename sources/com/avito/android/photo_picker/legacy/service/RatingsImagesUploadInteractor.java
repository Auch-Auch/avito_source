...
public final class RatingsImagesUploadInteractor implements UploadInteractor {
    ...
    public RatingsImagesUploadInteractor(@NotNull PickerApi pickerApi) {
    ...
    public Single<String> uploadFile(@NotNull File file) {
        ...
        Single<String> map = InteropKt.toV2(this.a.uploadRatingImage(FileUtils.convertToImageMultipart$default(file, null, null, 3, null))).flatMap(a.a).map(b.a);
