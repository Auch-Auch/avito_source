...
public enum AdvertDetailsIcebreakerStyleTestGroup implements RemoteNamingGroup {
    ...
    AdvertDetailsIcebreakerStyleTestGroup(String str) {
        this.a = str;
    }
