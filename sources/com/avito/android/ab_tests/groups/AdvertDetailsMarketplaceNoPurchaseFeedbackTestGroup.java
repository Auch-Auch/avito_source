...
public enum AdvertDetailsMarketplaceNoPurchaseFeedbackTestGroup implements RemoteNamingGroup {
    ...
    AdvertDetailsMarketplaceNoPurchaseFeedbackTestGroup(String str) {
        this.a = str;
    }
