...
public enum AdvertDetailsNoCallFeedbackTestGroup implements RemoteNamingGroup {
    ...
    AdvertDetailsNoCallFeedbackTestGroup(String str) {
        this.a = str;
    }
