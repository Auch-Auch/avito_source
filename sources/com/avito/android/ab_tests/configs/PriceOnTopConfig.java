...
public final class PriceOnTopConfig extends AbTestWithClientExposureConfig<PriceOnTopTestGroup> {
    ...
    @Override // com.avito.android.ab_tests.models.AbTestWithClientExposureConfig
    @Nullable
    public PriceOnTopTestGroup getDebugOverrideDefaultGroup(@NotNull Features features) {
        Intrinsics.checkNotNullParameter(features, "features");
        if (features.getPriceOnTop().invoke().booleanValue()) {
            return PriceOnTopTestGroup.TEST;
        }
        return null;
    }
    ...
    @Override // com.avito.android.ab_tests.models.AbTestWithClientExposureConfig
    @NotNull
    public PriceOnTopTestGroup[] getGroups() {
        return PriceOnTopTestGroup.values();
    }

    @Override // com.avito.android.ab_tests.models.AbTestWithClientExposureConfig
    @NotNull
    public PriceOnTopTestGroup getReleaseDefaultGroup() {
        return PriceOnTopTestGroup.NONE;
    }
}
