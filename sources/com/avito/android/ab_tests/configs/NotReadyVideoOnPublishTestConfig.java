...
public final class NotReadyVideoOnPublishTestConfig extends AbTestWithClientExposureConfig<SimpleTestGroup> {
    ...
    public boolean isTestEnabled(@NotNull Features features) {
        ...
        return features.getVideoNotReadyOnPublish().invoke().booleanValue();
    }
