...
public final class DraftsOnStartPublishSheetTestConfig extends AbTestWithClientExposureConfig<SimpleTestGroup> {
    ...
    public boolean isTestEnabled(@NotNull Features features) {
        ...
        return features.getDraftsOnStartPublishSheet().invoke().booleanValue();
    }
