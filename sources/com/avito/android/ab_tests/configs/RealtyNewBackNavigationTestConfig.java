...
public final class RealtyNewBackNavigationTestConfig extends AbTestWithClientExposureConfig<SimpleTestGroupWithNone> {
    ...
    public boolean isTestEnabled(@NotNull Features features) {
        ...
        return features.getNewMapBackNavigation().invoke().booleanValue();
    }
