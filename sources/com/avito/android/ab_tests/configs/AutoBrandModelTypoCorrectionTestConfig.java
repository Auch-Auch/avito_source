...
public final class AutoBrandModelTypoCorrectionTestConfig extends AbTestWithClientExposureConfig<AutoBrandModelTypoCorrectionTestGroup> {
    ...
    public boolean isTestEnabled(@NotNull Features features) {
        ...
        return features.getAutoBrandModelSuggests().invoke().booleanValue();
    }

    @Override // com.avito.android.ab_tests.models.AbTestWithClientExposureConfig
    @Nullable
    public AutoBrandModelTypoCorrectionTestGroup getDebugOverrideDefaultGroup(@NotNull Features features) {
        Intrinsics.checkNotNullParameter(features, "features");
        return (AutoBrandModelTypoCorrectionTestGroup) getGroupByString(features.getAutoBrandModelSuggestsScenario().getValue().getSelectedOption());
    }

    @Override // com.avito.android.ab_tests.models.AbTestWithClientExposureConfig
    @NotNull
    public AutoBrandModelTypoCorrectionTestGroup[] getGroups() {
        return AutoBrandModelTypoCorrectionTestGroup.values();
    }

    @Override // com.avito.android.ab_tests.models.AbTestWithClientExposureConfig
    @NotNull
    public AutoBrandModelTypoCorrectionTestGroup getReleaseDefaultGroup() {
