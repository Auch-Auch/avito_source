...
public enum TinkoffCreditCalculatorTestGroup implements RemoteNamingGroup {
    ...
    TinkoffCreditCalculatorTestGroup(String str) {
        this.a = str;
    }
