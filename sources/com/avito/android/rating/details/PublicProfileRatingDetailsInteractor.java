...
public final class PublicProfileRatingDetailsInteractor implements RatingDetailsInteractor {
    ...
    public PublicProfileRatingDetailsInteractor(@NotNull RatingApi ratingApi, @NotNull SchedulersFactory3 schedulersFactory3, @NotNull String str) {
    ...
    public Observable<RatingDetailsResult> getItems() {
        Observable<R> flatMap = this.a.getPublicProfileRatingDetails(this.c).subscribeOn(this.b.io()).flatMap(a.a);
        Intrinsics.checkNotNullExpressionValue(flatMap, "api.getPublicProfileRati…it.toTypedObservable3() }");
        return flatMap;
    }
