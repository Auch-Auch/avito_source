...
public final class ShopRatingDetailsResourceProvider implements RatingDetailsResourceProvider {
    ...
    public String getTitle() {
        String string = this.a.getString(R.string.shop_rating_details_title);
        Intrinsics.checkNotNullExpressionValue(string, "resources.getString(R.st…hop_rating_details_title)");
        return string;
    }
}
