...
public final class SelectAdvertTrackerImpl implements SelectAdvertTracker {
    ...
    @Inject
    public SelectAdvertTrackerImpl(@NotNull ScreenDiInjectTracker screenDiInjectTracker, @NotNull ScreenInitTracker screenInitTracker, @NotNull ScreenFlowTrackerProvider screenFlowTrackerProvider) {
    ...
    @Override // com.avito.android.rating.publish.select_advert.tracker.SelectAdvertTracker
    public void startDraw() {
        ContentDrawingTracker contentDrawing = this.e.getContentDrawing("adverts-list");
    ...
    public void startLoading() {
        ContentLoadingTracker contentLoadingFromRemoteStorage = this.e.getContentLoadingFromRemoteStorage("adverts-list");
