...
public final class SafetyInfoProviderImpl$loadSafetyInfo$2$$special$$inlined$toTyped$1<T, R> implements Function<TypedResult<T>, SingleSource<? extends T>> {
    public static final SafetyInfoProviderImpl$loadSafetyInfo$2$$special$$inlined$toTyped$1 INSTANCE = new SafetyInfoProviderImpl$loadSafetyInfo$2$$special$$inlined$toTyped$1();
