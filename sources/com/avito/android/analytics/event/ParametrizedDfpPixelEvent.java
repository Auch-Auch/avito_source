...
public final class ParametrizedDfpPixelEvent implements PixelEvent {
    ...
    public ParametrizedDfpPixelEvent(@NotNull String str, @NotNull String str2, boolean z) {
        Intrinsics.checkNotNullParameter(str, "adSlot");
        Intrinsics.checkNotNullParameter(str2, "event");
        this.c = new ParametrizedPixelAdEvent(ParametrizedDfpPixelEventKt.access$createParams(str, str2, z));
        this.a = str;
        this.b = str2;
    }
