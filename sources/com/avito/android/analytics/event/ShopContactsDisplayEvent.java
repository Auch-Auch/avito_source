...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u000b\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u000e\u001a\u00020\t\u0012\u0006\u0010\u0011\u001a\u00020\t¢\u0006\u0004\b\u0012\u0010\u0013J\u001f\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0016¢\u0006\u0004\b\u0007\u0010\bR\u0019\u0010\u000e\u001a\u00020\t8\u0006@\u0006¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\rR\u0019\u0010\u0011\u001a\u00020\t8\u0006@\u0006¢\u0006\f\n\u0004\b\u000f\u0010\u000b\u001a\u0004\b\u0010\u0010\r¨\u0006\u0014"}, d2 = {"Lcom/avito/android/analytics/event/ShopContactsDisplayEvent;", "Lcom/avito/android/analytics/provider/api/ApiEvent;", "Lcom/avito/android/analytics/provider/api/ApiEventTracker;", "tracker", "Lcom/avito/android/analytics/remote/AnalyticsApi;", "api", "", "accept", "(Lcom/avito/android/analytics/provider/api/ApiEventTracker;Lcom/avito/android/analytics/remote/AnalyticsApi;)V", "", AuthSource.SEND_ABUSE, "Ljava/lang/String;", "getUserKey", "()Ljava/lang/String;", "userKey", AuthSource.BOOKING_ORDER, "getSource", "source", "<init>", "(Ljava/lang/String;Ljava/lang/String;)V", "analytics_release"}, k = 1, mv = {1, 4, 2})
public final class ShopContactsDisplayEvent implements ApiEvent {
    @NotNull
    ...
    public ShopContactsDisplayEvent(@NotNull String str, @NotNull String str2) {
    ...
    public void accept(@NotNull ApiEventTracker apiEventTracker, @NotNull AnalyticsApi analyticsApi) {
        ...
        Observable<Unit> map = InteropKt.toV2(analyticsApi.shopContactsShowed(this.a, this.b)).map(a.a);
        Intrinsics.checkNotNullExpressionValue(map, "api.shopContactsShowed(u…            .map { Unit }");
