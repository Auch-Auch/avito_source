...
public final class YandexPassbackEvent implements PixelEvent {
    ...
    public YandexPassbackEvent(@NotNull String str, @NotNull String str2, boolean z) {
        Intrinsics.checkNotNullParameter(str, "id");
        Intrinsics.checkNotNullParameter(str2, "statId");
        this.c = new ParametrizedYandexPixelEvent(str, str2, "p", z);
        this.a = str;
        this.b = str2;
    }
