...
public final class UserProfileTrackerImpl implements UserProfileTracker {
    ...
    @Inject
    public UserProfileTrackerImpl(@NotNull ScreenDiInjectTracker screenDiInjectTracker, @NotNull ScreenInitTracker screenInitTracker, @NotNull ScreenFlowTrackerProvider screenFlowTrackerProvider) {
    ...
    @Override // com.avito.android.analytics.screen.UserProfileTracker
    ...
    public void startProfileDraw() {
        ContentDrawingTracker contentDrawing = this.e.getContentDrawing("profile");
    ...
    public void startProfileLoading() {
        ContentLoadingTracker contentLoadingFromRemoteStorage = this.e.getContentLoadingFromRemoteStorage("profile");
