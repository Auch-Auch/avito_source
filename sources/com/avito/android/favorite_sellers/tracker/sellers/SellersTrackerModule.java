...
public final class SellersTrackerModule {
    ...
    @IntoSet
    @NotNull
    public static final ContentTracker provideContentTrackerToSet(@Named("sellers") @NotNull ContentTracker contentTracker) {
