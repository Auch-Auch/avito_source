...
public final class RecommendationItemModule {
    ...
    public interface Declarations {
        ...
        @IntoSet
        @NotNull
        ItemBlueprint<?, ?> bindBlueprint(@NotNull RecommendationItemBlueprint recommendationItemBlueprint);
