...
public final class VariantItemRadioButtonBlueprintImpl implements VariantItemRadioButtonBlueprint {
    ...
    public static final class a extends Lambda implements Function2<ViewGroup, View, BaseViewHolder> {
        ...
        public BaseViewHolder invoke(ViewGroup viewGroup, View view) {
            ...
            return new VariantItemRadioButtonView(view2);
        }
    }

    @Inject
    public VariantItemRadioButtonBlueprintImpl(@NotNull VariantItemPresenter variantItemPresenter) {
