...
public final class ChannelFragment$bindChannelMenuView$$inlined$observeNotNull$6<T> implements Observer<T> {
    public final /* synthetic */ ChannelFragment a;

    public ChannelFragment$bindChannelMenuView$$inlined$observeNotNull$6(ChannelFragment channelFragment) {
    ...
    public final void onChanged(T t) {
        if (t != null) {
            ...
            this.a.getSendMessagePresenter().onDraftDeletionFromOutside();
