...
public final class ChannelFragment$bindChannelMenuView$$inlined$observeNotNull$9<T> implements Observer<T> {
    public final /* synthetic */ ChannelFragment a;

    public ChannelFragment$bindChannelMenuView$$inlined$observeNotNull$9(ChannelFragment channelFragment) {
    ...
    public final void onChanged(T t) {
        if (t != null) {
            this.a.onCallSellerConfirmed(t);
        }
    }
}
