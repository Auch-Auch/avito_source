...
public final class MessageListPresenterImpl$subscribeToMessageUpdates$1<T, R> implements Function<MessageListInteractor.State.FirstPageLoaded, Observable<List<? extends Pair<? extends LocalMessage, ? extends MessageMetaInfo>>>> {
    public static final MessageListPresenterImpl$subscribeToMessageUpdates$1 INSTANCE = new MessageListPresenterImpl$subscribeToMessageUpdates$1();
    ...
    public final Observable<List<Pair<LocalMessage, MessageMetaInfo>>> apply(@NotNull MessageListInteractor.State.FirstPageLoaded firstPageLoaded) {
        ...
        return firstPageLoaded.getFirstPageMessagesAndMetaInfoObservable();
    }
}
