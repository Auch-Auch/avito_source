...
public final class MessageRepoImpl$trackError$1<T, R> implements Function<Observable<Throwable>, ObservableSource<?>> {
    public final /* synthetic */ MessageRepoImpl a;
    public final /* synthetic */ String b;
    public final /* synthetic */ Map c;

    public MessageRepoImpl$trackError$1(MessageRepoImpl messageRepoImpl, String str, Map map) {
    ...
    public final ObservableSource<?> apply(@NotNull Observable<Throwable> observable) {
        ...
        return this.a.e.handleErrors(observable, this.b, this.c);
    }
}
