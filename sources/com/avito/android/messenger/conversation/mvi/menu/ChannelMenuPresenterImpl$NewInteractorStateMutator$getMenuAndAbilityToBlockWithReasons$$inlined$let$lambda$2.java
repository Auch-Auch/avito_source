...
public final class ChannelMenuPresenterImpl$NewInteractorStateMutator$getMenuAndAbilityToBlockWithReasons$$inlined$let$lambda$2 extends Lambda implements Function0<Unit> {
    ...
    public ChannelMenuPresenterImpl$NewInteractorStateMutator$getMenuAndAbilityToBlockWithReasons$$inlined$let$lambda$2(ChannelMenuAction channelMenuAction, ChannelMenuPresenterImpl channelMenuPresenterImpl, int i, List list, List list2) {
        super(0);
