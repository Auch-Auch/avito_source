...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\b\n\u0002\u0010\u0002\n\u0002\b\u0004\u0010\u0004\u001a\u00020\u0000H\n¢\u0006\u0004\b\u0001\u0010\u0002¨\u0006\u0003"}, d2 = {"", "invoke", "()V", "com/avito/android/messenger/conversation/mvi/menu/ChannelMenuPresenterImpl$getMenuAndAbilityToBlockWithReasons$handlers$1$1", "<anonymous>"}, k = 3, mv = {1, 4, 2})
public final class ChannelMenuPresenterImpl$NewInteractorStateMutator$getMenuAndAbilityToBlockWithReasons$$inlined$map$lambda$3 extends Lambda implements Function0<Unit> {
    public final /* synthetic */ ChannelMenuAction a;
    public final /* synthetic */ ChannelMenuPresenterImpl b;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ChannelMenuPresenterImpl$NewInteractorStateMutator$getMenuAndAbilityToBlockWithReasons$$inlined$map$lambda$3(ChannelMenuAction channelMenuAction, ChannelMenuPresenterImpl channelMenuPresenterImpl) {
        super(0);
