...
public final class ChannelMenuPresenterImpl$NewInteractorStateMutator$getMenuAndAbilityToBlockWithReasons$$inlined$map$lambda$1 extends Lambda implements Function0<Unit> {
    public final /* synthetic */ ChannelMenuAction a;
    public final /* synthetic */ ChannelMenuPresenterImpl b;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ChannelMenuPresenterImpl$NewInteractorStateMutator$getMenuAndAbilityToBlockWithReasons$$inlined$map$lambda$1(ChannelMenuAction channelMenuAction, ChannelMenuPresenterImpl channelMenuPresenterImpl) {
        super(0);
