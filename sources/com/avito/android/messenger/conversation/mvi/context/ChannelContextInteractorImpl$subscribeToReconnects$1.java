...
public final class ChannelContextInteractorImpl$subscribeToReconnects$1<T> implements Consumer<Boolean> {
    public final /* synthetic */ ChannelContextInteractorImpl a;

    public ChannelContextInteractorImpl$subscribeToReconnects$1(ChannelContextInteractorImpl channelContextInteractorImpl) {
    ...
    public final void accept(Boolean bool) {
        ...
        reducerQueue.plusAssign(new ChannelContextInteractorImpl.OnReconnectAction(bool.booleanValue()));
    }
}
