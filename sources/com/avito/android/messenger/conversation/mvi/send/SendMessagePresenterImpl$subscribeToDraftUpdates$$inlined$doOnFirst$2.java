...
public final class SendMessagePresenterImpl$subscribeToDraftUpdates$$inlined$doOnFirst$2<T, R> implements Function<Observable<T>, ObservableSource<T>> {
    public final /* synthetic */ SendMessagePresenterImpl a;

    public SendMessagePresenterImpl$subscribeToDraftUpdates$$inlined$doOnFirst$2(SendMessagePresenterImpl sendMessagePresenterImpl) {
    ...
    public final ObservableSource<T> apply(@NotNull Observable<T> observable) {
        ...
        return Observable.merge(observable.skip(1), observable.take(1).doOnNext(new Consumer<T>(this) { // from class: com.avito.android.messenger.conversation.mvi.send.SendMessagePresenterImpl$subscribeToDraftUpdates$$inlined$doOnFirst$2.1
            public final /* synthetic */ SendMessagePresenterImpl$subscribeToDraftUpdates$$inlined$doOnFirst$2 a;
