...
public interface OutgoingFileMessageView extends OutgoingMessageView, FileMessageView {
    ...
    public static final class Impl extends BaseViewHolder implements OutgoingFileMessageView, FileMessageView, MessageViewClicks, MessageViewDate, MessageViewStatus, MessageViewGroupDivider {
        ...
        public Impl(@NotNull View view) {
            ...
            this.s = new FileMessageViewDelegate(findViewById);
