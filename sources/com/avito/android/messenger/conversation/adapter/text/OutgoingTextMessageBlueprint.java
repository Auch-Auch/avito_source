...
import com.avito.android.messenger.conversation.adapter.text.OutgoingTextMessageView;
...
public final class OutgoingTextMessageBlueprint implements ItemBlueprint<OutgoingTextMessageView, ChannelItem.Message> {
    ...
    public static final class a extends Lambda implements Function2<ViewGroup, View, OutgoingTextMessageView.Impl> {
        ...
        public OutgoingTextMessageView.Impl invoke(ViewGroup viewGroup, View view) {
            View view2 = view;
            Intrinsics.checkNotNullParameter(viewGroup, "<anonymous parameter 0>");
            Intrinsics.checkNotNullParameter(view2, "view");
            return new OutgoingTextMessageView.Impl(view2);
        }
    }

    public OutgoingTextMessageBlueprint(@NotNull TextMessagePresenter textMessagePresenter, @NotNull Features features) {
    ...
    @NotNull
    public ViewHolderBuilder.ViewHolderProvider<OutgoingTextMessageView.Impl> getViewHolderProvider() {
        return this.a;
    }
    ...
    public boolean isRelevantItem(@org.jetbrains.annotations.NotNull com.avito.konveyor.blueprint.Item r5) {
        ...
        L_0x0073:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.avito.android.messenger.conversation.adapter.text.OutgoingTextMessageBlueprint.isRelevantItem(com.avito.konveyor.blueprint.Item):boolean");
    }

    /* Return type fixed from 'com.avito.android.messenger.conversation.adapter.text.TextMessagePresenter' to match base method */
    @Override // com.avito.konveyor.blueprint.ItemBlueprint
    @NotNull
    public ItemPresenter<OutgoingTextMessageView, ChannelItem.Message> getPresenter() {
        return this.b;
    }
}
