...
import com.avito.android.messenger.conversation.adapter.platform.from_user.text.IncomingPlatformTextMessageFromUserView;
...
public final class IncomingPlatformTextMessageFromUserBlueprint implements ItemBlueprint<IncomingPlatformTextMessageFromUserView, ChannelItem.Message> {
    ...
    public static final class a extends Lambda implements Function2<ViewGroup, View, IncomingPlatformTextMessageFromUserView.Impl> {
        ...
        public IncomingPlatformTextMessageFromUserView.Impl invoke(ViewGroup viewGroup, View view) {
            View view2 = view;
            Intrinsics.checkNotNullParameter(viewGroup, "<anonymous parameter 0>");
            Intrinsics.checkNotNullParameter(view2, "view");
            return new IncomingPlatformTextMessageFromUserView.Impl(view2);
        }
    }

    public IncomingPlatformTextMessageFromUserBlueprint(@NotNull PlatformTextMessageFromUserPresenter platformTextMessageFromUserPresenter) {
    ...
    @NotNull
    public ViewHolderBuilder.ViewHolderProvider<IncomingPlatformTextMessageFromUserView.Impl> getViewHolderProvider() {
        return this.a;
    }
    ...
    @Override // com.avito.konveyor.blueprint.ItemBlueprint
    @NotNull
    public ItemPresenter<IncomingPlatformTextMessageFromUserView, ChannelItem.Message> getPresenter() {
        return this.b;
    }
}
