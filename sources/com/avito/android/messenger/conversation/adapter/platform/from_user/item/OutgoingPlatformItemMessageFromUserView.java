...
public interface OutgoingPlatformItemMessageFromUserView extends OutgoingMessageView, PlatformItemMessageFromUserView {
    ...
    public static final class Impl extends BaseViewHolder implements OutgoingPlatformItemMessageFromUserView, PlatformItemMessageFromUserView, MessageViewClicks, MessageViewDate, MessageViewStatus, MessageViewGroupDivider {
        ...
        public Impl(@NotNull View view) {
            ...
            this.s = new PlatformItemMessageFromUserViewDelegate(findViewById, R.drawable.bg_messenger_item_message_outgoing);
