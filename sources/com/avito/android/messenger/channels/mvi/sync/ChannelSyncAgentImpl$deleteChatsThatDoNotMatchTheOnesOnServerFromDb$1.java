...
public final class ChannelSyncAgentImpl$deleteChatsThatDoNotMatchTheOnesOnServerFromDb$1<T, R> implements Function<List<? extends String>, CompletableSource> {
    public final /* synthetic */ ChannelSyncAgentImpl a;
    public final /* synthetic */ String b;
    public final /* synthetic */ List c;

    public ChannelSyncAgentImpl$deleteChatsThatDoNotMatchTheOnesOnServerFromDb$1(ChannelSyncAgentImpl channelSyncAgentImpl, String str, List list) {
    ...
    public final CompletableSource apply(@NotNull List<String> list) {
        ...
        String str = this.b;
        List list2 = this.c;
        List<T> sortedWith = CollectionsKt___CollectionsKt.sortedWith(list2, new Comparator<T>() { // from class: com.avito.android.messenger.channels.mvi.sync.ChannelSyncAgentImpl$deleteChatsThatDoNotMatchTheOnesOnServerFromDb$1$deleteChatsThatDoNotMatchTheOnesOnServerFromDb$$inlined$sortedByDescending$1
