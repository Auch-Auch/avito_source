...
public final class ChannelSyncAgentImpl$syncLatestChats$1$syncFullPageOfChatsFromServerWithDb$$inlined$flatMapSingle$1<T, R> implements Function<Unit, SingleSource<? extends T>> {
    ...
    public ChannelSyncAgentImpl$syncLatestChats$1$syncFullPageOfChatsFromServerWithDb$$inlined$flatMapSingle$1(ChannelSyncAgentImpl channelSyncAgentImpl, String str, List list, int i, SortedSet sortedSet, SortedSet sortedSet2) {
