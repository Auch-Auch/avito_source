...
public final class ChannelsFragment$bindChannelsHeader$$inlined$observeNotNull$3<T> implements Observer<T> {
    public final /* synthetic */ ChannelsFragment a;

    public ChannelsFragment$bindChannelsHeader$$inlined$observeNotNull$3(ChannelsFragment channelsFragment) {
    ...
    public final void onChanged(T t) {
        if (t != null) {
            this.a.getRouter().showLoginScreen();
        }
    }
}
