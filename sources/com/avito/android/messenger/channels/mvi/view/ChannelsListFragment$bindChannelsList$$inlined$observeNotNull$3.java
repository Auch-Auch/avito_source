...
public final class ChannelsListFragment$bindChannelsList$$inlined$observeNotNull$3<T> implements Observer<T> {
    public final /* synthetic */ ChannelsListFragment a;

    public ChannelsListFragment$bindChannelsList$$inlined$observeNotNull$3(ChannelsListFragment channelsListFragment) {
    ...
    public final void onChanged(T t) {
        if (t != null) {
            ChannelsListFragment channelsListFragment = this.a;
