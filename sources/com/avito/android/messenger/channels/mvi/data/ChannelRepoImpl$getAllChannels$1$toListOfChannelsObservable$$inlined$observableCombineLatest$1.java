...
public final class ChannelRepoImpl$getAllChannels$1$toListOfChannelsObservable$$inlined$observableCombineLatest$1<T1, T2, T3, R> implements Function3<T1, T2, T3, R> {
    public final /* synthetic */ ChannelRepoImpl a;
    public final /* synthetic */ List b;

    public ChannelRepoImpl$getAllChannels$1$toListOfChannelsObservable$$inlined$observableCombineLatest$1(ChannelRepoImpl channelRepoImpl, List list) {
