...
public final class ChannelsListInteractorImpl$subscribeToChannelsUpdatesFromDb$6<T> implements Consumer<List<? extends Pair<? extends Channel, ? extends DraftEntity>>> {
    public final /* synthetic */ ChannelsListInteractorImpl a;

    public ChannelsListInteractorImpl$subscribeToChannelsUpdatesFromDb$6(ChannelsListInteractorImpl channelsListInteractorImpl) {
    ...
    public final void accept(List<Pair<Channel, DraftEntity>> list) {
        ...
        reducerQueue.plusAssign(new ChannelsListInteractorImpl.NewPinnedChannelsAndDraftsFromDbMutator(channelsListInteractorImpl, list));
    }
}
