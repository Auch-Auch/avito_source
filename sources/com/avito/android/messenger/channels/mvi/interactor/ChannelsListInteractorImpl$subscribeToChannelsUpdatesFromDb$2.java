...
public final class ChannelsListInteractorImpl$subscribeToChannelsUpdatesFromDb$2<T, R> implements Function<Pair<? extends String, ? extends Long>, ObservableSource<? extends List<? extends Pair<? extends Channel, ? extends DraftEntity>>>> {
    public final /* synthetic */ ChannelsListInteractorImpl a;

    public ChannelsListInteractorImpl$subscribeToChannelsUpdatesFromDb$2(ChannelsListInteractorImpl channelsListInteractorImpl) {
    ...
    public final ObservableSource<? extends List<Pair<Channel, DraftEntity>>> apply(@NotNull Pair<String, Long> pair) {
        ...
        if (this.a.u.getMessengerPinSupportChat().invoke().booleanValue()) {
            return this.a.y.getChannelsAndDraftsStartingFromTimestamp(component1, component2.longValue(), (SortedSet) this.a.H.getFirst(), (SortedSet) this.a.H.getSecond());
        }
        return this.a.y.getChannelsAndDraftsStartingFromTimestamp(component1, component2.longValue(), (SortedSet) this.a.J.getFirst(), (SortedSet) this.a.J.getSecond());
    }
}
