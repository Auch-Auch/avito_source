...
public final class ChannelsListInteractorImpl$subscribeToChannelsUpdatesFromDb$1<T, R> implements Function<ChannelsListInteractor.State, Pair<? extends String, ? extends Long>> {
    public static final ChannelsListInteractorImpl$subscribeToChannelsUpdatesFromDb$1 INSTANCE = new ChannelsListInteractorImpl$subscribeToChannelsUpdatesFromDb$1();

    public final Pair<String, Long> apply(@NotNull ChannelsListInteractor.State state) {
        Intrinsics.checkNotNullParameter(state, "state");
        return TuplesKt.to(state.getUserId(), state.getMainListBottomTimestamp());
    }
}
