...
public final class UserLastActivitySyncAgentImpl$getUsersLastActivityInSingleRequest$1<T, R> implements Function<Throwable, List<? extends UserLastActivity>> {
    public final /* synthetic */ UserLastActivitySyncAgentImpl a;
    public final /* synthetic */ Collection b;

    public UserLastActivitySyncAgentImpl$getUsersLastActivityInSingleRequest$1(UserLastActivitySyncAgentImpl userLastActivitySyncAgentImpl, Collection collection) {
    ...
    public final List<UserLastActivity> apply(@NotNull Throwable th) {
        ...
        StringBuilder L = a.L("getUsersLastActivityInSingleRequest(userIds = ");
        L.append(this.b);
        L.append(") error!");
