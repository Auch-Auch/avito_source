...
public final class BlacklistInteractorImpl$subscribeToReconnects$1<T> implements Consumer<Boolean> {
    public final /* synthetic */ BlacklistInteractorImpl a;

    public BlacklistInteractorImpl$subscribeToReconnects$1(BlacklistInteractorImpl blacklistInteractorImpl) {
        this.a = blacklistInteractorImpl;
    }

    public final void accept(Boolean bool) {
        ReducerQueue reducerQueue = this.a.getReducerQueue();
        BlacklistInteractorImpl blacklistInteractorImpl = this.a;
        Intrinsics.checkNotNullExpressionValue(bool, "notificationQueueWasRestored");
        reducerQueue.plusAssign(new BlacklistInteractorImpl.OnReconnectAction(bool.booleanValue()));
    }
}
