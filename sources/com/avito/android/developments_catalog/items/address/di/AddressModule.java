package com.avito.android.developments_catalog.items.address.di;
...
import com.avito.android.developments_catalog.items.address.AddressPresenterImpl;
...
public interface AddressModule {
    ...
    @PerFragment
    ItemBlueprint<?, ?> bindAddressBlueprint(@NotNull AddressBlueprint addressBlueprint);

    @PerFragment
    @Binds
    @NotNull
    AddressPresenter bindAddressPresenter(@NotNull AddressPresenterImpl addressPresenterImpl);
}
