...
@Metadata(bv = {1, 0, 3}, d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\b\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\u0011\b\u0007\u0012\u0006\u0010\u000e\u001a\u00020\t¢\u0006\u0004\b\u0016\u0010\u0017J\u0017\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0016¢\u0006\u0004\b\u0007\u0010\bR\u001c\u0010\u000e\u001a\u00020\t8\u0016@\u0016X\u0004¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\rR\"\u0010\u0015\u001a\b\u0012\u0004\u0012\u00020\u00100\u000f8\u0016@\u0016X\u0004¢\u0006\f\n\u0004\b\u0011\u0010\u0012\u001a\u0004\b\u0013\u0010\u0014¨\u0006\u0018"}, d2 = {"Lcom/avito/android/module/serp/adapter/ad/dfp/DfpUnifiedDoubleBlueprint;", "Lcom/avito/konveyor/blueprint/ItemBlueprint;", "Lcom/avito/android/module/serp/adapter/ad/dfp/DfpUnifiedItemView;", "Lcom/avito/android/serp/adapter/DfpUnifiedBannerItem;", "Lcom/avito/konveyor/blueprint/Item;", "item", "", "isRelevantItem", "(Lcom/avito/konveyor/blueprint/Item;)Z", "Lcom/avito/android/module/serp/adapter/ad/dfp/DfpUnifiedPresenter;", AuthSource.BOOKING_ORDER, "Lcom/avito/android/module/serp/adapter/ad/dfp/DfpUnifiedPresenter;", "getPresenter", "()Lcom/avito/android/module/serp/adapter/ad/dfp/DfpUnifiedPresenter;", "presenter", "Lcom/avito/konveyor/blueprint/ViewHolderBuilder$ViewHolderProvider;", "Lcom/avito/android/module/serp/adapter/ad/dfp/DfpUnifiedItemViewImpl;", AuthSource.SEND_ABUSE, "Lcom/avito/konveyor/blueprint/ViewHolderBuilder$ViewHolderProvider;", "getViewHolderProvider", "()Lcom/avito/konveyor/blueprint/ViewHolderBuilder$ViewHolderProvider;", "viewHolderProvider", "<init>", "(Lcom/avito/android/module/serp/adapter/ad/dfp/DfpUnifiedPresenter;)V", "serp-core_release"}, k = 1, mv = {1, 4, 2})
public final class DfpUnifiedDoubleBlueprint implements ItemBlueprint<DfpUnifiedItemView, DfpUnifiedBannerItem> {
    @NotNull
    public final ViewHolderBuilder.ViewHolderProvider<DfpUnifiedItemViewImpl> a = new ViewHolderBuilder.ViewHolderProvider<>(R.layout.dfp_unified_double, a.a);
    @NotNull
    ...
    @Inject
    public DfpUnifiedDoubleBlueprint(@NotNull DfpUnifiedPresenter dfpUnifiedPresenter) {
    ...
    public boolean isRelevantItem(@NotNull Item item) {
        ...
        if (item instanceof DfpUnifiedBannerItem) {
            ...
            if (dfpUnifiedBannerItem.getViewType() == SerpViewType.BIG && dfpUnifiedBannerItem.getDisplayType().isGrid()) {
                return true;
            }
        }
        return false;
