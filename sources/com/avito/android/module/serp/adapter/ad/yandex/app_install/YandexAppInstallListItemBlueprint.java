...
public final class YandexAppInstallListItemBlueprint implements ItemBlueprint<AdYandexAppInstallViewHolder, YandexAppInstallBannerItem> {
    ...
    @Inject
    public YandexAppInstallListItemBlueprint(@NotNull YandexAppInstallItemPresenter yandexAppInstallItemPresenter) {
    ...
    public boolean isRelevantItem(@NotNull Item item) {
        ...
        return (item instanceof YandexAppInstallBannerItem) && ((YandexAppInstallBannerItem) item).getDisplayType().isList();
    }
