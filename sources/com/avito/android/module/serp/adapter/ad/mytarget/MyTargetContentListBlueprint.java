...
public final class MyTargetContentListBlueprint implements ItemBlueprint<AdMyTargetViewHolder, MyTargetContentBannerItem> {
    ...
    @Inject
    public MyTargetContentListBlueprint(@NotNull MyTargetContentPresenter myTargetContentPresenter) {
    ...
    public boolean isRelevantItem(@NotNull Item item) {
        ...
        if (item instanceof MyTargetContentBannerItem) {
            ...
            if (myTargetContentBannerItem.getDisplayType().isList() || myTargetContentBannerItem.getDisplayType().isInformative()) {
                return true;
            }
        }
        return false;
