...
public final class CheckableItemViewHolder extends BaseViewHolder implements CheckableItemView {
    ...
    public CheckableItemViewHolder(@NotNull View view) {
        super(view);
        Intrinsics.checkNotNullParameter(view, "view");
        this.s = (CheckmarkListItem) view;
    }

    @Override // com.avito.android.publish.select.blueprints.CheckableItemView
