...
public final class AnonymousNumberSlotFlowTracker implements FlowTracker {
    ...
    public void startDraw() {
        this.a.startAnonymousNumberSlotDraw();
    }

    @Override // com.avito.android.publish.details.analytics.FlowTracker
    public void startPrepare() {
        this.a.startAnonymousNumberSlotPrepare();
    }

    @Override // com.avito.android.publish.details.analytics.FlowTracker
    public void trackDraw() {
        this.a.trackAnonymousNumberSlotDraw();
    }

    @Override // com.avito.android.publish.details.analytics.FlowTracker
    public void trackPrepare() {
        this.a.trackAnonymousNumberSlotPrepare();
    }
}
