...
public final class UpdateFlowTracker implements FlowTracker {
    ...
    public void startDraw() {
        this.a.startUpdateFlowDraw();
    }

    @Override // com.avito.android.publish.details.analytics.FlowTracker
    public void startPrepare() {
        this.a.startUpdateFlowPrepare();
    }

    @Override // com.avito.android.publish.details.analytics.FlowTracker
    public void trackDraw() {
        this.a.trackUpdateFlowDraw();
    }

    @Override // com.avito.android.publish.details.analytics.FlowTracker
    public void trackPrepare() {
        this.a.trackUpdateFlowPrepare();
    }
}
