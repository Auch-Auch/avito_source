...
public final class InformationWithUserIdSlotFlowTracker implements FlowTracker {
    ...
    public void startDraw() {
        this.a.startInformationWithUserIdSlotDraw();
    }

    @Override // com.avito.android.publish.details.analytics.FlowTracker
    public void startPrepare() {
        this.a.startInformationWithUserIdSlotPrepare();
    }

    @Override // com.avito.android.publish.details.analytics.FlowTracker
    public void trackDraw() {
        this.a.trackInformationWithUserIdSlotDraw();
    }

    @Override // com.avito.android.publish.details.analytics.FlowTracker
    public void trackPrepare() {
        this.a.trackInformationWithUserIdSlotPrepare();
    }
}
