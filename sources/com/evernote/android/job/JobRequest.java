        ...
        public JobRequest build() {
            ...
            if (z && this.g > 0) {
                ...
                if (i2 <= 0 && (this.c == -1 || this.d == -1)) {
                    ...
                    if (this.a == -8765) {
                        e g2 = JobManager.instance().g();
                        synchronized (g2) {
                            if (g2.c == null) {
                                g2.c = new AtomicInteger(g2.d());
                            }
                            incrementAndGet = g2.c.incrementAndGet();
                            int jobIdOffset = JobConfig.getJobIdOffset();
                            if (incrementAndGet < jobIdOffset || incrementAndGet >= 2147480000) {
                                g2.c.set(jobIdOffset);
                                incrementAndGet = g2.c.incrementAndGet();
                            }
                            g2.a.edit().putInt("JOB_ID_COUNTER_v2", incrementAndGet).apply();
                        }
