...
public final class PersistableBundleCompat {
    ...
    public static com.evernote.android.job.util.support.PersistableBundleCompat fromXml(@androidx.annotation.NonNull java.lang.String r3) {
        /*
            r0 = 0
            ...
            java.util.HashMap r3 = androidx.appcompat.app.AppCompatDelegateImpl.i.K1(r1)     // Catch:{ XmlPullParserException -> 0x0021, IOException -> 0x001f, VerifyError -> 0x001c, all -> 0x0019 }
            com.evernote.android.job.util.support.PersistableBundleCompat r0 = new com.evernote.android.job.util.support.PersistableBundleCompat     // Catch:{ XmlPullParserException -> 0x0021, IOException -> 0x001f, VerifyError -> 0x001c, all -> 0x0019 }
        ...
        L_0x0026:
            r3 = move-exception
        L_0x0027:
            com.evernote.android.job.util.JobCat r1 = com.evernote.android.job.util.support.PersistableBundleCompat.b     // Catch:{ all -> 0x0024 }
            r1.e(r3)     // Catch:{ all -> 0x0024 }
            com.evernote.android.job.util.support.PersistableBundleCompat r3 = new com.evernote.android.job.util.support.PersistableBundleCompat     // Catch:{ all -> 0x0024 }
        ...
        L_0x0039:
            r3 = move-exception
        L_0x003a:
            com.evernote.android.job.util.JobCat r1 = com.evernote.android.job.util.support.PersistableBundleCompat.b
            r1.e(r3)
            com.evernote.android.job.util.support.PersistableBundleCompat r3 = new com.evernote.android.job.util.support.PersistableBundleCompat
            r3.<init>()
    ...
    public String saveToXml() {
        ...
        try {
            AppCompatDelegateImpl.i.s2(this.a, byteArrayOutputStream);
