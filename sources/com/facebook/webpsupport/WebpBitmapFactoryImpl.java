...
public class WebpBitmapFactoryImpl implements WebpBitmapFactory {
    ...
    public static WebpBitmapFactory.WebpErrorLogger a;
    ...
    public static void b(String str) {
        WebpBitmapFactory.WebpErrorLogger webpErrorLogger = a;
        if (webpErrorLogger != null) {
            webpErrorLogger.onWebpErrorLog(str, "decoding_failure");
        }
    }

    public static void c(Bitmap bitmap, BitmapFactory.Options options) {
    ...
    private static Bitmap createBitmap(int i, int i2, BitmapFactory.Options options) {
        ...
        if (!IN_BITMAP_SUPPORTED || options == null || (bitmap = options.inBitmap) == null || !bitmap.isMutable()) {
            return b.createNakedBitmap(i, i2, Bitmap.Config.ARGB_8888);
        }
    ...
    public static Bitmap hookDecodeFileDescriptor(FileDescriptor fileDescriptor, Rect rect, BitmapFactory.Options options) {
        ...
        if (nativeSeek != -1) {
            ...
            try {
                byte[] a3 = a(fileInputStream, options);
                if (!WebpSupportStatus.sIsWebpSupportRequired || !WebpSupportStatus.isWebpHeader(a3, 0, 20)) {
    ...
    public static android.graphics.Bitmap hookDecodeResource(android.content.res.Resources r2, int r3, android.graphics.BitmapFactory.Options r4) {
        ...
        L_0x0022:
        L_0x0023:
            boolean r2 = com.facebook.webpsupport.WebpBitmapFactoryImpl.IN_BITMAP_SUPPORTED
    ...
    public static Bitmap hookDecodeStream(InputStream inputStream, Rect rect, BitmapFactory.Options options) {
        ...
        byte[] a3 = a(inputStream, options);
        if (!WebpSupportStatus.sIsWebpSupportRequired || !WebpSupportStatus.isWebpHeader(a3, 0, 20)) {
            bitmap = originalDecodeStream(inputStream, rect, options);
            if (bitmap == null) {
