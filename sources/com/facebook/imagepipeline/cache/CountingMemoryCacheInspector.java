...
public class CountingMemoryCacheInspector<K, V> {
    public final CountingMemoryCache<K, V> a;
    ...
    public DumpInfo dumpCacheContent() {
        DumpInfo dumpInfo;
        synchronized (this.a) {
            dumpInfo = new DumpInfo(this.a.getSizeInBytes(), this.a.getEvictionQueueSizeInBytes(), this.a.mMemoryCacheParams);
            for (Map.Entry<K, CountingMemoryCache.b<K, V>> entry : this.a.c.getMatchingEntries(null)) {
                CountingMemoryCache.b<K, V> value = entry.getValue();
            ...
            for (Map.Entry<Bitmap, Object> entry2 : this.a.d.entrySet()) {
