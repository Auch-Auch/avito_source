...
public abstract class GamingMediaUploader {
    public static void uploadToGamingServices(String str, Bitmap bitmap, Bundle bundle, GraphRequest.Callback callback) {
        GraphRequest.newUploadPhotoRequest(AccessToken.getCurrentAccessToken(), ShareInternalUtility.MY_PHOTOS, bitmap, str, bundle, callback).executeAsync();
    }
    ...
    public static void uploadToGamingServices(String str, File file, Bundle bundle, GraphRequest.Callback callback) throws FileNotFoundException {
        GraphRequest.newUploadPhotoRequest(AccessToken.getCurrentAccessToken(), ShareInternalUtility.MY_PHOTOS, file, str, bundle, callback).executeAsync();
    }
    ...
    public static void uploadToGamingServices(String str, Uri uri, Bundle bundle, GraphRequest.Callback callback) throws FileNotFoundException {
        ...
        if (Utility.isFileUri(uri) || Utility.isContentUri(uri)) {
            GraphRequest.newUploadPhotoRequest(currentAccessToken, ShareInternalUtility.MY_PHOTOS, uri, str, bundle, callback).executeAsync();
            return;
        }
        ...
        new GraphRequest(currentAccessToken, ShareInternalUtility.MY_PHOTOS, bundle2, HttpMethod.POST, callback).executeAsync();
    }
}
