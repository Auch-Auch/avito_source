...
public class MonitorLoggingStore implements LoggingStore {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:10:0x0022 A[ExcHandler: all (th java.lang.Throwable), PHI: r2 
      PHI: (r2v3 java.io.ObjectOutputStream) = (r2v0 java.io.ObjectOutputStream), (r2v2 java.io.ObjectOutputStream), (r2v2 java.io.ObjectOutputStream), (r2v0 java.io.ObjectOutputStream) binds: [B:1:0x0007, B:11:0x0024, B:13:?, B:2:?] A[DONT_GENERATE, DONT_INLINE], Splitter:B:1:0x0007] */
    @Override // com.facebook.internal.logging.LoggingStore
