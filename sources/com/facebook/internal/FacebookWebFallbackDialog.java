...
public class FacebookWebFallbackDialog extends WebDialog {
    public static final String p = FacebookWebFallbackDialog.class.getName();
    public boolean o;
    ...
    public Bundle parseResponseUri(String str) {
        ...
        if (!Utility.isNullOrEmpty(string)) {
            try {
                ...
                Utility.logd(p, "Unable to parse bridge_args JSON", e);
            }
        }
        ...
        if (!Utility.isNullOrEmpty(string2)) {
            ...
            try {
                ...
                Utility.logd(p, "Unable to parse bridge_args JSON", e2);
            }
        }
