...
public class SwapDrawer extends a {
    ...
    public void draw(@androidx.annotation.NonNull android.graphics.Canvas r9, @androidx.annotation.NonNull com.rd.animation.data.Value r10, int r11, int r12, int r13) {
        ...
        L_0x0005:
            ...
            com.rd.draw.data.Indicator r0 = r8.b
            int r0 = r0.getSelectedColor()
            com.rd.draw.data.Indicator r1 = r8.b
            int r1 = r1.getUnselectedColor()
            com.rd.draw.data.Indicator r2 = r8.b
            int r2 = r2.getRadius()
            com.rd.draw.data.Indicator r3 = r8.b
            int r3 = r3.getSelectedPosition()
            com.rd.draw.data.Indicator r4 = r8.b
            int r4 = r4.getSelectingPosition()
            com.rd.draw.data.Indicator r5 = r8.b
            int r5 = r5.getLastSelectedPosition()
            int r6 = r10.getCoordinate()
            com.rd.draw.data.Indicator r7 = r8.b
        ...
        L_0x0052:
            r0 = r1
        L_0x0053:
            android.graphics.Paint r10 = r8.a
            r10.setColor(r0)
            com.rd.draw.data.Indicator r10 = r8.b
            ...
            float r11 = (float) r13
            float r12 = (float) r2
            android.graphics.Paint r13 = r8.a
