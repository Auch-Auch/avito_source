...
public final class AdapterViewItemClickEvent {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: com.jakewharton.rxbinding3.widget.AdapterViewItemClickEvent */
    ...
    public boolean equals(@Nullable Object obj) {
        if (this != obj) {
            if (obj instanceof AdapterViewItemClickEvent) {
                ...
                if (Intrinsics.areEqual(this.a, adapterViewItemClickEvent.a) && Intrinsics.areEqual(this.b, adapterViewItemClickEvent.b)) {
