...
public class PreinstallUtil {
    ...
    public static String getPayloadFromSystemProperty(String str, ILogger iLogger) {
        return readSystemProperty(a.c3(Constants.ADJUST_PREINSTALL_SYSTEM_PROPERTY_PREFIX, str), iLogger);
    }
    ...
    public static String getPayloadFromSystemPropertyReflection(String str, ILogger iLogger) {
        return readSystemPropertyReflection(a.c3(Constants.ADJUST_PREINSTALL_SYSTEM_PROPERTY_PREFIX, str), iLogger);
    }
