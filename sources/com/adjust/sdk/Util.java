...
public class Util {
    ...
    public static String convertToHex(byte[] bArr) {
        return formatString(a.j(a.L("%0"), bArr.length << 1, "x"), new BigInteger(1, bArr));
    }
    ...
    public static void getGoogleAdId(Context context, final OnDeviceIdsRead onDeviceIdsRead) {
        ...
        if (Looper.myLooper() != Looper.getMainLooper()) {
            ...
            logger.debug(a.c3("GoogleAdId read ", googleAdId), new Object[0]);
        ...
        new AsyncTask<Context, Void, String>() { // from class: com.adjust.sdk.Util.5
            public String doInBackground(Context... contextArr) {
                ...
                logger2.debug(a.c3("GoogleAdId read ", googleAdId2), new Object[0]);
                return googleAdId2;
            }
