...
public class SingleThreadFutureScheduler implements FutureScheduler {
    ...
    public SingleThreadFutureScheduler(final String str, boolean z) {
        ScheduledThreadPoolExecutor scheduledThreadPoolExecutor2 = new ScheduledThreadPoolExecutor(1, new ThreadFactoryWrapper(str), new RejectedExecutionHandler() { // from class: com.adjust.sdk.scheduler.SingleThreadFutureScheduler.1
