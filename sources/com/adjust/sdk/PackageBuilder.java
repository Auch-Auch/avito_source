...
public class PackageBuilder {
    ...
    public PackageBuilder(AdjustConfig adjustConfig2, DeviceInfo deviceInfo2, ActivityState activityState, SessionParameters sessionParameters2, long j) {
        this.createdAt = j;
    ...
    private void checkDeviceIds(Map<String, String> map) {
        if (map != null && !map.containsKey("mac_sha1") && !map.containsKey("mac_md5") && !map.containsKey("android_id") && !map.containsKey("gps_adid") && !map.containsKey("oaid") && !map.containsKey("imei") && !map.containsKey("meid") && !map.containsKey(SNSConstants.Preference.KEY_DEVICE_ID) && !map.containsKey("imeis") && !map.containsKey("meids") && !map.containsKey("device_ids")) {
    ...
    private Map<String, String> getAdRevenueParameters(String str, JSONObject jSONObject) {
        ...
        addString(hashMap, Preference.APP_VERSION, this.deviceInfo.appVersion);
        ...
        addString(hashMap, SessionContract.PUSH_TOKEN, this.activityStateCopy.pushToken);
        ...
        addDuration(hashMap, MonitorLogServerProtocol.PARAM_TIME_SPENT, this.activityStateCopy.timeSpent);
