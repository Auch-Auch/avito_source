...
public class ActivityPackage implements Serializable {
    private static final ObjectStreamField[] serialPersistentFields = {new ObjectStreamField(MessageMetaInfo.COLUMN_PATH, String.class), new ObjectStreamField("clientSdk", String.class), new ObjectStreamField(ScreenPublicConstsKt.CONTENT_TYPE_PUBLISH_PARAMETERS_INIT, Map.class), new ObjectStreamField("activityKind", ActivityKind.class), new ObjectStreamField("suffix", String.class), new ObjectStreamField("callbackParameters", Map.class), new ObjectStreamField("partnerParameters", Map.class)};
    ...
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        ...
        this.path = Util.readStringField(readFields, MessageMetaInfo.COLUMN_PATH, null);
        this.clientSdk = Util.readStringField(readFields, "clientSdk", null);
        this.parameters = (Map) Util.readObjectField(readFields, ScreenPublicConstsKt.CONTENT_TYPE_PUBLISH_PARAMETERS_INIT, null);
