...
public class PackageHandler implements IPackageHandler {
    ...
    public void closeFirstPackage(ResponseData responseData, ActivityPackage activityPackage) {
        ...
        AnonymousClass5 r9 = new Runnable() { // from class: com.adjust.sdk.PackageHandler.5
            @Override // java.lang.Runnable
            public void run() {
        ...
        this.logger.verbose("Waiting for %s seconds before retrying the %d time", Util.SecondsDisplayFormat.format(((double) j) / 1000.0d), Integer.valueOf(increaseRetries));
