...
public interface IClient extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IClient {
        private static final String DESCRIPTOR = "com.yandex.runtime.rpc.IClient";
        ...
        public static class Proxy implements IClient {
            ...
            public void handle(byte[] bArr) throws RemoteException {
        ...
        public static IClient asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface == null || !(queryLocalInterface instanceof IClient)) {
                return new Proxy(iBinder);
            }
            return (IClient) queryLocalInterface;
        }
    ...
    void handle(byte[] bArr) throws RemoteException;
}
