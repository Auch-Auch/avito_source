...
public final class CommonNotificationBuilder {
    ...
    private static String getOrCreateChannel(Context context, String str, Bundle bundle) {
        ...
        try {
            ...
            if (notificationManager.getNotificationChannel(FCM_FALLBACK_NOTIFICATION_CHANNEL) == null) {
                notificationManager.createNotificationChannel(new NotificationChannel(FCM_FALLBACK_NOTIFICATION_CHANNEL, context.getString(context.getResources().getIdentifier(FCM_FALLBACK_NOTIFICATION_CHANNEL_LABEL, Types.STRING, context.getPackageName())), 3));
            }
    ...
    private static Uri getSound(String str, NotificationParams notificationParams, Resources resources) {
        ...
        StringBuilder sb = new StringBuilder(String.valueOf(soundResourceName).length() + String.valueOf(str).length() + 24);
    ...
    private static String getTag(NotificationParams notificationParams) {
        ...
        return a.q2(37, "FCM-Notification:", SystemClock.uptimeMillis());
    }
