...
public class TopicsSyncTask implements Runnable {
    ...
    public class ConnectivityChangeReceiver extends BroadcastReceiver {
        ...
        public void registerReceiver() {
            TopicsSyncTask.isLoggable();
            TopicsSyncTask.this.context.registerReceiver(this, new IntentFilter(NetworkChangeReceiver.CONNECTIVITY_ACTION));
        }
    }
    ...
    private static String createPermissionMissingLog(String str) {
        return a.s2(a.q0(str, 142), "Missing Permission: ", str, ". This permission should normally be included by the manifest merger, but may needed to be manually added to your manifest");
    }
