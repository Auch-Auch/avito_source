...
public final class ExpandedProductParsedResult extends ParsedResult {
    ...
    public int hashCode() {
        return ((((((((((((b(this.c) ^ 0) ^ b(this.d)) ^ b(this.e)) ^ b(this.f)) ^ b(this.h)) ^ b(this.i)) ^ b(this.j)) ^ b(this.k)) ^ b(this.l)) ^ b(this.m)) ^ b(this.n)) ^ b(this.o)) ^ b(this.p);
    }
}
