...
public final class MimeTypes {
    ...
    public static boolean allSamplesAreSyncSamples(@Nullable String str, @Nullable String str2) {
        ...
        switch (c) {
            ...
            case '\n':
                return true;
            case 3:
                if (str2 == null || (a3 = a(str2)) == null || (encodingForAudioObjectType = AacUtil.getEncodingForAudioObjectType(a3.b)) == 0 || encodingForAudioObjectType == 16) {
                    return false;
                }
                return true;
            default:
    ...
    public static int getEncoding(String str, @Nullable String str2) {
        ...
        switch (c) {
            ...
            case 2:
                ...
                return AacUtil.getEncodingForAudioObjectType(a3.b);
            case 3:
                return 5;
            case 4:
                return 17;
    ...
    public static String getMediaMimeType(@Nullable String str) {
        ...
        if (lowerInvariant.startsWith("mp4a")) {
            if (lowerInvariant.startsWith("mp4a.") && (a3 = a(lowerInvariant)) != null) {
                str2 = getMimeTypeFromMp4ObjectType(a3.a);
            }
            ...
            for (int i = 0; i < size; i++) {
                a aVar = a.get(i);
                if (lowerInvariant.startsWith(aVar.b)) {
                    return aVar.a;
                }
            }
            return null;
