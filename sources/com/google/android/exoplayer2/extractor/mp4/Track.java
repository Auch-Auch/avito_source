...
public final class Track {
    ...
    public Track copyWithFormat(Format format2) {
        return new Track(this.id, this.type, this.timescale, this.movieTimescale, this.durationUs, format2, this.sampleTransformation, this.a, this.nalUnitLengthFieldLength, this.editListDurations, this.editListMediaTimes);
    }
