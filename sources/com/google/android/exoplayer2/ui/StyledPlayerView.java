...
public class StyledPlayerView extends FrameLayout implements AdsLoader.AdViewProvider {
    ...
    public boolean m;
    @Nullable
    public StyledPlayerControlView.VisibilityListener n;
    public boolean o;
    @Nullable
    public Drawable p;
    public int q;
    ...
    public final class a implements Player.EventListener, TextOutput, VideoListener, View.OnLayoutChangeListener, SingleTapListener, StyledPlayerControlView.VisibilityListener {
        ...
        public void onPlayWhenReadyChanged(boolean z, int i) {
            ...
            if (!styledPlayerView2.d() || !styledPlayerView2.x) {
        ...
        public void onTracksChanged(TrackGroupArray trackGroupArray, TrackSelectionArray trackSelectionArray) {
            Player player = (Player) Assertions.checkNotNull(StyledPlayerView.this.l);
        ...
        public void onVideoSizeChanged(int i, int i2, int i3, float f) {
            ...
            if (view instanceof TextureView) {
                ...
                StyledPlayerView.a((TextureView) styledPlayerView3.d, styledPlayerView3.z);
            }
            StyledPlayerView styledPlayerView4 = StyledPlayerView.this;
            styledPlayerView4.onContentAspectRatioChanged(f2, styledPlayerView4.b, styledPlayerView4.d);
        }
    ...
    public final void e(boolean z2) {
        if ((!d() || !this.x) && n()) {
            boolean z3 = this.i.isFullyVisible() && this.i.getShowTimeoutMs() <= 0;
            boolean g2 = g();
            if (z2 || z3 || g2) {
                h(g2);
            }
    ...
    public final boolean g() {
        ...
        if (!this.w || this.l.getCurrentTimeline().isEmpty() || (playbackState != 1 && playbackState != 4 && ((Player) Assertions.checkNotNull(this.l)).getPlayWhenReady())) {
            return false;
        }
        return true;
    }
    ...
    public void setControllerOnFullScreenModeChangedListener(@Nullable StyledPlayerControlView.OnFullScreenModeChangedListener onFullScreenModeChangedListener) {
        Assertions.checkStateNotNull(this.i);
        this.i.setOnFullScreenModeChangedListener(onFullScreenModeChangedListener);
    }
    ...
    public StyledPlayerView(Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        this.w = z8;
        this.x = z7;
        this.m = z2 && styledPlayerControlView3 != null;
        if (styledPlayerControlView3 != null) {
            styledPlayerControlView3.hideImmediately();
            this.i.addVisibilityListener(aVar);
        }
        k();
    }
}
