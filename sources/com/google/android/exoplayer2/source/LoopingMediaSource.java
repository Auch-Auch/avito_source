...
public final class LoopingMediaSource extends CompositeMediaSource<Void> {
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator, long j2) {
        ...
        MaskingMediaPeriod createPeriod = this.j.createPeriod(copyWithPeriodUid, allocator, j2);
    ...
    public Timeline getInitialTimeline() {
        if (this.k != Integer.MAX_VALUE) {
            return new b(this.j.getTimeline(), this.k);
        }
        return new a(this.j.getTimeline());
    }
    ...
    public void onChildSourceInfoRefreshed(Void r1, MediaSource mediaSource, Timeline timeline) {
        Timeline timeline2;
        if (this.k != Integer.MAX_VALUE) {
            timeline2 = new b(timeline, this.k);
        } else {
