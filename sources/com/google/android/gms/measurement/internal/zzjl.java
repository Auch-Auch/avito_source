...
public final class zzjl implements Runnable {
    ...
    public zzjl(zzis zzis, AtomicReference atomicReference, String str, String str2, String str3, boolean z, zzn zzn) {
        this.zzg = zzis;
        ...
        synchronized (this.zza) {
            try {
                ...
                if (TextUtils.isEmpty(this.zzb)) {
                    this.zza.set(zzer.zza(this.zzc, this.zzd, this.zze, this.zzf));
                } else {
                    this.zza.set(zzer.zza(this.zzb, this.zzc, this.zzd, this.zze));
                }
                this.zzg.zzak();
                this.zza.notify();
