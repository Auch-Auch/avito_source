        ...
        for (String str : bundle.keySet()) {
            ...
            if (obj != null) {
                try {
                    ...
                    jSONObject.put(VKApiConst.VERSION, String.valueOf(obj));
            ...
            if (string != null) {
                try {
                    ...
                    for (int i = 0; i < jSONArray.length(); i++) {
                        ...
                        if (c == 0) {
                            bundle.putString(string2, jSONObject.getString(VKApiConst.VERSION));
                        } else if (c == 1) {
                            bundle.putDouble(string2, Double.parseDouble(jSONObject.getString(VKApiConst.VERSION)));
                        } else if (c != 2) {
                            try {
                            ...
                            bundle.putLong(string2, Long.parseLong(jSONObject.getString(VKApiConst.VERSION)));
                        }
                    }
                    this.zzd = bundle;
