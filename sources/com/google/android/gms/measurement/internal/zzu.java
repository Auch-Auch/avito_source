...
public final class zzu extends zzv {
    ...
    public zzu(zzo zzo, String str, int i, zzbu.zze zze) {
        super(str, i);
        this.zzh = zzo;
        this.zzg = zze;
    }
    ...
    public final boolean zza(Long l, Long l2, zzcc.zzk zzk, boolean z) {
        ...
        if (!z || z3) {
            ...
            this.zzh.zzr().zzx().zza("Property filter result", bool == null ? BuildConfig.ADJUST_DEFAULT_TRACKER : bool);
            if (bool == null) {
                return false;
            }
