...
public final class Plus {
    ...
    public static final class PlusOptions implements Api.ApiOptions.Optional {
        ...
        public static final class Builder {
            public String zzg;
            public final Set<String> zzh = new HashSet();
        ...
        public /* synthetic */ PlusOptions(Builder builder, zzc zzc) {
            this(builder);
        }

        public /* synthetic */ PlusOptions(zzc zzc) {
            this();
        }
    ...
    static {
        ...
        zzc zzc = new zzc();
        CLIENT_BUILDER = zzc;
        API = new Api<>("Plus.API", zzc, clientKey);
    }
