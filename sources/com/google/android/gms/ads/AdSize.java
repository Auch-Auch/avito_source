...
public final class AdSize {
    ...
    public AdSize(int r6, int r7) {
        ...
        L_0x0014:
            r2 = 4
            int r2 = a2.b.a.a.a.q0(r0, r2)
            int r2 = a2.b.a.a.a.q0(r1, r2)
            java.lang.String r3 = "x"
            java.lang.String r4 = "_as"
            java.lang.String r0 = a2.b.a.a.a.t2(r2, r0, r3, r1, r4)
            r5.<init>(r6, r7, r0)
            return
        */
    ...
    public final boolean equals(Object obj) {
        ...
        return this.width == adSize.width && this.height == adSize.height && this.zzacx.equals(adSize.zzacx);
    }
    ...
    public AdSize(int i, int i2, String str) {
        if (i < 0 && i != -1 && i != -3) {
            throw new IllegalArgumentException(a.m2(37, "Invalid width for AdSize: ", i));
        } else if (i2 >= 0 || i2 == -2 || i2 == -4) {
            this.width = i;
            this.height = i2;
            this.zzacx = str;
        } else {
            throw new IllegalArgumentException(a.m2(38, "Invalid height for AdSize: ", i2));
        }
    }
}
