...
public final class LocationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public LocationRequest() {
        this.priority = 102;
        this.zzaw = ConstantsKt.DEFAULT_TIME_TO_MODIFY_MESSAGE_MS;
        this.zzax = GeoPositionModelKt.MIN_GEO_REPORT_TIMEOUT;
        this.zzay = false;
    ...
    private static void zza(long j) {
        if (j < 0) {
            throw new IllegalArgumentException(a.q2(38, "invalid interval: ", j));
        }
    }
    ...
    public final LocationRequest setNumUpdates(int i) {
        ...
        throw new IllegalArgumentException(a.m2(31, "invalid numUpdates: ", i));
    }
    ...
    public final LocationRequest setPriority(int i) {
        ...
        throw new IllegalArgumentException(a.m2(28, "invalid quality: ", i));
    }
    ...
    public final String toString() {
        ...
        if (this.zzaz > 0.0f) {
            ...
            L.append(this.zzaz);
            L.append(AuthSource.OPEN_CHANNEL_LIST);
        }
        long j = this.zzaf;
        if (j != Long.MAX_VALUE) {
            L.append(" expireIn=");
