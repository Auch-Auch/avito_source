...
public class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    public final Api.Client zaa(Looper looper, GoogleApiManager.zaa<O> zaa2) {
        return ((Api.AbstractClientBuilder) Preconditions.checkNotNull(this.zac.zab())).buildClient(this.zaa, looper, createClientSettingsBuilder().build(), (ClientSettings) this.zad, (GoogleApiClient.ConnectionCallbacks) zaa2, (GoogleApiClient.OnConnectionFailedListener) zaa2);
    }
