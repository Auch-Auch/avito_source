...
public final class zzqt<FieldDescriptorType extends zzqv<FieldDescriptorType>> {
    ...
    public final zztc<FieldDescriptorType, Object> zzaxo = zztc.zzbu(16);
    ...
    private final void zzd(Map.Entry<FieldDescriptorType, Object> entry) {
        ...
        if (key.zzoz()) {
            ...
            this.zzaxo.zza((zztc<FieldDescriptorType, Object>) key, (FieldDescriptorType) zza);
            ...
            this.zzaxo.zza((zztc<FieldDescriptorType, Object>) key, (FieldDescriptorType) zzsk);
        } else {
            this.zzaxo.zza((zztc<FieldDescriptorType, Object>) key, (FieldDescriptorType) zzu(value));
        }
    }
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        ...
        for (int i = 0; i < this.zzaxo.zzra(); i++) {
            ...
            zzqt.zza((zzqt) zzbv.getKey(), zzbv.getValue());
        }
        for (Map.Entry<FieldDescriptorType, Object> entry : this.zzaxo.zzrb()) {
            zzqt.zza((zzqt) entry.getKey(), entry.getValue());
        }
    ...
    public static void zza(zzqj zzqj, zzug zzug, int i, Object obj) throws IOException {
        if (zzug == zzug.GROUP) {
            zzsk zzsk = (zzsk) obj;
            zzre.zzf(zzsk);
            zzqj.zzd(i, 3);
    ...
    public static int zza(zzug zzug, int i, Object obj) {
