...
public abstract class zzqj extends zzpr {
    ...
    public static final class zzb extends zza {
        ...
        public final void flush() {
            this.zzawv.position(zzok() + this.zzaww);
        }
    }
    ...
    public static int zzb(int i, zzsk zzsk, zzsz zzsz) {
        return zzb(zzsk, zzsz) + zzbb(i);
    }
    ...
    @Deprecated
    public static int zzc(int i, zzsk zzsk, zzsz zzsz) {
        int zzbb = zzbb(i) << 1;
        zzpl zzpl = (zzpl) zzsk;
        int zzmw = zzpl.zzmw();
        if (zzmw == -1) {
