...
public final class zztb {
    ...
    public static int zzd(int i, List<zzps> list) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
    ...
    public static <T> void zza(zzsf zzsf, T t, T t2, long j) {
        zztx.zza(t, j, zzsf.zzc(zztx.zzp(t, j), zztx.zzp(t2, j)));
    }

    public static int zzd(int i, List<zzsk> list, zzsz zzsz) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
    ...
    public static <T, FT extends zzqv<FT>> void zza(zzqq<FT> zzqq, T t, T t2) {
    ...
    public static <T, UT, UB> void zza(zztr<UT, UB> zztr, T t, T t2) {
        zztr.zzf(t, zztr.zzh(zztr.zzag(t), zztr.zzag(t2)));
    }

    public static int zzc(int i, Object obj, zzsz zzsz) {
    ...
    public static <UT, UB> UB zza(int i, List<Integer> list, zzrh zzrh, UB ub, zztr<UT, UB> zztr) {
        if (zzrh == null) {
            return ub;
        }
    ...
    public static int zzc(int i, List<?> list, zzsz zzsz) {
        int i2;
        int size = list.size();
        if (size == 0) {
            return 0;
    ...
    public static <UT, UB> UB zza(int i, int i2, UB ub, zztr<UT, UB> zztr) {
        if (ub == null) {
            ub = zztr.zzri();
        }
