...
import com.avito.android.order.di.component.OrderComponentKt;
...
public enum zzb {
    ...
    ACCOUNT(BaseAnalyticKt.ANALYTIC_MODULE_ACCOUNT),
    ACTIVITY("activity"),
    ACTIVATE("activate"),
    ...
    OPTOUT("optout"),
    ORDER("order"),
    ORDER_ID(OrderComponentKt.KEY_ORDER_ID),
    ...
    PIXEL("pixel"),
    PLACEMENT("placement"),
    PLATFORM(Shared.PARAM_PLATFORM),
