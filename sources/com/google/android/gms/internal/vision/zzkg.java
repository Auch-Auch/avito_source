...
public class zzkg<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public static <FieldDescriptorType extends zzhv<FieldDescriptorType>> zzkg<FieldDescriptorType, Object> zzcb(int i) {
        return new zzkj(i);
    }
    ...
    public final V zzcd(int i) {
        zziq();
        V v = (V) this.zzabl.remove(i).getValue();
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: com.google.android.gms.internal.vision.zzkg<K extends java.lang.Comparable<K>, V> */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.google.android.gms.internal.vision.zzkg<K extends java.lang.Comparable<K>, V> */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.AbstractMap, java.util.Map
    public /* synthetic */ Object put(Object obj, Object obj2) {
        return zza((zzkg<K, V>) ((Comparable) obj), (Comparable) obj2);
    }
    ...
    public final V zza(K k, V v) {
        zziq();
        int zza = zza((zzkg<K, V>) k);
        if (zza >= 0) {
            return (V) this.zzabl.get(zza).setValue(v);
        }
        zziq();
        ...
        if (size == i2) {
            ...
            zzir().put((K) ((Comparable) remove.getKey()), (V) remove.getValue());
        }
    ...
    public /* synthetic */ zzkg(int i, zzkj zzkj) {
        this(i);
    }
