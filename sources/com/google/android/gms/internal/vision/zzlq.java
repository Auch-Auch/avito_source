...
public interface zzlq {
    ...
    @Deprecated
    void zzb(int i, Object obj, zzkf zzkf) throws IOException;

    void zzb(int i, List<zzgs> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzkf zzkf) throws IOException;
