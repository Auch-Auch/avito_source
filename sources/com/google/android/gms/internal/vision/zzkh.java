...
public final class zzkh {
    ...
    public static int zzo(int i, List<Long> list, boolean z) {
        ...
        return (zzhl.zzbh(i) * list.size()) + zzq(list);
    }
    ...
    public static int zzp(int i, List<Long> list, boolean z) {
        ...
        return (zzhl.zzbh(i) * size) + zzr(list);
    }
    ...
    public static int zzq(List<Long> list) {
        ...
        if (list instanceof zzjb) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzhl.zzv(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    public static int zzr(List<Long> list) {
        ...
        if (list instanceof zzjb) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzhl.zzw(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    public static int zzs(List<Long> list) {
        ...
        if (list instanceof zzjb) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzhl.zzx(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    public static int zzt(List<Integer> list) {
        ...
        if (list instanceof zzif) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzhl.zzbn(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    public static int zzu(List<Integer> list) {
        ...
        if (list instanceof zzif) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzhl.zzbi(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    public static int zzv(List<Integer> list) {
        ...
        if (list instanceof zzif) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzhl.zzbj(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    public static int zzw(List<Integer> list) {
        ...
        if (list instanceof zzif) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzhl.zzbk(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    public static int zzd(int i, List<zzgs> list) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
    ...
    private static zzkx<?, ?> zzn(boolean z) {
        try {
            ...
            return (zzkx) zziw.getConstructor(Boolean.TYPE).newInstance(Boolean.valueOf(z));
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    public static int zzq(int i, List<Long> list, boolean z) {
        ...
        return (zzhl.zzbh(i) * size) + zzs(list);
    }
    ...
    public static int zzr(int i, List<Integer> list, boolean z) {
        ...
        return (zzhl.zzbh(i) * size) + zzt(list);
    }
    ...
    public static int zzs(int i, List<Integer> list, boolean z) {
        ...
        return (zzhl.zzbh(i) * size) + zzu(list);
    }
    ...
    public static int zzt(int i, List<Integer> list, boolean z) {
        ...
        return (zzhl.zzbh(i) * size) + zzv(list);
    }
    ...
    public static int zzu(int i, List<Integer> list, boolean z) {
        ...
        return (zzhl.zzbh(i) * size) + zzw(list);
    }
    ...
    public static int zzw(int i, List<?> list, boolean z) {
        ...
        return zzhl.zzg(i, 0) * size;
    }

    public static <T> void zza(zzjg zzjg, T t, T t2, long j) {
        zzld.zza(t, j, zzjg.zzc(zzld.zzp(t, j), zzld.zzp(t2, j)));
    }

    public static int zzd(int i, List<zzjn> list, zzkf zzkf) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
    ...
    public static <T, FT extends zzhv<FT>> void zza(zzhq<FT> zzhq, T t, T t2) {
    ...
    public static <T, UT, UB> void zza(zzkx<UT, UB> zzkx, T t, T t2) {
        zzkx.zzf(t, zzkx.zzh(zzkx.zzy(t), zzkx.zzy(t2)));
    }

    public static int zzc(int i, Object obj, zzkf zzkf) {
    ...
    public static <UT, UB> UB zza(int i, List<Integer> list, zzij zzij, UB ub, zzkx<UT, UB> zzkx) {
        if (zzij == null) {
            return ub;
        }
    ...
    public static int zzc(int i, List<?> list, zzkf zzkf) {
        int i2;
        int size = list.size();
        if (size == 0) {
            return 0;
    ...
    public static <UT, UB> UB zza(int i, int i2, UB ub, zzkx<UT, UB> zzkx) {
        if (ub == null) {
            ub = zzkx.zzjd();
        }
