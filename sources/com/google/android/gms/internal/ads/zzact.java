...
public final class zzact {
    public static zzaca<Long> zzdbh = zzaca.zzb("gads:dynamite_load:fail:sample_rate", 10000L);
    public static zzaca<Boolean> zzdbi = zzaca.zzg("gads:report_dynamite_crash_in_background_thread", false);
    public static zzaca<String> zzdbj = zzaca.zzi("gads:public_beta:traffic_multiplier", "1.0");
