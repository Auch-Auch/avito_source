...
public final class zzasu {
    ...
    public final boolean zzdtp;
    public final boolean zzdtq;
    private final boolean zzdtr;
    private final boolean zzdts;
    public final String zzdtt;
    public final String zzdtu;
    public final String zzdtv;
    private final int zzdtw;
    public final int zzdtx;
    public final int zzdty;
    ...
    @VisibleForTesting
    public zzasu(int i, boolean z, boolean z2, String str, String str2, boolean z3, boolean z4, boolean z5, boolean z7, boolean z8, String str3, String str4, String str5, int i2, int i3, int i4, int i5, int i6, int i7, float f, int i8, int i9, double d, boolean z9, boolean z10, int i10, String str6, boolean z11, String str7) {
        this.zzdtj = i;
        this.zzdtk = z;
        this.zzdtl = z2;
        this.zzdtm = str;
