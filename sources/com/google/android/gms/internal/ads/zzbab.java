    ...
    public static JSONObject zzc(JsonReader jsonReader) throws IllegalStateException, IOException, JSONException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (JsonToken.BEGIN_ARRAY.equals(peek)) {
                ...
                throw new IllegalStateException(a.r2(valueOf.length() + 23, "unexpected json token: ", valueOf));
            }
        }
        jsonReader.endObject();
        return jSONObject;
                ...
                if (opt instanceof Boolean) {
                    ...
                    if (jSONArray.length() != 0) {
                        ...
                        if (obj == null) {
                            ...
                            zzbbd.zzfe(String.format("JSONArray with unsupported type %s for key:%s", obj.getClass().getCanonicalName(), next));
                        }
                    }
