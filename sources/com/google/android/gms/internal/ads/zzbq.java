...
public final class zzbq {
    ...
    public static double zzi(ByteBuffer byteBuffer) {
        ...
        byteBuffer.get(bArr);
        return ((double) ((((0 | ((bArr[0] << Ascii.CAN) & ViewCompat.MEASURED_STATE_MASK)) | ((bArr[1] << Ascii.DLE) & 16711680)) | ((bArr[2] << 8) & 65280)) | (bArr[3] & 255))) / 65536.0d;
    }

    public static double zzj(ByteBuffer byteBuffer) {
        byte[] bArr = new byte[4];
        byteBuffer.get(bArr);
        return ((double) ((((0 | ((bArr[0] << Ascii.CAN) & ViewCompat.MEASURED_STATE_MASK)) | ((bArr[1] << Ascii.DLE) & 16711680)) | ((bArr[2] << 8) & 65280)) | (bArr[3] & 255))) / 1.073741824E9d;
    }
