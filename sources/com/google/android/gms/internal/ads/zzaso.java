...
public final class zzaso implements Parcelable.Creator<zzasp> {
    ...
    public final /* synthetic */ zzasp createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < validateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(readHeader)) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    zzdnd = (zzdnd) SafeParcelReader.createParcelable(parcel, readHeader, zzdnd.CREATOR);
                    break;
                case 11:
        ...
        return new zzasp(bundle, zzbbg, applicationInfo, str, arrayList, packageInfo, str2, z, str3, zzdnd, str4);
    }
