...
public final class zzhr<T extends zzht<T>> {
    ...
    public final zzkd<T, Object> zza;
    private boolean zzb;
    private boolean zzc;
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        ...
        for (int i = 0; i < this.zza.zzc(); i++) {
            ...
            zzhr.zzb((zzhr) zzb2.getKey(), zzb2.getValue());
        }
        for (Map.Entry<T, Object> entry : this.zza.zzd()) {
            zzhr.zzb((zzhr) entry.getKey(), entry.getValue());
        }
        zzhr.zzc = this.zzc;
        return zzhr;
    }
    ...
    private final void zzb(T t, Object obj) {
        ...
        this.zza.zza((zzkd<T, Object>) t, (T) obj);
    }
    ...
    private final void zzb(Map.Entry<T, Object> entry) {
        ...
        if (key.zzd()) {
            ...
            this.zza.zza((zzkd<T, Object>) key, (T) zza2);
        } else if (key.zzc() == zzlo.MESSAGE) {
            Object zza3 = zza((zzhr<T>) key);
            if (zza3 == null) {
                this.zza.zza((zzkd<T, Object>) key, (T) zza(value));
                return;
            }
            ...
            this.zza.zza((zzkd<T, Object>) key, (T) zzjj);
        } else {
            this.zza.zza((zzkd<T, Object>) key, (T) zza(value));
        }
    }
    ...
    public static void zza(zzhi zzhi, zzlh zzlh, int i, Object obj) throws IOException {
        if (zzlh == zzlh.GROUP) {
            zzjj zzjj = (zzjj) obj;
            zzie.zza(zzjj);
            zzhi.zza(i, 3);
    ...
    public static int zza(zzlh zzlh, int i, Object obj) {
        int zze = zzhi.zze(i);
        if (zzlh == zzlh.GROUP) {
            zzie.zza((zzjj) obj);
            zze <<= 1;
