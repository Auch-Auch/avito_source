...
public abstract class zzhi extends zzgq {
    ...
    private static final boolean zzc = zzla.zza();
    public zzhl zza;
    ...
    public static class zza extends zzhi {
        ...
        public final void zza(int i, zzjj zzjj, zzkc zzkc) throws IOException {
            ...
            zzb(zzbj);
            zzkc.zza((zzkc) zzjj, (zzln) this.zza);
        }
    ...
    @Deprecated
    public static int zzc(int i, zzjj zzjj, zzkc zzkc) {
        int zze = zze(i) << 1;
        zzgj zzgj = (zzgj) zzjj;
        int zzbj = zzgj.zzbj();
        if (zzbj == -1) {
    ...
    public static int zzb(int i, zzjj zzjj, zzkc zzkc) {
        return zza(zzjj, zzkc) + zze(i);
    }
    ...
    public static int zza(zzjj zzjj, zzkc zzkc) {
        zzgj zzgj = (zzgj) zzjj;
        int zzbj = zzgj.zzbj();
        if (zzbj == -1) {
            zzbj = zzkc.zzb(zzgj);
