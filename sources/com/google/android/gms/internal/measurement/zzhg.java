...
public final class zzhg implements zzjz {
    ...
    public final <K, V> void zza(Map<K, V> map, zzje<K, V> zzje, zzho zzho) throws IOException {
        ...
        while (true) {
            ...
            if (zza2 == Integer.MAX_VALUE || this.zza.zzt()) {
                ...
                obj = zza(zzje.zza, (Class<?>) null, (zzho) null);
            } else if (zza2 != 2) {
                try {
                    if (!zzc()) {
                ...
                obj2 = zza(zzje.zzc, zzje.zzd.getClass(), zzho);
            }
        }
        map.put(obj, obj2);
    }
