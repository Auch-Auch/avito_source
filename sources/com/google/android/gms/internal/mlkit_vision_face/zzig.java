...
public class zzig<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public static <FieldDescriptorType extends zzfx<FieldDescriptorType>> zzig<FieldDescriptorType, Object> zza(int i) {
        return new zzif(i);
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: com.google.android.gms.internal.mlkit_vision_face.zzig<K extends java.lang.Comparable<K>, V> */
    ...
    public boolean equals(Object obj) {
        ...
        int zzc2 = zzc();
        if (zzc2 != zzig.zzc()) {
            return entrySet().equals(zzig.entrySet());
        }
        for (int i = 0; i < zzc2; i++) {
            if (!zzb(i).equals(zzig.zzb(i))) {
                return false;
            }
        }
        if (zzc2 != size) {
            return this.zzc.equals(zzig.zzc);
        }
        return true;
    }
    ...
    public V get(Object obj) {
        Comparable comparable = (Comparable) obj;
        int zza2 = zza((zzig<K, V>) comparable);
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.google.android.gms.internal.mlkit_vision_face.zzig<K extends java.lang.Comparable<K>, V> */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.AbstractMap, java.util.Map
    public /* synthetic */ Object put(Object obj, Object obj2) {
        return zza((zzig<K, V>) ((Comparable) obj), (Comparable) obj2);
    }
    ...
    public /* synthetic */ zzig(int i, zzif zzif) {
        this(i);
    }

    public final V zza(K k, V v) {
        zzf();
        int zza2 = zza((zzig<K, V>) k);
        if (zza2 >= 0) {
