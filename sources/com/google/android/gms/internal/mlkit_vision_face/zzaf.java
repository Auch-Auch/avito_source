...
public final class zzaf<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private final void zzb(int i) {
        if (i >= 0) {
            this.zzf = zzbk.zza(i, 1, LockFreeTaskQueueCore.MAX_CAPACITY_MASK);
            return;
        }
    ...
    private final void zzc(int i) {
        this.zzf = zzam.zza(this.zzf, 32 - Integer.numberOfLeadingZeros(i), 31);
    }
    ...
    public final void clear() {
        if (!zza()) {
            ...
            Map<K, V> zzb2 = zzb();
            if (zzb2 != null) {
                this.zzf = zzbk.zza(size(), 3, LockFreeTaskQueueCore.MAX_CAPACITY_MASK);
                zzb2.clear();
                this.zze = null;
                this.zzg = 0;
                return;
    ...
    public final V put(@NullableDecl K k, @NullableDecl V v) {
        int min;
        if (zza()) {
            zzj.zza(zza(), "Arrays already allocated");
            int i = this.zzf;
        ...
        if (zza3 != 0) {
            ...
            while (true) {
                int i8 = zza3 - 1;
                int i9 = iArr[i8];
                if ((i9 & i5) != i6 || !zzh.zza(k, objArr[i8])) {
                    int i10 = i9 & zzi2;
                    int i11 = i7 + 1;
                    if (i10 != 0) {
                        i7 = i11;
                        ...
                        zzi2 = zza(zzi2, zzam.zzb(zzi2), zza2, i2);
                    } else {
                        iArr[i8] = zzam.zza(i9, i3, zzi2);
                    }
                } else {
                    V v2 = (V) objArr2[i8];
                    objArr2[i8] = v;
        ...
        this.zza[i2] = zzam.zza(zza2, 0, zzi2);
        this.zzb[i2] = k;
        this.zzc[i2] = v;
        this.zzg = i3;
        zzc();
    ...
    private final int zza(int i, int i2, int i3, int i4) {
        Object zza2 = zzam.zza(i2);
        int i5 = i2 - 1;
        if (i4 != 0) {
            zzam.zza(zza2, i3 & i5, i4 + 1);
        }
        Object obj = this.zze;
        int[] iArr = this.zza;
        for (int i6 = 0; i6 <= i; i6++) {
            int zza3 = zzam.zza(obj, i6);
            while (zza3 != 0) {
                int i7 = zza3 - 1;
                int i8 = iArr[i7];
                int i9 = ((~i) & i8) | i6;
                int i10 = i9 & i5;
                int zza4 = zzam.zza(zza2, i10);
                zzam.zza(zza2, i10, zza3);
                iArr[i7] = zzam.zza(i9, zza4, i5);
                zza3 = i8 & i;
            }
        }
        this.zze = zza2;
    ...
    public static /* synthetic */ int zzd(zzaf zzaf) {
        int i = zzaf.zzg;
        zzaf.zzg = i - 1;
        return i;
    }
    ...
    private final Object zzb(@NullableDecl Object obj) {
        ...
        int zzi2 = zzi();
        int zza2 = zzam.zza(obj, null, zzi2, this.zze, this.zza, this.zzb, null);
        if (zza2 == -1) {
            return zzd;
        }
    ...
    private final int zza(@NullableDecl Object obj) {
        ...
        int zza2 = zzap.zza(obj);
        int zzi2 = zzi();
        int zza3 = zzam.zza(this.zze, zza2 & zzi2);
        if (zza3 == 0) {
            return -1;
        }
        int i = ~zzi2;
        ...
        do {
            int i3 = zza3 - 1;
            int i4 = this.zza[i3];
            if ((i4 & i) == i2 && zzh.zza(obj, this.zzb[i3])) {
                return i3;
            }
            zza3 = i4 & zzi2;
        } while (zza3 != 0);
    ...
    public final void zza(int i, int i2) {
        ...
        if (i < size) {
            ...
            iArr[i] = iArr[size];
            iArr[size] = 0;
            int zza2 = zzap.zza(obj) & i2;
            int zza3 = zzam.zza(this.zze, zza2);
            int i3 = size + 1;
            if (zza3 == i3) {
                zzam.zza(this.zze, zza2, i + 1);
                return;
            }
            while (true) {
                int i4 = zza3 - 1;
