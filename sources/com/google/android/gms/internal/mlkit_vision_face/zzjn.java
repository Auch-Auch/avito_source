...
public interface zzjn {
    ...
    void zza(int i, zzez zzez) throws IOException;

    <K, V> void zza(int i, zzhg<K, V> zzhg, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzib zzib) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzib zzib) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzib zzib) throws IOException;

    void zzb(int i, List<zzez> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzib zzib) throws IOException;
