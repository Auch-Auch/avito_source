...
public final class zzhq {
    public static String zza(zzhl zzhl, String str) {
    ...
    private static void zza(com.google.android.gms.internal.mlkit_vision_face.zzhl r13, java.lang.StringBuilder r14, int r15) {
        /*
        // Method dump skipped, instructions count: 641
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.mlkit_vision_face.zzhq.zza(com.google.android.gms.internal.mlkit_vision_face.zzhl, java.lang.StringBuilder, int):void");
    }
    ...
    public static final void zza(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"");
                sb.append(zzip.zza(zzez.zza((String) obj)));
                sb.append(Typography.quote);
            } else if (obj instanceof zzez) {
                sb.append(": \"");
                sb.append(zzip.zza((zzez) obj));
                sb.append(Typography.quote);
            } else if (obj instanceof zzgd) {
                sb.append(" {");
                zza((zzgd) obj, sb, i + 2);
                sb.append("\n");
                while (i2 < i) {
