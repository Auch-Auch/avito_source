...
public final class zzr extends AbstractSafeParcelable {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzr) {
            zzr zzr = (zzr) obj;
            if (Objects.equal(this.packageName, zzr.packageName) && this.zzi == zzr.zzi && this.zzk == zzr.zzk && Objects.equal(this.zzj, zzr.zzj) && Objects.equal(this.zzl, zzr.zzl) && Objects.equal(this.zzm, zzr.zzm) && this.zzay == zzr.zzay && this.zzn == zzr.zzn && this.zzaz == zzr.zzaz) {
                return true;
            }
        }
        return false;
    ...
    public final String toString() {
        ...
        a.k1(Q, this.packageName, ',', "packageVersionCode=");
        Q.append(this.zzi);
        Q.append(',');
        Q.append("logSource=");
        Q.append(this.zzk);
        ...
        a.k1(Q, this.zzj, ',', "uploadAccount=");
        a.k1(Q, this.zzl, ',', "loggingId=");
        a.k1(Q, this.zzm, ',', "logAndroidId=");
        Q.append(this.zzay);
        Q.append(',');
