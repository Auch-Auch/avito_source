...
public enum zzcb {
    ...
    static {
        zzcd zzcd = zzcd.SCALAR;
        zzcq zzcq = zzcq.DOUBLE;
        zzcq zzcq2 = zzcq.FLOAT;
        zzcq zzcq3 = zzcq.LONG;
        zzcq zzcq4 = zzcq.INT;
        zzcq zzcq5 = zzcq.BOOLEAN;
        zzcq zzcq6 = zzcq.STRING;
        zzcq zzcq7 = zzcq.MESSAGE;
        zzcq zzcq8 = zzcq.BYTE_STRING;
        zzcq zzcq9 = zzcq.ENUM;
        zzcd zzcd2 = zzcd.VECTOR;
        zzcd zzcd3 = zzcd.PACKED_VECTOR;
        zzcq zzcq10 = zzcq.LONG;
        zzcb[] values = values();
