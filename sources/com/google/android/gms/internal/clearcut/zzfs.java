...
public final class zzfs {
    ...
    private static int zza(CharSequence charSequence) {
                    ...
                    if (charAt2 < 2048) {
                        ...
                        if (55296 <= charAt2 && charAt2 <= 57343) {
                            if (Character.codePointAt(charSequence, i2) >= 65536) {
                                ...
                                throw new IllegalArgumentException(a.m2(39, "Unpaired surrogate at index ", i2));
                            }
                        }
                    }
                    i2++;
        ...
        throw new IllegalArgumentException(a.q2(54, "UTF-8 length does not fit in int: ", ((long) i3) + 4294967296L));
    }
                ...
                while (i4 < length2) {
                    ...
                    if (charAt4 >= 128) {
                        if (charAt4 < 2048) {
                            ...
                            throw new IllegalArgumentException(a.m2(39, "Unpaired surrogate at index ", i4 - 1));
                        }
