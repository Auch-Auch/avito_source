...
public final class zzhf {
    ...
    private static final Class<?> zzd = zzdd.zzb();
    ...
    public static final class zza extends zzd {
        ...
        public final byte zza(Object obj, long j) {
            if (zzhf.zza) {
                return zzhf.zzk(obj, j);
            }
            return zzhf.zzl(obj, j);
        }

        @Override // com.google.android.gms.internal.mlkit_vision_common.zzhf.zzd
        public final boolean zzb(Object obj, long j) {
            if (zzhf.zza) {
                return zzhf.zzm(obj, j);
            }
            return zzhf.zzn(obj, j);
        }
    ...
    private static Field zzf() {
        Field zza2;
        if (zzdd.zza() && (zza2 = zza(Buffer.class, "effectiveDirectAddress")) != null) {
            return zza2;
        }
