...
public interface zzht {
    ...
    void zza(int i, zzdf zzdf) throws IOException;

    <K, V> void zza(int i, zzfm<K, V> zzfm, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzgh zzgh) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzgh zzgh) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzgh zzgh) throws IOException;

    void zzb(int i, List<zzdf> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzgh zzgh) throws IOException;
