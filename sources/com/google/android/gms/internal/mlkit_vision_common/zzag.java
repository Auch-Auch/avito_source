...
public enum zzag implements zzel {
    UNKNOWN_EVENT(0),
    ...
    public final String toString() {
        return "<" + zzag.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.zzds + " name=" + name() + Typography.greater;
    }
