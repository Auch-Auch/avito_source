...
public abstract class zzdf implements Serializable, Iterable<Byte> {
    public static final zzdf zza = new zzdp(zzem.zzb);
    private static final zzdl zzb = (zzdd.zza() ? new zzds(null) : new zzdj(null));
    private static final Comparator<zzdf> zzd = new zzdh();
    private int zzc = 0;

    public static zzdf zza(String str) {
        return new zzdp(str.getBytes(zzem.zza));
    }
    ...
    public static zzdn zzc(int i) {
        return new zzdn(i, null);
    }
    ...
    public final String toString() {
        ...
        objArr[2] = zza() <= 50 ? zzgv.zza(this) : String.valueOf(zzgv.zza(zza(0, 47))).concat("...");
    ...
    public abstract zzdf zza(int i, int i2);

    public abstract String zza(Charset charset);

    public abstract void zza(zzdg zzdg) throws IOException;
