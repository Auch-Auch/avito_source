...
public final class zzo extends AbstractSafeParcelable {
    ...
    private zzm zzch;
    @SafeParcelable.Field(defaultValueUnchecked = BuildConfig.ADJUST_DEFAULT_TRACKER, getter = "getDeviceOrientationListenerBinder", id = 3, type = "android.os.IBinder")
    private zzr zzci;
    @SafeParcelable.Field(defaultValueUnchecked = BuildConfig.ADJUST_DEFAULT_TRACKER, getter = "getFusedLocationProviderCallbackBinder", id = 4, type = "android.os.IBinder")
    private zzaj zzcj;

    @SafeParcelable.Constructor
    public zzo(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) zzm zzm, @SafeParcelable.Param(id = 3) IBinder iBinder, @SafeParcelable.Param(id = 4) IBinder iBinder2) {
        this.zzcg = i;
        this.zzch = zzm;
        zzaj zzaj = null;
