...
public final class zzbh extends AbstractSafeParcelable implements Geofence {
    ...
    @SafeParcelable.Field(defaultValue = DateTimeParameterKt.DATE_TIME_PARAMETER_PRESENT_TIME, getter = "getLoiteringDelay", id = 9)
    ...
    public zzbh(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 7) int i, @SafeParcelable.Param(id = 3) short s, @SafeParcelable.Param(id = 4) double d, @SafeParcelable.Param(id = 5) double d2, @SafeParcelable.Param(id = 6) float f, @SafeParcelable.Param(id = 2) long j, @SafeParcelable.Param(id = 8) int i2, @SafeParcelable.Param(id = 9) int i3) {
        if (str == null || str.length() > 100) {
            ...
            throw new IllegalArgumentException(a.m2(46, "No supported transition specified: ", i));
        }
    }
    ...
    public final int hashCode() {
        ...
        return ((a.i1(this.zzaj, (((((int) (doubleToLongBits ^ (doubleToLongBits >>> 32))) + 31) * 31) + ((int) (doubleToLongBits2 ^ (doubleToLongBits2 >>> 32)))) * 31, 31) + this.zzag) * 31) + this.zzae;
    }

    /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x0010: APUT  (r1v1 java.lang.Object[]), (0 ??[int, short, byte, char]), (r2v1 java.lang.String) */
    @Override // java.lang.Object
