...
public final class zzbf extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = BuildConfig.ADJUST_DEFAULT_TRACKER, id = 4)
    private PendingIntent zzbv;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestUpdateData.OPERATION_ADD", id = 1)
    private int zzcg;
    @SafeParcelable.Field(defaultValueUnchecked = BuildConfig.ADJUST_DEFAULT_TRACKER, getter = "getFusedLocationProviderCallbackBinder", id = 6, type = "android.os.IBinder")
    private zzaj zzcj;
    @SafeParcelable.Field(defaultValueUnchecked = BuildConfig.ADJUST_DEFAULT_TRACKER, id = 2)
    private zzbd zzdl;
    @SafeParcelable.Field(defaultValueUnchecked = BuildConfig.ADJUST_DEFAULT_TRACKER, getter = "getLocationListenerBinder", id = 3, type = "android.os.IBinder")
    private zzx zzdm;
    @SafeParcelable.Field(defaultValueUnchecked = BuildConfig.ADJUST_DEFAULT_TRACKER, getter = "getLocationCallbackBinder", id = 5, type = "android.os.IBinder")
    private zzu zzdn;

    @SafeParcelable.Constructor
    public zzbf(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) zzbd zzbd, @SafeParcelable.Param(id = 3) IBinder iBinder, @SafeParcelable.Param(id = 4) PendingIntent pendingIntent, @SafeParcelable.Param(id = 5) IBinder iBinder2, @SafeParcelable.Param(id = 6) IBinder iBinder3) {
        this.zzcg = i;
        this.zzdl = zzbd;
        zzaj zzaj = null;
