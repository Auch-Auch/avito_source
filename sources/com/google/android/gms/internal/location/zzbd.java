...
public final class zzbd extends AbstractSafeParcelable {
    ...
    @Nullable
    @SafeParcelable.Field(defaultValueUnchecked = BuildConfig.ADJUST_DEFAULT_TRACKER, id = 10)
    private String moduleId;
    @Nullable
    @SafeParcelable.Field(defaultValueUnchecked = BuildConfig.ADJUST_DEFAULT_TRACKER, id = 6)
    private String tag;
    @SafeParcelable.Field(defaultValueUnchecked = BuildConfig.ADJUST_DEFAULT_TRACKER, id = 1)
