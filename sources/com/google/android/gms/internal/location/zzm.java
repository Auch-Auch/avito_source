...
public final class zzm extends AbstractSafeParcelable {
    ...
    @Nullable
    @SafeParcelable.Field(defaultValueUnchecked = BuildConfig.ADJUST_DEFAULT_TRACKER, id = 3)
    private String tag;
    ...
    public zzm(@SafeParcelable.Param(id = 1) zzj zzj, @SafeParcelable.Param(id = 2) List<ClientIdentity> list, @SafeParcelable.Param(id = 3) String str) {
        this.zzcf = zzj;
        this.zzm = list;
        this.tag = str;
    }
