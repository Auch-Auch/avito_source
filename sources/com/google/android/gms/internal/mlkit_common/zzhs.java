...
public class zzhs<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: com.google.android.gms.internal.mlkit_common.zzhs<K extends java.lang.Comparable<K>, V> */
    ...
    public boolean equals(Object obj) {
        ...
        int zzc2 = zzc();
        if (zzc2 != zzhs.zzc()) {
            return entrySet().equals(zzhs.entrySet());
        }
        for (int i = 0; i < zzc2; i++) {
            if (!zzb(i).equals(zzhs.zzb(i))) {
                return false;
            }
        }
        if (zzc2 != size) {
            return this.zzc.equals(zzhs.zzc);
        }
        return true;
    }
    ...
    public V get(Object obj) {
        Comparable comparable = (Comparable) obj;
        int zza2 = zza((zzhs<K, V>) comparable);
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.google.android.gms.internal.mlkit_common.zzhs<K extends java.lang.Comparable<K>, V> */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.AbstractMap, java.util.Map
    ...
    public /* synthetic */ zzhs(int i, zzhv zzhv) {
        this(i);
    }

    public final V zza(K k, V v) {
        zzf();
        int zza2 = zza((zzhs<K, V>) k);
        if (zza2 >= 0) {
