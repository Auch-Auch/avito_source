...
public interface zzjd {
    ...
    void zza(int i, zzep zzep) throws IOException;

    <K, V> void zza(int i, zzgs<K, V> zzgs, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzhr zzhr) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzhr zzhr) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzhr zzhr) throws IOException;

    void zzb(int i, List<zzep> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzhr zzhr) throws IOException;
