...
public enum zzfm {
    ...
    SINT32_LIST_PACKED(47, r13, zzgd.INT),
    ...
    static {
        zzfo zzfo = zzfo.SCALAR;
        zzgd zzgd = zzgd.DOUBLE;
        zzgd zzgd2 = zzgd.FLOAT;
        zzgd zzgd3 = zzgd.LONG;
        zzgd zzgd4 = zzgd.INT;
        zzgd zzgd5 = zzgd.BOOLEAN;
        zzgd zzgd6 = zzgd.STRING;
        zzgd zzgd7 = zzgd.MESSAGE;
        zzgd zzgd8 = zzgd.BYTE_STRING;
        zzgd zzgd9 = zzgd.ENUM;
        zzfo zzfo2 = zzfo.VECTOR;
        zzfo zzfo3 = zzfo.PACKED_VECTOR;
        zzgd zzgd10 = zzgd.LONG;
        zzfm[] values = values();
    ...
    private zzfm(int i, zzfo zzfo, zzgd zzgd) {
        ...
        this.zzbd = (zzfo != zzfo.SCALAR || (i2 = zzfp.zzb[zzgd.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : z;
    }
