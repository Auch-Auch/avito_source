...
public enum zzbg implements zzfv {
    ...
    private static final zzfu<zzbg> zzdr = new zzbj();
    ...
    public final String toString() {
        return "<" + zzbg.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.zzds + " name=" + name() + Typography.greater;
    }
