...
public enum zzbf implements zzfv {
    ...
    private static final zzfu<zzbf> zzac = new zzbe();
    ...
    public final String toString() {
        return "<" + zzbf.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.zzad + " name=" + name() + Typography.greater;
    }
