...
public final class zzy {
    ...
    public static int zza(int i, int i2) {
        ...
        if (i < 0) {
            str = zzx.zza("%s (%s) must not be negative", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i));
        } else if (i2 < 0) {
            throw new IllegalArgumentException(a.m2(26, "negative size: ", i2));
        } else {
            str = zzx.zza("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i), Integer.valueOf(i2));
        }
