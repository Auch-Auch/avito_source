...
public final class zziv extends zziq {
    ...
    public final int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i4 < length) {
            ...
            if (charAt2 < c && j3 < j4) {
                j2 = j3 + j;
                zzip.zza(bArr, j3, (byte) charAt2);
            } else if (charAt2 < 2048 && j3 <= j4 - 2) {
                long j5 = j3 + j;
                zzip.zza(bArr, j3, (byte) ((charAt2 >>> 6) | 960));
                zzip.zza(bArr, j5, (byte) ((charAt2 & '?') | 128));
                j3 = j5 + j;
                i4++;
                c = 128;
            } else if ((charAt2 < 55296 || 57343 < charAt2) && j3 <= j4 - 3) {
                long j6 = j3 + j;
                zzip.zza(bArr, j3, (byte) ((charAt2 >>> '\f') | 480));
                long j7 = j + j6;
                zzip.zza(bArr, j6, (byte) (((charAt2 >>> 6) & 63) | 128));
                j2 = j7 + 1;
                zzip.zza(bArr, j7, (byte) ((charAt2 & '?') | 128));
                j = 1;
            } else if (j3 <= j4 - 4) {
                int i5 = i4 + 1;
                if (i5 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                        ...
                        long j8 = j3 + 1;
                        zzip.zza(bArr, j3, (byte) ((codePoint >>> 18) | 240));
                        long j9 = 1 + j8;
                        zzip.zza(bArr, j8, (byte) (((codePoint >>> 12) & 63) | 128));
                        long j10 = 1 + j9;
                        zzip.zza(bArr, j9, (byte) (((codePoint >>> 6) & 63) | 128));
                        j = 1;
                        zzip.zza(bArr, j10, (byte) ((codePoint & 63) | 128));
                        i4 = i5;
                        j3 = j10 + 1;
                        i4++;
                        c = 128;
    ...
    private static int zza(byte[] bArr, int i, long j, int i2) {
        ...
        if (i2 == 1) {
            return zzir.zzb(i, zzip.zza(bArr, j));
        }
        if (i2 == 2) {
            return zzir.zzb(i, zzip.zza(bArr, j), zzip.zza(bArr, j + 1));
        }
