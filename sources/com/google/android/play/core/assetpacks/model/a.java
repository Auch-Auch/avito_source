...
public final class a {
    ...
    public static String a(@AssetPackErrorCode int i) {
        ...
        return a2.b.a.a.a.v(new StringBuilder(String.valueOf(str).length() + 113 + String.valueOf(str2).length()), str, " (https://developer.android.com/reference/com/google/android/play/core/assetpacks/model/AssetPackErrorCode.html#", str2, ")");
    }
}
