...
public final class CircularProgressIndicatorSpec extends BaseProgressIndicatorSpec {
    ...
    public void a() {
        if (this.indicatorSize < this.trackThickness * 2) {
            StringBuilder L = a.L("The indicatorSize (");
            L.append(this.indicatorSize);
            L.append(" px) cannot be less than twice of the trackThickness (");
            throw new IllegalArgumentException(a.j(L, this.trackThickness, " px)."));
        }
    }
