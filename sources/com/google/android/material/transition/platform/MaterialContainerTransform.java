...
import a2.j.b.d.v.l.f;
import a2.j.b.d.v.l.g;
import a2.j.b.d.v.l.l;
import a2.j.b.d.v.l.m;
...
public final class MaterialContainerTransform extends Transition {
    ...
    public static final c z = new c(new ProgressThresholds(0.0f, 0.25f), new ProgressThresholds(0.0f, 1.0f), new ProgressThresholds(0.0f, 1.0f), new ProgressThresholds(0.0f, 0.75f), null);
    public boolean a = false;
    public boolean b = false;
    @IdRes
    public int c = 16908290;
    @IdRes
    public int d = -1;
    @IdRes
    public int e = -1;
    ...
    public static final class d extends Drawable {
        public final c A;
        public final a2.j.b.d.v.l.a B;
        public final a2.j.b.d.v.l.d C;
        public final boolean D;
        public final Paint E;
        public final Path F;
        public a2.j.b.d.v.l.c G;
        public f H;
        public RectF I;
        public float J;
        public float K;
        ...
        public d(PathMotion pathMotion, View view, RectF rectF, ShapeAppearanceModel shapeAppearanceModel, float f2, View view2, RectF rectF2, ShapeAppearanceModel shapeAppearanceModel2, float f3, int i2, int i3, int i4, int i5, boolean z2, boolean z3, a2.j.b.d.v.l.a aVar, a2.j.b.d.v.l.d dVar, c cVar, boolean z4, a aVar2) {
        ...
        public final void a(Canvas canvas) {
            ...
            RectF rectF = this.y;
            n.h(canvas, bounds, rectF.left, rectF.top, this.H.b, this.G.b, new b());
        }
        ...
        public final void e(float f2) {
            ...
            if (f2 >= start) {
                if (f2 > end) {
                    ...
                    shapeAppearanceModel = (z2 ? shapeAppearanceModel : shapeAppearanceModel2).toBuilder().setTopLeftCornerSize(new AbsoluteCornerSize(n.e(shapeAppearanceModel.getTopLeftCornerSize().getCornerSize(rectF4), shapeAppearanceModel2.getTopLeftCornerSize().getCornerSize(rectF6), start, end, f2))).setTopRightCornerSize(new AbsoluteCornerSize(n.e(shapeAppearanceModel.getTopRightCornerSize().getCornerSize(rectF4), shapeAppearanceModel2.getTopRightCornerSize().getCornerSize(rectF6), start, end, f2))).setBottomLeftCornerSize(new AbsoluteCornerSize(n.e(shapeAppearanceModel.getBottomLeftCornerSize().getCornerSize(rectF4), shapeAppearanceModel2.getBottomLeftCornerSize().getCornerSize(rectF6), start, end, f2))).setBottomRightCornerSize(new AbsoluteCornerSize(n.e(shapeAppearanceModel.getBottomRightCornerSize().getCornerSize(rectF4), shapeAppearanceModel2.getBottomRightCornerSize().getCornerSize(rectF6), start, end, f2))).build();
                }
            }
    ...
    public MaterialContainerTransform() {
        boolean z2 = false;
        this.u = Build.VERSION.SDK_INT >= 28 ? true : z2;
        this.v = -1.0f;
        this.w = -1.0f;
    ...
    public static void a(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i2, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (ViewCompat.isLaidOut(view4) || view4.getWidth() != 0 || view4.getHeight() != 0) {
            ...
            RectF rectF4 = n.a;
            map.put("materialContainerTransition:shapeAppearance", shapeAppearanceModel.withTransformedCornerSizes(new m(rectF)));
        }
    }
    ...
    public final c b(boolean z2, c cVar, c cVar2) {
        ...
        return new c((ProgressThresholds) n.a(this.q, cVar.a), (ProgressThresholds) n.a(this.r, cVar.b), (ProgressThresholds) n.a(this.s, cVar.c), (ProgressThresholds) n.a(this.t, cVar.d), null);
    }
