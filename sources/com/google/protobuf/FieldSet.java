...
public final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    public final l<FieldDescriptorType, Object> a;
    public boolean b;
    ...
    public static int d(WireFormat.FieldType fieldType, int i, Object obj) {
        ...
        return e(fieldType, obj) + computeTagSize;
    }
    ...
    public static int i(WireFormat.FieldType fieldType, boolean z) {
        if (z) {
            return 2;
        }
    ...
    public static Object o(CodedInputStream codedInputStream, WireFormat.FieldType fieldType, boolean z) throws IOException {
        if (z) {
            return WireFormat.a(codedInputStream, fieldType, WireFormat.b.STRICT);
        }
        return WireFormat.a(codedInputStream, fieldType, WireFormat.b.LOOSE);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:5:0x0017, code lost:
        if ((r3 instanceof com.google.protobuf.LazyField) == false) goto L_0x002c;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x0020, code lost:
        if ((r3 instanceof com.google.protobuf.Internal.EnumLite) == false) goto L_0x002c;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void q(com.google.protobuf.WireFormat.FieldType r2, java.lang.Object r3) {
        /*
    ...
    public static void r(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, int i, Object obj) throws IOException {
        ...
        codedOutputStream.writeTag(i, i(fieldType, false));
    ...
    public void a(FieldDescriptorType fielddescriptortype, Object obj) {
        List list;
        if (((GeneratedMessageLite.c) fielddescriptortype).d) {
            q(((GeneratedMessageLite.c) fielddescriptortype).c, obj);
    ...
    public FieldSet<FieldDescriptorType> clone() {
        ...
        for (int i = 0; i < this.a.e(); i++) {
            ...
            fieldSet.p(d2.getKey(), d2.getValue());
        }
    ...
    public final int h(Map.Entry<FieldDescriptorType, Object> entry) {
    ...
    public Iterator<Map.Entry<FieldDescriptorType, Object>> k() {
        if (this.c) {
            return new LazyField.c(((l.d) this.a.entrySet()).iterator());
        }
        return ((l.d) this.a.entrySet()).iterator();
    }
    ...
    public void m(FieldSet<FieldDescriptorType> fieldSet) {
    ...
    public final void n(Map.Entry<FieldDescriptorType, Object> entry) {
        FieldDescriptorType key = entry.getKey();
        Object value = entry.getValue();
        if (value instanceof LazyField) {
    ...
    public void p(FieldDescriptorType fielddescriptortype, Object obj) {
        if (!fielddescriptortype.isRepeated()) {
            ...
            while (it.hasNext()) {
                q(fielddescriptortype.getLiteType(), it.next());
            }
            obj = arrayList;
        } else {
            throw new IllegalArgumentException("Wrong object type used with protocol message reflection.");
