...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    public static class b extends FluentIterable<T> {
        public final /* synthetic */ Iterable b;
        ...
        public Iterator<T> iterator() {
            return Iterators.concat(Iterators.transform(this.b.iterator(), new s1()));
        }
    }

    public static class c extends FluentIterable<T> {
        public final /* synthetic */ Iterable[] b;

        public class a extends a2.j.d.c.c<Iterator<? extends T>> {
            public a(int i) {
                super(i);
            }
