...
public final class PercentEscaper extends UnicodeEscaper {
    ...
    public PercentEscaper(String str, boolean z) {
        ...
        if (!str.matches(".*[0-9A-Za-z].*")) {
            String c3 = a.c3(str, "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789");
            if (!z || !c3.contains(" ")) {
                this.b = z;
    ...
    public char[] escape(int i) {
        ...
        if (i <= 127) {
            ...
            throw new IllegalArgumentException(a.M2("Invalid unicode character value ", i));
        }
    }
}
