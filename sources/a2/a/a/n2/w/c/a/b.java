...
public final class b extends Lambda implements Function1<DeepLink, Unit> {
    public final /* synthetic */ AdvertXlRichJobItemPresenterImpl.d a;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public b(AdvertXlRichJobItemPresenterImpl.d dVar) {
        super(1);
        this.a = dVar;
    }
    ...
    public Unit invoke(DeepLink deepLink) {
        ...
        ((AdvertRichItemListener) this.a.c.b.get()).onCallActionClicked(this.a.a.getStringId(), deepLink2, ContactSource.CONTACT_XL);
