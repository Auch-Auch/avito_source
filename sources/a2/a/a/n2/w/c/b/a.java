...
public final class a extends Lambda implements Function1<DeepLink, Unit> {
    ...
    public Unit invoke(DeepLink deepLink) {
        ...
        ((AdvertRichItemListener) this.a.c.b.get()).onCallActionClicked(this.a.a.getStringId(), deepLink2, AdvertRichItemPresenterImpl.access$contactSource(this.a.c, this.b));
