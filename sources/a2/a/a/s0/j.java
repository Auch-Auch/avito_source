...
import kotlin.Pair;
public final class j<T, R> implements Function<FavoriteSellersLoadingResult, SingleSource<? extends Pair<? extends FavoriteSellersResult, ? extends List<? extends FavoriteSellersItem>>>> {
    ...
    public SingleSource<? extends Pair<? extends FavoriteSellersResult, ? extends List<? extends FavoriteSellersItem>>> apply(FavoriteSellersLoadingResult favoriteSellersLoadingResult) {
        ...
        if (favoriteSellersLoadingResult2 instanceof FavoriteSellersLoadingResult.Ok) {
            return this.a.y.convert(((FavoriteSellersLoadingResult.Ok) favoriteSellersLoadingResult2).getResult()).map(new i(favoriteSellersLoadingResult2));
        }
