...
public final class i<T, R> implements Function<List<? extends FavoriteSellersItem>, Pair<? extends FavoriteSellersResult, ? extends List<? extends FavoriteSellersItem>>> {
    public final /* synthetic */ FavoriteSellersLoadingResult a;

    public i(FavoriteSellersLoadingResult favoriteSellersLoadingResult) {
