...
public final class j<T> implements Consumer<LoadingState<? super CvResult>> {
    public final /* synthetic */ ExpressCvViewModelImpl a;

    public j(ExpressCvViewModelImpl expressCvViewModelImpl) {
    ...
    public void accept(LoadingState<? super CvResult> loadingState) {
        ...
        if (loadingState2 instanceof LoadingState.Loaded) {
            this.a.d(((CvResult) ((LoadingState.Loaded) loadingState2).getData()).getDeepLink());
