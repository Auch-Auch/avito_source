...
public final class a<T> implements Consumer<DefaultPublicUserProfile> {
    ...
    public void accept(DefaultPublicUserProfile defaultPublicUserProfile) {
        this.a.v.updateSellersSubscription(defaultPublicUserProfile.getUser().getSubscribeInfo(), false);
    }
}
