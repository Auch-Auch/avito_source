...
public final class p<T, R> implements Function<Throwable, LoadingState<? super SearchParameters>> {
    public final /* synthetic */ FiltersInteractorImpl a;

    public p(FiltersInteractorImpl filtersInteractorImpl) {
    ...
    public LoadingState<? super SearchParameters> apply(Throwable th) {
        Throwable th2 = th;
