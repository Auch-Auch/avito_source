...
public final class j<T, R> implements Function<LoadingState<? super SerpInteractor.Result>, LoadAction.LoadSerp> {
    ...
    public LoadAction.LoadSerp apply(LoadingState<? super SerpInteractor.Result> loadingState) {
        ...
        return new LoadAction.ReloadSerp(loadingState2);
    }
}
