...
public final class j extends Lambda implements Function2<Dialog.Config, DialogInterface, Unit> {
    ...
    public j(PhonesListFragment phonesListFragment) {
        super(2);
    ...
    public Unit invoke(Dialog.Config config, DialogInterface dialogInterface) {
        ...
        config2.setSubtitle(this.a.getString(R.string.verification_stub_text));
        config2.addPrimaryButton(R.string.verification_stub_button_text, new i(dialogInterface2));
