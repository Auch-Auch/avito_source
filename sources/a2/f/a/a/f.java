...
public final class f implements DatabaseErrorHandler {
    ...
    public void onCorruption(android.database.sqlite.SQLiteDatabase r4) {
        /*
            r3 = this;
            com.evernote.android.job.util.JobCat r0 = a2.f.a.a.f.a
        ...
        L_0x0074:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: a2.f.a.a.f.onCorruption(android.database.sqlite.SQLiteDatabase):void");
    }
}
