...
public class c {
    ...
    public final class b implements Callable<Job.Result> {
        ...
        public b(Job job, a aVar) {
            this.a = job;
            this.b = g.a(job.getContext(), "JobExecutor", c.f);
        }
        ...
        public final void a(Job job, Job.Result result) {
            ...
            boolean z = false;
            boolean z2 = true;
            if (!jobRequest.isPeriodic() && Job.Result.RESCHEDULE.equals(result) && !job.b()) {
        ...
        public Job.Result call() throws Exception {
            try {
                g.b(this.a.getContext(), this.b, c.f);
                Job.Result b2 = b();
                c.this.c(this.a);
