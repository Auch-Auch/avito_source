...
public class l<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public final int a;
    public List<l<K, V>.b> b = Collections.emptyList();
    public Map<K, V> c = Collections.emptyMap();
    public boolean d;
    public volatile l<K, V>.d e;

    public static class a {
        public static final Iterator<Object> a = new C0085a();
        public static final Iterable<Object> b = new b();

        /* renamed from: a2.j.i.l$a$a  reason: collision with other inner class name */
        public static class C0085a implements Iterator<Object> {
    ...
    public class d extends AbstractSet<Map.Entry<K, V>> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r0v1, resolved type: a2.j.i.l */
        ...
        public boolean add(Object obj) {
            ...
            l.this.put((Comparable) entry.getKey(), entry.getValue());
            return true;
        }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: a2.j.i.l<K extends java.lang.Comparable<K>, V> */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.AbstractMap, java.util.Map
    ...
    public boolean equals(Object obj) {
        ...
        int e2 = e();
        if (e2 != lVar.e()) {
            return ((AbstractSet) entrySet()).equals(lVar.entrySet());
        }
        for (int i = 0; i < e2; i++) {
            if (!d(i).equals(lVar.d(i))) {
                return false;
            }
        }
        if (e2 != size) {
    ...
    public V put(K k, V v) {
        ...
        int i2 = this.a;
        if (size == i2) {
            l<K, V>.b remove = this.b.remove(i2 - 1);
    ...
    public class b implements Map.Entry<K, V>, Comparable<l<K, V>.b> {
        public final K a;
        public V b;

        public b(l lVar, Map.Entry<K, V> entry) {
        ...
        public int compareTo(l<K, V>.b bVar) {
