...
public final class d {
    ...
    public d(Context context) {
        ...
        this.a = Utility.isNullOrEmpty(null) ? "com.facebook.SharedPreferencesTokenCachingStrategy.DEFAULT_KEY" : null;
    ...
    public final void a(String str, Bundle bundle) throws JSONException {
        ...
        } else if (string.equals(Types.INT)) {
        ...
        } else if (string.equals(Types.FLOAT)) {
        ...
        } else if (string.equals(Types.STRING)) {
